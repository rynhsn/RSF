...
namespace Lookup_APModel
{
    public class PublicAPLookupRecordModel : R_BusinessObjectServiceClientBase<APL00100DTO>, IPublicAPLookupRecord
    {
        ...
        public async Task<APL00600DTO> APL00600GetRecordAsync(APL00600ParameterDTO poEntity)
        {
            var loEx = new R_Exception();
            APL00600DTO loResult = null;
            ...
            try
            {
                ...
                var loTempResult = await R_HTTPClientWrapper
                    .R_APIRequestObject<APLGenericRecord<APL00600DTO>, APL00600ParameterDTO>(
                        _RequestServiceEndPoint,
                        nameof(IPublicAPLookupRecord.APL00600GetRecord),
                        poEntity,
                        DEFAULT_MODULE,
                        _SendWithContext,
                        _SendWithToken);
        ...
        public async Task<APL00700DTO> APL00700GetRecordAsync(APL00700ParameterDTO poEntity)
        {
            var loEx = new R_Exception();
            APL00700DTO loResult = null;
            ...
            try
            {
                ...
                var loTempResult = await R_HTTPClientWrapper
                    .R_APIRequestObject<APLGenericRecord<APL00700DTO>, APL00700ParameterDTO>(
                        _RequestServiceEndPoint,
                        nameof(IPublicAPLookupRecord.APL00700GetRecord),
                        poEntity,
                        DEFAULT_MODULE,
                        _SendWithContext,
                        _SendWithToken);
