...
{
    public partial class GSL03000 : R_Page
    {
        private LookupGSL03000ViewModel _viewModel = new LookupGSL03000ViewModel();
        private R_Grid<GSL03000DTO> GridRef;
        ...
        protected override async Task R_Init_From_Master(object poParameter)
        {
            ...
            try
            {
                _viewModel.ProductParameter = (GSL03000ParameterDTO)poParameter;
        ...
        public async Task OnClickRefresh()
        {
            ...
            try
            {
                ...
                {
                    if (string.IsNullOrEmpty(_viewModel.ProductParameter.CCATEGORY_ID))
                    {
        ...
        private async Task OnChanged(string poParam)
        {
            ...
            try
            {
                ...
                if (poParam == "A")
                {
                    _viewModel.ProductParameter.CCATEGORY_ID = "";
                    _ProductName = "";
                }
            }
            catch (Exception ex)
        ...
        private async Task Category_OnLostFocus()
        {
            ...
            try
            {
                if (string.IsNullOrWhiteSpace(_viewModel.ProductParameter.CCATEGORY_ID) == false)
                {

                    GSL01800DTOParameter loParam = new GSL01800DTOParameter();
                    loParam.CSEARCH_TEXT = _viewModel.ProductParameter.CCATEGORY_ID;
                    loParam.CCATEGORY_TYPE = "30";
                    ...
                    _viewModel.ProductParameter.CCATEGORY_ID = loResult.CCATEGORY_ID;
                    _ProductName = loResult.CCATEGORY_NAME;
        ...
        private async Task R_After_Open_LookupCategory(R_AfterOpenLookupEventArgs eventArgs)
        {
            ...
            _viewModel.ProductParameter.CCATEGORY_ID = loTempResult.CCATEGORY_ID;
            _ProductName = loTempResult.CCATEGORY_NAME;
