    ...
    public class PublicHDLookupModel : R_BusinessObjectServiceClientBase<HDL00100DTO>, IPublicHDLookup
    {
        ...
        public async Task<List<HDL00400DTO>> HDL00400AssetLookupAsync(HDL00400ParameterDTO poParam)
        {
            ...
            try
            {
                ...
                R_FrontContext.R_SetStreamingContext(ContextConstantPublicLookup.CAREA_TYPE, poParam.CAREA_TYPE);
                R_HTTPClientWrapper.httpClientName = _HttpClientName;
        ...
        public async Task<List<HDL00500DTO>> HDL00500TaskLookupAsync(HDL00500ParameterDTO poParam)
        {
            var loEx = new R_Exception();
            List<HDL00500DTO> loResult = null;
            ...
            try
            {
                ...
                R_FrontContext.R_SetStreamingContext(ContextConstantPublicLookup.CPROPERTY_ID, poParam.CPROPERTY_ID);
                R_HTTPClientWrapper.httpClientName = _HttpClientName;
                loResult = await R_HTTPClientWrapper.R_APIRequestStreamingObject<HDL00500DTO>(
                    _RequestServiceEndPoint,
                    nameof(IPublicHDLookup.HDL00500TaskLookup),
                    DEFAULT_MODULE,
                    _SendWithContext,
                    _SendWithToken);
            }
