...
namespace Lookup_HDModel
{
    public class PublicHDLookupRecordModel : R_BusinessObjectServiceClientBase<HDL00100DTO>, IPublicHDLookupRecord
    {
        ...
        public async Task<HDL00500DTO> HDL00500GetRecordAsync(HDL00500ParameterDTO poEntity)
        {
            var loEx = new R_Exception();
            HDL00500DTO loResult = null;
            ...
            try
            {
                ...
                var loTempResult = await R_HTTPClientWrapper
                    .R_APIRequestObject<HDLGenericRecord<HDL00500DTO>, HDL00500ParameterDTO>(
                        _RequestServiceEndPoint,
                        nameof(IPublicHDLookupRecord.HDL00500GetRecord),
                        poEntity,
                        DEFAULT_MODULE,
                        _SendWithContext,
                        _SendWithToken);
