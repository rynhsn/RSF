...
namespace Lookup_APSERVICES
{
    ...
    public class PublicLookupController : ControllerBase, IPublicLookup
    {
        ...
        {
            _Logger.LogInfo("Start APL00600ApSchedulePaymentLookup");
            var loException = new R_Exception();
            ...
            try
            {
                ...
                _Logger.LogInfo("Set Param APL00600ApSchedulePaymentLookup");
                poParam.CCOMPANY_ID = R_BackGlobalVar.COMPANY_ID;
                poParam.CPROPERTY_ID = R_Utility.R_GetStreamingContext<string>(ContextConstantPublicLookup.CPROPERTY_ID);
        ...
        {
            _Logger.LogInfo("Start APL00600ApInvoiceListLookup");
            var loException = new R_Exception();
            IAsyncEnumerable<APL00600DTO> loRtn = null;
            try
            {
                ...
                _Logger.LogInfo("Set Param APL00600ApInvoiceListLookup");
                poParam.CSCH_PAYMENT_ID = R_Utility.R_GetStreamingContext<string>(ContextConstantPublicLookup.CSCH_PAYMENT_ID);
                _Logger.LogInfo("Call Back Method SchedulePaymentLookup");
                var loResult = loCls.InvoiceListLookup(poParam);

                _Logger.LogInfo("Call Stream Method Data APL00600ApInvoiceListLookup");
                loRtn = GetStream<APL00600DTO>(loResult);
            }
            catch (Exception ex)
            {
            ...
            _Logger.LogInfo("End APL00600ApInvoiceListLookup");
            return loRtn;
        }
