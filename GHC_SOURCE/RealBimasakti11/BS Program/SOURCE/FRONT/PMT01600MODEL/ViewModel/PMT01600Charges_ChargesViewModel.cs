...
{
    public class PMT01600Charges_ChargesViewModel : R_ViewModel<PMT01600Charges_ChagesInfoDetailDTO>
    {
        #region From Back
        ...
        private readonly PMT01600Charges_ChagesInfoDetailModel _model = new PMT01600Charges_ChagesInfoDetailModel();
        ...
        public PMT01600Charges_ChagesInfoDetailDTO loEntityChargesInfo = new PMT01600Charges_ChagesInfoDetailDTO();
        ...
        public PMT01600ParameterFrontChangePageToChargesDTO loParameterList = new PMT01600ParameterFrontChangePageToChargesDTO();
        ...
        public async Task GetEntity(PMT01600Charges_ChagesInfoDetailDTO poEntity)
        {
        ...
        public async Task ServiceSave(PMT01600Charges_ChagesInfoDetailDTO poNewEntity, eCRUDMode peCRUDMode)
        {
            var loEx = new R_Exception();
        ...
        public async Task ServiceDelete(PMT01600Charges_ChagesInfoDetailDTO poEntity)
        {
            var loEx = new R_Exception();
        ...
        private PMT01600Charges_ChagesInfoDetailDTO ConvertToEntityFront(PMT01600Charges_ChagesInfoDetailDTO poEntity)
        {
            R_Exception loException = new R_Exception();
            PMT01600Charges_ChagesInfoDetailDTO? loReturn = null;

            try
            {
                if (poEntity != null)
                {
                    loReturn = R_FrontUtility.ConvertObjectToObject<PMT01600Charges_ChagesInfoDetailDTO>(poEntity);
        ...
        private PMT01600Charges_ChagesInfoDetailDTO ConvertToEntityBack(PMT01600Charges_ChagesInfoDetailDTO poEntity)
        {
            R_Exception loException = new R_Exception();
            PMT01600Charges_ChagesInfoDetailDTO? loReturn = null;
        ...
        private void CalculateYMD(ref PMT01600Charges_ChagesInfoDetailDTO poEntity)
        {
            R_Exception loException = new R_Exception();
            PMT01600Charges_ChagesInfoDetailDTO loData = poEntity;
