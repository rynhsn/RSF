...
{
    public class PMT01600Unit_UtilitiesViewModel : R_ViewModel<PMT01600Unit_UtilitiesDetailDTO>
    {
        #region From Back
        ...
        private readonly PMT01600Unit_UtilitiesDetailModel _model = new PMT01600Unit_UtilitiesDetailModel();
        public PMT01600Unit_UtilitiesDetailDTO oEntity = new PMT01600Unit_UtilitiesDetailDTO();
        ...
        public async Task GetEntity(PMT01600Unit_UtilitiesDetailDTO poEntity)
        {
        ...
        public async Task ServiceSave(PMT01600Unit_UtilitiesDetailDTO poNewEntity, eCRUDMode peCRUDMode)
        {
            var loEx = new R_Exception();
        ...
        public async Task ServiceDelete(PMT01600Unit_UtilitiesDetailDTO poEntity)
        {
            var loEx = new R_Exception();
