...
{
    public class PMT01600LOIViewModel : R_ViewModel<PMT01600LOI_SelectedLOIDTO>
    {
        #region From Back

        private readonly PMT01600LOI_SelectedLOIModel _model = new PMT01600LOI_SelectedLOIModel();
        private readonly BaseAOCGetSingleDataModel _baseSingleDataModel = new BaseAOCGetSingleDataModel();
        public PMT01600LOI_SelectedLOIDTO oEntity = new PMT01600LOI_SelectedLOIDTO();
        ...
        public R_ILocalizer<Resources_PMT01600_Class>? _localizer { get; set; }
        ...
        public async Task GetEntity(PMT01600LOI_SelectedLOIDTO poEntity)
        {
        ...
        public async Task ServiceSave(PMT01600LOI_SelectedLOIDTO poNewEntity, eCRUDMode peCRUDMode)
        {
            var loEx = new R_Exception();
        ...
        public async Task ServiceDelete(PMT01600LOI_SelectedLOIDTO poEntity)
        {
            var loEx = new R_Exception();
