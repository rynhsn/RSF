    ...
    public class GSM00301ViewModel : R_ViewModel<TaxInfoDTO>
    {
        ...
        public async Task GetTaxInfoGetRecordAsync()
        {
            ...
            try
            {
                ...
                loResult.DID_EXPIRED_DATE = DateTime.TryParseExact(loResult.CID_EXPIRED_DATE, "yyyyMMdd", CultureInfo.InvariantCulture, DateTimeStyles.None, out var loResultInv) ? loResultInv : (DateTime?)null;
