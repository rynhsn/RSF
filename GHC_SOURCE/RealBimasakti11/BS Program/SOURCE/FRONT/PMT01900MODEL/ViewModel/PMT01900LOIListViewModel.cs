...
{
    public class PMT01900LOIListViewModel : R_ViewModel<BaseAOCResponseAgreementListDTO>
    {
        ...
        {
            new BaseAOCResponseComboBoxDTO { CCODE = "00", CDESCRIPTION =  R_FrontUtility.R_GetMessage(typeof(Resources_PMT01900_Class), "_Draft/Open" )},
            new BaseAOCResponseComboBoxDTO { CCODE = "30", CDESCRIPTION = R_FrontUtility.R_GetMessage(typeof(Resources_PMT01900_Class), "_Approved" )},
              new BaseAOCResponseComboBoxDTO { CCODE = "80", CDESCRIPTION = R_FrontUtility.R_GetMessage(typeof(Resources_PMT01900_Class), "_Closed" )},
            new BaseAOCResponseComboBoxDTO { CCODE = "90", CDESCRIPTION = R_FrontUtility.R_GetMessage(typeof(Resources_PMT01900_Class), "_Cancelled/Rejected" )},
        };
