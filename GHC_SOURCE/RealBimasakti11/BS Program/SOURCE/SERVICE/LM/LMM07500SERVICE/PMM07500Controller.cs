    ...
    public class PMM07500Controller : ControllerBase, IPMM07500
    {
        ...
        public IAsyncEnumerable<PMM07500GridDTO> GetStampList()
        {
            ...
            try
            {
                ...
                ShowLogExecute();
                loRtnTemp = loCls.GetStampRateList(new PMR07500ParamDTO()
                {
        ...
        public R_ServiceDeleteResultDTO R_ServiceDelete(R_ServiceDeleteParameterDTO<PMM07500GridDTO> poParameter)
        {
            ...
            try
            {
                ...
                loCls = new PMM07500Cls(); //create cls class instance
        ...
        public R_ServiceGetRecordResultDTO<PMM07500GridDTO> R_ServiceGetRecord(R_ServiceGetRecordParameterDTO<PMM07500GridDTO> poParameter)
        {
            using Activity activity = _activitySource.StartActivity($"{GetType().Name}.{MethodBase.GetCurrentMethod().Name}");
            ShowLogStart();
            R_ServiceGetRecordResultDTO<PMM07500GridDTO> loRtn = null;
            R_Exception loException = new R_Exception();
            try
            {
                var loCls = new PMM07500Cls(); //create cls class instance
                poParameter.Entity.CUSER_ID = R_BackGlobalVar.USER_ID;
                poParameter.Entity.CCOMPANY_ID = R_BackGlobalVar.COMPANY_ID;
                poParameter.Entity.CLANGUAGE_ID= R_BackGlobalVar.CULTURE;
                loRtn = new R_ServiceGetRecordResultDTO<PMM07500GridDTO>();
                ShowLogExecute();
        ...
        public R_ServiceSaveResultDTO<PMM07500GridDTO> R_ServiceSave(R_ServiceSaveParameterDTO<PMM07500GridDTO> poParameter)
        {
            using Activity activity = _activitySource.StartActivity($"{GetType().Name}.{MethodBase.GetCurrentMethod().Name}");
            ShowLogStart();
            R_ServiceSaveResultDTO<PMM07500GridDTO> loRtn = null;
            R_Exception loException = new R_Exception();
            PMM07500Cls loCls;
            try
            {
                loCls = new PMM07500Cls();
                loRtn = new R_ServiceSaveResultDTO<PMM07500GridDTO>();
                poParameter.Entity.CCOMPANY_ID = R_BackGlobalVar.COMPANY_ID;
                poParameter.Entity.CUSER_ID = R_BackGlobalVar.USER_ID;
                poParameter.Entity.CLANGUAGE_ID = R_BackGlobalVar.CULTURE;
                ShowLogExecute();
