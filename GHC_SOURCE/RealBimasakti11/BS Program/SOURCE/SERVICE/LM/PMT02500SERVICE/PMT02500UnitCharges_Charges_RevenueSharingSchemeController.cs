...
namespace PMT02500Service
{
    ...
    [ApiController]
    public class PMT02500UnitCharges_Charges_RevenueSharingSchemeController : ControllerBase, IPMT02500UnitCharges_Charges_RevenueSharingScheme
    {
        private readonly LoggerPMT02500? _loggerPMT02500;
        private readonly ActivitySource _activitySource;


        public PMT02500UnitCharges_Charges_RevenueSharingSchemeController(ILogger<PMT02500UnitCharges_Charges_RevenueSharingSchemeController> logger)
        {
            LoggerPMT02500.R_InitializeLogger(logger);
            _loggerPMT02500 = LoggerPMT02500.R_GetInstanceLogger();
            _activitySource = PMT02500Activity.R_InitializeAndGetActivitySource(nameof(PMT02500UnitCharges_Charges_RevenueSharingSchemeController));
        }
        ...
        public IAsyncEnumerable<PMT02500UnitCharges_Charges_RevenueSharingSchemeOriginalDTO> GetRevenueSharingSchemeList()
        {
            ...
            List<PMT02500UnitCharges_Charges_RevenueSharingSchemeOriginalDTO> loRtnTmp;
            PMT02500UnitCharges_Charges_RevenueSharingSchemeCls loCls;
            IAsyncEnumerable<PMT02500UnitCharges_Charges_RevenueSharingSchemeOriginalDTO>? loReturn = null;
            ...
            try
            {
                ...
                {
                    loDbParameter.CPROPERTY_ID = R_Utility.R_GetStreamingContext<string>(PMT02500GetAgreementChargesInfo_RevenueSharingSchemeContextDTO.CPROPERTY_ID);
                    loDbParameter.CDEPT_CODE = R_Utility.R_GetStreamingContext<string>(PMT02500GetAgreementChargesInfo_RevenueSharingSchemeContextDTO.CDEPT_CODE);
                    loDbParameter.CREF_NO = R_Utility.R_GetStreamingContext<string>(PMT02500GetAgreementChargesInfo_RevenueSharingSchemeContextDTO.CREF_NO);
                    loDbParameter.CTRANS_CODE = R_Utility.R_GetStreamingContext<string>(PMT02500GetAgreementChargesInfo_RevenueSharingSchemeContextDTO.CTRANS_CODE);
                    loDbParameter.CCHARGE_SEQ_NO = R_Utility.R_GetStreamingContext<string>(PMT02500GetAgreementChargesInfo_RevenueSharingSchemeContextDTO.CCHARGE_SEQ_NO);
                    loDbParameter.CREVENUE_SHARING_ID = R_Utility.R_GetStreamingContext<string>(PMT02500GetAgreementChargesInfo_RevenueSharingSchemeContextDTO.CREVENUE_SHARING_ID);
        ...
        [HttpPost]
        public R_ServiceGetRecordResultDTO<PMT02500UnitCharges_Charges_RevenueSharingSchemeOriginalDTO> R_ServiceGetRecord(R_ServiceGetRecordParameterDTO<PMT02500UnitCharges_Charges_RevenueSharingSchemeOriginalDTO> poParameter)
        {
            string? lcMethod = nameof(R_ServiceGetRecord);
            _loggerPMT02500.LogInfo(string.Format("Start Method {0}", lcMethod));
            var loEx = new R_Exception();
            var loRtn = new R_ServiceGetRecordResultDTO<PMT02500UnitCharges_Charges_RevenueSharingSchemeOriginalDTO>();

            try
            {
                _loggerPMT02500.LogInfo(string.Format("Initialize the loCls in method {0}", lcMethod));
                var loCls = new PMT02500UnitCharges_Charges_RevenueSharingSchemeCls();
                _loggerPMT02500.LogDebug("{@PMT01500ChargesInfo_RevenueSharingCls}", loCls);
        ...
        [HttpPost]
        public R_ServiceSaveResultDTO<PMT02500UnitCharges_Charges_RevenueSharingSchemeOriginalDTO> R_ServiceSave(R_ServiceSaveParameterDTO<PMT02500UnitCharges_Charges_RevenueSharingSchemeOriginalDTO> poParameter)
        {
            string? lcMethod = nameof(R_ServiceSave);
            using Activity activity = _activitySource.StartActivity(lcMethod)!;
            _loggerPMT02500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception? loException = new R_Exception();
            R_ServiceSaveResultDTO<PMT02500UnitCharges_Charges_RevenueSharingSchemeOriginalDTO> loReturn = new();
            try
            {
                _loggerPMT02500.LogInfo(string.Format("Initialize the loCls object as a new instance of Cls in method {0}", lcMethod));
                PMT02500UnitCharges_Charges_RevenueSharingSchemeCls? loCls = new();
        ...
        [HttpPost]
        public R_ServiceDeleteResultDTO R_ServiceDelete(R_ServiceDeleteParameterDTO<PMT02500UnitCharges_Charges_RevenueSharingSchemeOriginalDTO> poParameter)
        {
