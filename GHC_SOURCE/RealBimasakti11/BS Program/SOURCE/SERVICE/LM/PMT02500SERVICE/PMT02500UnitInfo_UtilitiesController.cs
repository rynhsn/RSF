...
namespace PMT02500Service
{
    ...
    [ApiController]
    public class PMT02500UnitInfo_UtilitiesController : ControllerBase, IPMT02500UnitInfo_Utilities
    {
        private readonly LoggerPMT02500? _loggerPMT01500;
        private readonly ActivitySource _activitySource;

        public PMT02500UnitInfo_UtilitiesController(ILogger<PMT02500UnitInfo_UtilitiesController> logger)
        {
        ...
        public IAsyncEnumerable<PMT02500UnitInfoUnit_UtilitiesListDTO> GetUnitInfoList()
        {
            ...
            PMT02500GetUnitInfo_UtilitiesParameterDTO? loDbParameter;
            List<PMT02500UnitInfoUnit_UtilitiesListDTO> loRtnTmp;
            PMT02500UnitInfo_UtilitiesCls loCls;
            IAsyncEnumerable<PMT02500UnitInfoUnit_UtilitiesListDTO>? loReturn = null;
            ...
            try
            {
                ...
                {
                    loDbParameter.CPROPERTY_ID = R_Utility.R_GetStreamingContext<string>(PMT02500GetUnitInfo_UtilitiesParameterContextDTO.CPROPERTY_ID);
                    loDbParameter.CDEPT_CODE = R_Utility.R_GetStreamingContext<string>(PMT02500GetUnitInfo_UtilitiesParameterContextDTO.CDEPT_CODE);
                    loDbParameter.CREF_NO = R_Utility.R_GetStreamingContext<string>(PMT02500GetUnitInfo_UtilitiesParameterContextDTO.CREF_NO);
                    loDbParameter.CTRANS_CODE = R_Utility.R_GetStreamingContext<string>(PMT02500GetUnitInfo_UtilitiesParameterContextDTO.CTRANS_CODE);
                    loDbParameter.CUNIT_ID = R_Utility.R_GetStreamingContext<string>(PMT02500GetUnitInfo_UtilitiesParameterContextDTO.CUNIT_ID);
                    loDbParameter.CFLOOR_ID = R_Utility.R_GetStreamingContext<string>(PMT02500GetUnitInfo_UtilitiesParameterContextDTO.CFLOOR_ID);
                    loDbParameter.CBUILDING_ID = R_Utility.R_GetStreamingContext<string>(PMT02500GetUnitInfo_UtilitiesParameterContextDTO.CBUILDING_ID);
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public IAsyncEnumerable<PMT02500ComboBoxStartInvoicePeriodYearDTO> GetComboBoxDataCSTART_INV_PRDYear()
        {
            ...
            R_Exception loException = new R_Exception();
            List<PMT02500ComboBoxStartInvoicePeriodYearDTO> loRtnTmp;
            PMT02500UnitInfo_UtilitiesCls loCls;
            IAsyncEnumerable<PMT02500ComboBoxStartInvoicePeriodYearDTO>? loReturn = null;
            PMT02500Utilities? loUtilities = null;
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        [HttpPost]
        public R_ServiceGetRecordResultDTO<PMT02500UnitInfoUnit_UtilitiesDetailDTO> R_ServiceGetRecord(R_ServiceGetRecordParameterDTO<PMT02500UnitInfoUnit_UtilitiesDetailDTO> poParameter)
        {
            string? lcMethod = nameof(R_ServiceGetRecord);
            using Activity activity = _activitySource.StartActivity(lcMethod)!;
            _loggerPMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            var loEx = new R_Exception();
            var loRtn = new R_ServiceGetRecordResultDTO<PMT02500UnitInfoUnit_UtilitiesDetailDTO>();

            try
            {
                _loggerPMT01500.LogInfo(string.Format("Initialize the loCls in method {0}", lcMethod));
                var loCls = new PMT02500UnitInfo_UtilitiesCls();
                _loggerPMT01500.LogDebug("{@PMT01500UnitInfo_UtilitiesCls}", loCls);
        ...
        [HttpPost]
        public R_ServiceSaveResultDTO<PMT02500UnitInfoUnit_UtilitiesDetailDTO> R_ServiceSave(R_ServiceSaveParameterDTO<PMT02500UnitInfoUnit_UtilitiesDetailDTO> poParameter)
        {
            string? lcMethod = nameof(R_ServiceSave);
            using Activity activity = _activitySource.StartActivity(lcMethod)!;
            _loggerPMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception? loException = new R_Exception();
            R_ServiceSaveResultDTO<PMT02500UnitInfoUnit_UtilitiesDetailDTO> loReturn = new();
            try
            {
                _loggerPMT01500.LogInfo(string.Format("Initialize the loCls object as a new instance of Cls in method {0}", lcMethod));
                PMT02500UnitInfo_UtilitiesCls? loCls = new();
        ...
        [HttpPost]
        public R_ServiceDeleteResultDTO R_ServiceDelete(R_ServiceDeleteParameterDTO<PMT02500UnitInfoUnit_UtilitiesDetailDTO> poParameter)
        {
        ...
        public IAsyncEnumerable<PMT02500ComboBoxStartInvoicePeriodMonthDTO> GetComboBoxDataCSTART_INV_PRDMonth()
        {
            ...
            R_Exception loException = new R_Exception();
            List<PMT02500ComboBoxStartInvoicePeriodMonthDTO> loRtnTmp;
            PMT02500UnitInfo_UtilitiesCls loCls;
            IAsyncEnumerable<PMT02500ComboBoxStartInvoicePeriodMonthDTO>? loReturn = null;
            PMT02500Utilities? loUtilities = null;
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public IAsyncEnumerable<PMT02500ComboBoxCMeterNoDTO> GetComboBoxDataCMETER_NO(PMT02500GetUnitInfo_UtilitiesCMeterNoParameterDTO poParameter)
        {
            ...
            R_Exception loException = new R_Exception();
            PMT02500UtilitiesParameterDTO? loDbParameterInternal;
            PMT02500GetUnitInfo_UtilitiesCMeterNoParameterDTO? loDbParameter;
            List<PMT02500ComboBoxCMeterNoDTO> loRtnTmp;
            PMT02500UnitInfo_UtilitiesCls loCls;
            IAsyncEnumerable<PMT02500ComboBoxCMeterNoDTO>? loReturn = null;
            PMT02500Utilities? loUtilities = null;
