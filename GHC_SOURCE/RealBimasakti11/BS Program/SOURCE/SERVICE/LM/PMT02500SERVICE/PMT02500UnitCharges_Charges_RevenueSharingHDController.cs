...
namespace PMT02500Service
{
    ...
    [ApiController]
    public class PMT02500UnitCharges_Charges_RevenueSharingHDController : ControllerBase, IPMT02500UnitCharges_Charges_RevenueSharingHD
    {
        private readonly LoggerPMT02500? _loggerPMT02500;
        private readonly ActivitySource _activitySource;


        public PMT02500UnitCharges_Charges_RevenueSharingHDController(ILogger<PMT02500UnitCharges_Charges_RevenueSharingHDController> logger)
        {
            LoggerPMT02500.R_InitializeLogger(logger);
            _loggerPMT02500 = LoggerPMT02500.R_GetInstanceLogger();
            _activitySource = PMT02500Activity.R_InitializeAndGetActivitySource(nameof(PMT02500UnitCharges_Charges_RevenueSharingHDController));
        }

        [HttpPost]
        public IAsyncEnumerable<PMT02500UnitCharges_Charges_RevenueSharingHDDTO> GetRevenueSharingHDList()
        {
            string? lcMethod = nameof(GetRevenueSharingHDList);
            ...
            List<PMT02500UnitCharges_Charges_RevenueSharingHDDTO> loRtnTmp;
            PMT02500UnitCharges_Charges_RevenueSharingHDCls loCls;
            IAsyncEnumerable<PMT02500UnitCharges_Charges_RevenueSharingHDDTO>? loReturn = null;
            ...
            try
            {
                ...
                {
                    loDbParameter.CPROPERTY_ID = R_Utility.R_GetStreamingContext<string>(PMT02500GetAgreementChargesInfo_RevenueSharingHDContextDTO.CPROPERTY_ID);
                    loDbParameter.CDEPT_CODE = R_Utility.R_GetStreamingContext<string>(PMT02500GetAgreementChargesInfo_RevenueSharingHDContextDTO.CDEPT_CODE);
                    loDbParameter.CREF_NO = R_Utility.R_GetStreamingContext<string>(PMT02500GetAgreementChargesInfo_RevenueSharingHDContextDTO.CREF_NO);
                    loDbParameter.CTRANS_CODE = R_Utility.R_GetStreamingContext<string>(PMT02500GetAgreementChargesInfo_RevenueSharingHDContextDTO.CTRANS_CODE);
                    loDbParameter.CCHARGE_SEQ_NO = R_Utility.R_GetStreamingContext<string>(PMT02500GetAgreementChargesInfo_RevenueSharingHDContextDTO.CCHARGE_SEQ_NO);
                ...
                loRtnTmp = loCls.GetRevenueSharingHDListDb(poParameterInternal: loDbParameterInternal, poParameter: loDbParameter);
        ...
        [HttpPost]
        public R_ServiceGetRecordResultDTO<PMT02500UnitCharges_Charges_RevenueSharingHDDTO> R_ServiceGetRecord(R_ServiceGetRecordParameterDTO<PMT02500UnitCharges_Charges_RevenueSharingHDDTO> poParameter)
        {
            string? lcMethod = nameof(R_ServiceGetRecord);
            _loggerPMT02500.LogInfo(string.Format("Start Method {0}", lcMethod));
            var loEx = new R_Exception();
            var loRtn = new R_ServiceGetRecordResultDTO<PMT02500UnitCharges_Charges_RevenueSharingHDDTO>();

            try
            {
                _loggerPMT02500.LogInfo(string.Format("Initialize the loCls in method {0}", lcMethod));
                var loCls = new PMT02500UnitCharges_Charges_RevenueSharingHDCls();
                _loggerPMT02500.LogDebug("{@PMT01500ChargesInfo_RevenueSharingCls}", loCls);
        ...
        [HttpPost]
        public R_ServiceSaveResultDTO<PMT02500UnitCharges_Charges_RevenueSharingHDDTO> R_ServiceSave(R_ServiceSaveParameterDTO<PMT02500UnitCharges_Charges_RevenueSharingHDDTO> poParameter)
        {
            string? lcMethod = nameof(R_ServiceSave);
            using Activity activity = _activitySource.StartActivity(lcMethod)!;
            _loggerPMT02500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception? loException = new R_Exception();
            R_ServiceSaveResultDTO<PMT02500UnitCharges_Charges_RevenueSharingHDDTO> loReturn = new();
            try
            {
                _loggerPMT02500.LogInfo(string.Format("Initialize the loCls object as a new instance of Cls in method {0}", lcMethod));
                PMT02500UnitCharges_Charges_RevenueSharingHDCls? loCls = new();
        ...
        [HttpPost]
        public R_ServiceDeleteResultDTO R_ServiceDelete(R_ServiceDeleteParameterDTO<PMT02500UnitCharges_Charges_RevenueSharingHDDTO> poParameter)
        {
