...
namespace PMT02500Service
{
    ...
    [ApiController]
    public class PMT02500InvoicePlanController : ControllerBase, IPMT02500InvoicePlan
    {
        private readonly LoggerPMT02500? _loggerPMT01500;
        private readonly ActivitySource _activitySource;

        public PMT02500InvoicePlanController(ILogger<PMT02500InvoicePlanController> logger)
        {
        ...
        public PMT02500InvoicePlanHeaderDTO GetInvoicePlanHeader(PMT02500GetHeaderParameterDTO poParameter)
        {
            ...
            PMT02500InvoicePlanHeaderDTO? loReturn = null;
            PMT02500InvoicePlanCls loCls;
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public IAsyncEnumerable<PMT02500InvoicePlanChargesListDTO> GetInvoicePlanChargeList()
        {
            ...
            PMT02500UtilitiesParameterDTO? loDbParameterInternal;
            PMT02500GetHeaderParameterDTO? loDbParameter;
            List<PMT02500InvoicePlanChargesListDTO> loRtnTmp;
            PMT02500InvoicePlanCls loCls;
            IAsyncEnumerable<PMT02500InvoicePlanChargesListDTO>? loReturn = null;
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public IAsyncEnumerable<PMT02500InvoicePlanListDTO> GetInvoicePlanList()
        {
            ...
            R_Exception loException = new R_Exception();
            PMT02500UtilitiesParameterDTO? loDbParameterInternal;
            PMT02500InvoicePlanParameterDbDTO? loDbParameter;
            List<PMT02500InvoicePlanListDTO> loRtnTmp;
            PMT02500InvoicePlanCls loCls;
            IAsyncEnumerable<PMT02500InvoicePlanListDTO>? loReturn = null;
            PMT02500Utilities? loUtilities = null;
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(loDbParameterInternal.CCOMPANY_ID))
                {
                    loDbParameter.CLOI_REC_ID = R_Utility.R_GetStreamingContext<string>(PMT02500InvoicePlanParameterContextDTO.CLOI_REC_ID);
                    loDbParameter.CAGRMT_REC_ID = R_Utility.R_GetStreamingContext<string>(PMT02500InvoicePlanParameterContextDTO.CAGRMT_REC_ID);
                    loDbParameter.CCHARGES_ID = R_Utility.R_GetStreamingContext<string>(PMT02500InvoicePlanParameterContextDTO.CCHARGES_ID);
                    loDbParameterInternal.CUSER_ID = R_BackGlobalVar.USER_ID;
                }
                _loggerPMT01500.LogDebug("{@ObjectParameterInternal}", loDbParameterInternal);
                _loggerPMT01500.LogDebug("{@ObjectParameter}", loDbParameter);
