...
namespace PMT02500Service
{
    ...
    [ApiController]
    public class PMT02500ChargesInfo_RevenueSharingController : ControllerBase, IPMT02500ChargesInfo_RevenueSharing
    {
        private readonly LoggerPMT02500? _loggerPMT01500;
        private readonly ActivitySource _activitySource;

        public PMT02500ChargesInfo_RevenueSharingController(ILogger<PMT02500ChargesInfo_RevenueSharingController> logger)
        {
        ...
        public IAsyncEnumerable<PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO> GetRevenueSharingSchemeList()
        {
            ...
            PMT02500ParameterForChargesInfo_RevenueSharingDTO? loDbParameter;
            List<PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO> loRtnTmp;
            PMT02500ChargesInfo_RevenueSharingCls loCls;
            IAsyncEnumerable<PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO>? loReturn = null;
            ...
            try
            {
                ...
                {
                    loDbParameter.CPROPERTY_ID = R_Utility.R_GetStreamingContext<string>(PMT02500GetAgreementChargesInfo_RevenueSharingContextDTO.CPROPERTY_ID);
                    loDbParameter.CDEPT_CODE = R_Utility.R_GetStreamingContext<string>(PMT02500GetAgreementChargesInfo_RevenueSharingContextDTO.CDEPT_CODE);
                    loDbParameter.CREF_NO = R_Utility.R_GetStreamingContext<string>(PMT02500GetAgreementChargesInfo_RevenueSharingContextDTO.CREF_NO);
                    loDbParameter.CTRANS_CODE = R_Utility.R_GetStreamingContext<string>(PMT02500GetAgreementChargesInfo_RevenueSharingContextDTO.CTRANS_CODE);
                    loDbParameter.CCHARGE_SEQ_NO = R_Utility.R_GetStreamingContext<string>(PMT02500GetAgreementChargesInfo_RevenueSharingContextDTO.CCHARGE_SEQ_NO);
                    /*
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public IAsyncEnumerable<PMT02500ChargesInfo_RevenueMinimumRentDTO> GetRevenueMinimumRentList()
        {
            ...
            PMT02500UtilitiesParameterDTO? loDbParameterInternal;
            PMT02500ParameterForChargesInfo_RevenueSharingDTO? loDbParameter;
            List<PMT02500ChargesInfo_RevenueMinimumRentDTO> loRtnTmp;
            PMT02500ChargesInfo_RevenueSharingCls loCls;
            IAsyncEnumerable<PMT02500ChargesInfo_RevenueMinimumRentDTO>? loReturn = null;
            PMT02500Utilities? loUtilities = null;
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        [HttpPost]
        public R_ServiceGetRecordResultDTO<PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO> R_ServiceGetRecord(R_ServiceGetRecordParameterDTO<PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO> poParameter)
        {
            string? lcMethod = nameof(R_ServiceGetRecord);
            using Activity activity = _activitySource.StartActivity(lcMethod)!;
            _loggerPMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            var loEx = new R_Exception();
            var loRtn = new R_ServiceGetRecordResultDTO<PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO>();

            try
            {
                _loggerPMT01500.LogInfo(string.Format("Initialize the loCls in method {0}", lcMethod));
                var loCls = new PMT02500ChargesInfo_RevenueSharingCls();
                _loggerPMT01500.LogDebug("{@PMT01500ChargesInfo_RevenueSharingCls}", loCls);
        ...
        [HttpPost]
        public R_ServiceSaveResultDTO<PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO> R_ServiceSave(R_ServiceSaveParameterDTO<PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO> poParameter)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            _loggerPMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception? loException = new R_Exception();
            R_ServiceSaveResultDTO<PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO> loReturn = new();
            try
            {
                _loggerPMT01500.LogInfo(string.Format("Initialize the loCls object as a new instance of Cls in method {0}", lcMethod));
                PMT02500ChargesInfo_RevenueSharingCls? loCls = new();
        ...
        [HttpPost]
        public R_ServiceDeleteResultDTO R_ServiceDelete(R_ServiceDeleteParameterDTO<PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO> poParameter)
        {
