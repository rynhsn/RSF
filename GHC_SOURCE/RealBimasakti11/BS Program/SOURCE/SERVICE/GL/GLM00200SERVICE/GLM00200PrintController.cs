    ...
    public class GLM00200PrintController : R_ReportControllerBase
    {
        ...
        private GLM00200ResultWithBaseHeaderPrintDTO GenerateDataPrint(JournalDTO poParam)
        {
            ...
            try
            {
                ...
                GLM00200ResultPrintDTO loData = new() { LabelPrint = new JournalLabelPrint() };
                ...
                {
                    CCOMPANY_NAME = loCls.GetRecordCompanyName(R_BackGlobalVar.COMPANY_ID).CCOMPANY_NAME,
                    CPRINT_CODE = poParam.CCOMPANY_ID.ToUpper(),
                    CPRINT_NAME = "ACTUAL RECURRING JOURNL",
