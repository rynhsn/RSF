...
namespace PMT00500BACK
{
    public class PMT00500Cls 
    {
        ...
        private RSP_PM_MANTAIN_LEASE_OWNERSHIPResources.Resources_Dummy_Class _loRSP9 = new RSP_PM_MANTAIN_LEASE_OWNERSHIPResources.Resources_Dummy_Class();
        ...
        private LoggerPMT00500Print _Printlogger;
        private readonly ActivitySource _activitySource;

        public PMT00500Cls()
        {
            _Logger = LoggerPMT00500.R_GetInstanceLogger();
            var loActivity = PMT00500ActivitySourceBase.R_GetInstanceActivitySource();
        ...
        public PMT00500Cls(LoggerPMT00500Print poParam)
        {
            _Printlogger = LoggerPMT00500Print.R_GetInstanceLogger();
            _activitySource = PMT00500PrintActivitySourceBase.R_GetInstanceActivitySource();
        }
        public List<PMT00500DTO> GetAllLOI(string pcPropertyId, string pcTransStatusList)
        {
            ...
            try
            {
                ...
                loResult = R_Utility.R_ConvertTo<PMT00500DTO>(loDataTable).ToList();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public PMT00500DTO GetLOIDisplay(PMT00500DTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity("GetLOIDisplay");
            var loEx = new R_Exception();
            PMT00500DTO loResult = null;
            ...
            try
            {
                ...
                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);
                loResult = R_Utility.R_ConvertTo<PMT00500DTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public PMT00500DTO SaveLOI(PMT00500DTO poNewEntity, eCRUDMode poCRUDMode)
        {
            using Activity activity = _activitySource.StartActivity("SaveLOI");
            var loEx = new R_Exception();
            PMT00500DTO loRtn = null;
            PMT00510DTO loUnitData = null;
            try
            {
                using (TransactionScope transactionScope = new TransactionScope(TransactionScopeOption.Required))
                {
                    ...
                    if (poNewEntity.OUNIT_LITS_DATA != null && poCRUDMode == eCRUDMode.AddMode)
                    {
                        var loClsUnit = new PMT00510Cls(_Logger);

                        foreach (PMT00500BuildingUnitDTO item in poNewEntity.OUNIT_LITS_DATA)
                        {
                            var loConvertItem = R_Utility.R_ConvertObjectToObject<PMT00500BuildingUnitDTO, PMT00510DTO>(item);
                            loConvertItem.CPROPERTY_ID = loRtn.CPROPERTY_ID;
                            loConvertItem.CDEPT_CODE = loRtn.CDEPT_CODE;
                            loConvertItem.CREF_NO = loRtn.CREF_NO;

                            loUnitData =  loClsUnit.R_Save(loConvertItem, poCRUDMode);
                        }
        ...
        private void SavingLOISP(PMT00500DTO poNewEntity, eCRUDMode poCRUDMode)
        {
            ...
            try
            {
                ...
                loDB.R_AddCommandParameter(loCmd, "@CLINK_TRANS_CODE", DbType.String, 30, poCRUDMode == eCRUDMode.AddMode ? poNewEntity.VAR_LINK_TRANS_CODE : poNewEntity.CLINK_TRANS_CODE);
                loDB.R_AddCommandParameter(loCmd, "@CLINK_REF_NO", DbType.String, 30,poCRUDMode == eCRUDMode.AddMode ? poNewEntity.VAR_LINK_REF_NO : poNewEntity.CLINK_REF_NO);

                loDB.R_AddCommandParameter(loCmd, "@CTRANS_MODE", DbType.String, 1, poCRUDMode == eCRUDMode.AddMode && !string.IsNullOrWhiteSpace(poNewEntity.VAR_TRANS_MODE) ? poNewEntity.VAR_TRANS_MODE : ContextConstant.VAR_TRANS_MODE);
                loDB.R_AddCommandParameter(loCmd, "@CFROM_AGRMT_ID", DbType.String, 50, poCRUDMode == eCRUDMode.AddMode ? poNewEntity.VAR_AGRMT_ID : "");
                ...
                try
                {
                    ...
                    var loTempResult = R_Utility.R_ConvertTo<PMT00500DTO>(loDataTable).FirstOrDefault();
        ...
        public void UpdateAgreementTransStatus(PMT00500SubmitRedraftDTO poEntity)
        {
        ...
        #region Report
        public PMT00500ParameterPrintLogoResultDTO GetBaseHeaderLogoCompany(PMT00500ParameterPrintLogoResultDTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity("GetBaseHeaderLogoCompany");
            var loEx = new R_Exception();
            PMT00500ParameterPrintLogoResultDTO loResult = null;
            ...
            try
            {
                ...
                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);
                loResult = R_Utility.R_ConvertTo<PMT00500ParameterPrintLogoResultDTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public List<PMT00500ResultSPPrintDTO> GetPrintResultSP(PMT00500ParameterPrintLogoResultDTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity("GetPrintResultSP");
            var loEx = new R_Exception();
            List<PMT00500ResultSPPrintDTO> loResult = null;
            ...
            try
            {
                ...
                loResult = R_Utility.R_ConvertTo<PMT00500ResultSPPrintDTO>(loDataTable).ToList();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public void LeaseProcessSP(PMT00500LeaseDTO poNewEntity)
        {
            using Activity activity = _activitySource.StartActivity("LeaseProcessSP");
            R_Exception loEx = new R_Exception();
            R_Db loDB = new R_Db();
            DbCommand loCmd = null;
            DbConnection loConn = null;
            ...
            try
            {
                ...
                loDB.R_BulkInsert<PMT00510MappingLeaseDTO>((SqlConnection)loConn, "#GRID_UNIT", poNewEntity.UnitList);
                #endregion
                ...
                loDB.SqlExecNonQuery(lcQuery, loConn, false);
                loDB.R_BulkInsert<PMT00520MappingLeaseDTO>((SqlConnection)loConn, "#GRID_UTILITY", poNewEntity.UtilityList);
                #endregion
                ...
                loDB.SqlExecNonQuery(lcQuery, loConn, false);
                loDB.R_BulkInsert<PMT00530MappingLeaseDTO>((SqlConnection)loConn, "#GRID_CHARGES", poNewEntity.ChargesList);
                #endregion
