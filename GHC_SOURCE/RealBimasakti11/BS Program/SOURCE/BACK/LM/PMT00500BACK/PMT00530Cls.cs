...
{
    public class PMT00530Cls : R_BusinessObject<PMT00530DTO>
    {
        ...
        public PMT00530Cls()
        {
            ...
            _activitySource = PMT00530ActivitySourceBase.R_GetInstanceActivitySource();
        }

        public List<PMT00530DTO> GetAllLOICharges(PMT00530DTO poEntity)
        {
            ...
            try
            {
                ...
                loResult = R_Utility.R_ConvertTo<PMT00530DTO>(loDataTable).ToList();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        protected override PMT00530DTO R_Display(PMT00530DTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity("R_Display");
            var loEx = new R_Exception();
            PMT00530DTO loResult = null;
            ...
            try
            {
             ...
             .Where(x => x != null && x.ParameterName.StartsWith("@")).Select(x => x.Value);
                ...
                loResult = R_Utility.R_ConvertTo<PMT00530DTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        protected override void R_Saving(PMT00530DTO poNewEntity, eCRUDMode poCRUDMode)
        {
            ...
            try
            {
                ...
                loDb.R_BulkInsert<PMT00500AgreementChargeCalUnitDTO>((SqlConnection)loConn, "#CHARGES_CAL_UNIT", poNewEntity.CHARGE_CALL_UNIT_LIST);
                ...
                try
                {
                    ...
                    var loTempResult = R_Utility.R_ConvertTo<PMT00530DTO>(loDataTable).FirstOrDefault();
        ...
        protected override void R_Deleting(PMT00530DTO poEntity)
        {
        ...
        public void ChangeStatusLOICharge(PMT00530ActiveInactiveDTO poNewEntity)
        {
