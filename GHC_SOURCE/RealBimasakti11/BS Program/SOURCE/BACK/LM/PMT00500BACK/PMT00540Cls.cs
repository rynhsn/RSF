...
{
    public class PMT00540Cls : R_BusinessObject<PMT00540DTO>
    {
        ...
        public PMT00540Cls()
        {
            ...
            _activitySource = PMT00540ActivitySourceBase.R_GetInstanceActivitySource();
        }

        public List<PMT00540DTO> GetAllLOIDeposit(PMT00540DTO poEntity)
        {
            ...
            try
            {
                ...
                loResult = R_Utility.R_ConvertTo<PMT00540DTO>(loDataTable).ToList();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        protected override PMT00540DTO R_Display(PMT00540DTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity("R_Display");
            var loEx = new R_Exception();
            PMT00540DTO loResult = null;
            ...
            try
            {
             ...
             .Where(x => x != null && x.ParameterName.StartsWith("@")).Select(x => x.Value);
                ...
                loResult = R_Utility.R_ConvertTo<PMT00540DTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        protected override void R_Saving(PMT00540DTO poNewEntity, eCRUDMode poCRUDMode)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@LCONTRACTOR", DbType.Boolean, 10, poNewEntity.LCONTRACTOR);
                ...
                try
                {
                    ...
                    var loTempResult = R_Utility.R_ConvertTo<PMT00540DTO>(loDataTable).FirstOrDefault();
        ...
        protected override void R_Deleting(PMT00540DTO poEntity)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@LCONTRACTOR", DbType.Boolean, 10, poEntity.LCONTRACTOR);
