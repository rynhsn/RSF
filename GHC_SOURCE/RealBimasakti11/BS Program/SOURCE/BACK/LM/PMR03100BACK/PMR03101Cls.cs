...
namespace PMR03100BACK
{
    public class PMR03101Cls
    {
        ...
        public List<SPResultDTO> GetReportDataList(SPParamDTO poParam)
        {
            using Activity activity = _activitySource.StartActivity(MethodBase.GetCurrentMethod().Name);
            R_Exception loEx = new R_Exception();
            List<SPResultDTO> loRtn = null;
            R_Db loDB = null;
            ...
            try
            {
                ...
                lcQuery = "RSP_PMR03100_GET_REPORT";
                ...
                loDB.R_AddCommandParameter(loCmd, "@CCUT_OFF_YEAR", DbType.String, int.MaxValue, poParam.CCUT_OFF_YEAR);
                loDB.R_AddCommandParameter(loCmd, "@CUSER_ID", DbType.String, int.MaxValue, poParam.CUSER_ID);

                ShowLogDebug(lcQuery, loCmd.Parameters);
                var loRtnTemp = loDB.SqlExecQuery(loConn, loCmd, true);
                loRtn = R_Utility.R_ConvertTo<SPResultDTO>(loRtnTemp).ToList();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
