...
{
    public class PMT01310Cls : R_BusinessObject<PMT01310DTO>
    {
        ...
        public PMT01310Cls()
        {
            ...
            _activitySource = PMT01310ActivitySourceBase.R_GetInstanceActivitySource();
        }

        public List<PMT01310DTO> GetAllLOIUnit(PMT01310DTO poEntity)
        {
            ...
            try
            {
                ...
                loResult = R_Utility.R_ConvertTo<PMT01310DTO>(loDataTable).ToList();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        protected override PMT01310DTO R_Display(PMT01310DTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity("R_Display");
            var loEx = new R_Exception();
            PMT01310DTO loResult = null;
            ...
            try
            {
             ...
             .Where(x => x != null && x.ParameterName.StartsWith("@")).Select(x => x.Value);
                ...
                loResult = R_Utility.R_ConvertTo<PMT01310DTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        protected override void R_Saving(PMT01310DTO poNewEntity, eCRUDMode poCRUDMode)
        {
        ...
        protected override void R_Deleting(PMT01310DTO poEntity)
        {
