...
{
    public class PMT02630Cls : R_BusinessObject<PMT02630DTO>
    {
        RSP_PM_MAINTAIN_AGREEMENT_DEPOSITResources.Resources_Dummy_Class _loRspMaintainDeposit = new RSP_PM_MAINTAIN_AGREEMENT_DEPOSITResources.Resources_Dummy_Class();
        ...
        public PMT02630Cls()
        {
            ...
            _activitySource = PMT02630ActivitySourceBase.R_GetInstanceActivitySource();
        }

        public List<PMT02630DTO> GetAllAgreementDeposit(PMT02630DTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity("GetAllAgreementDeposit");
            ...
            try
            {
                ...
                loResult = R_Utility.R_ConvertTo<PMT02630DTO>(loDataTable).ToList();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        protected override PMT02630DTO R_Display(PMT02630DTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity("R_Display");
            var loEx = new R_Exception();
            PMT02630DTO loResult = null;
            ...
            try
            {
             ...
             .Where(x => x != null && x.ParameterName.StartsWith("@")).ToDictionary(x => x.ParameterName, x => x.Value);
                ...
                loResult = R_Utility.R_ConvertTo<PMT02630DTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        protected override void R_Saving(PMT02630DTO poNewEntity, eCRUDMode poCRUDMode)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@CCONTRACTOR_ID", DbType.String, 20, "");
                ...
                try
                {
                    ...
                    var loTempResult = R_Utility.R_ConvertTo<PMT02630DTO>(loDataTable).FirstOrDefault();
        ...
        protected override void R_Deleting(PMT02630DTO poEntity)
        {
