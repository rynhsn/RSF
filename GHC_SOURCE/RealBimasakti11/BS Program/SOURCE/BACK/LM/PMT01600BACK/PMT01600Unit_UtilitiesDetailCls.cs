...
{
    public class PMT01600Unit_UtilitiesDetailCls : R_BusinessObject<PMT01600Unit_UtilitiesDetailDTO>
    {
        ...
        protected override PMT01600Unit_UtilitiesDetailDTO R_Display(PMT01600Unit_UtilitiesDetailDTO poEntity)
        {
            ...
            try
            {
                ...
                _loggerPMT01600.LogInfo(string.Format("Convert the data in loRtn to data of PMT01600Unit_UtilitiesDetailDTO objects and assign it to loRtn in Method {0}", lcMethod));
                loRtn = R_Utility.R_ConvertTo<PMT01600Unit_UtilitiesDetailDTO>(loProfileDataTable).FirstOrDefault()!;
        ...
        protected override void R_Saving(PMT01600Unit_UtilitiesDetailDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            string? lcMethod = nameof(R_Saving);
            using Activity activity = _activitySource.StartActivity(lcMethod)!;
            _loggerPMT01600.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception? loException = new R_Exception();
            PMT01600Unit_UtilitiesDetailDTO loEntity;
            string? lcQuery;
            ...
            try
            {
                ...
                try
                {
                    ...
                    loEntity = R_Utility.R_ConvertTo<PMT01600Unit_UtilitiesDetailDTO>(loDataTable).FirstOrDefault()!;
        ...
        protected override void R_Deleting(PMT01600Unit_UtilitiesDetailDTO poEntity)
        {
