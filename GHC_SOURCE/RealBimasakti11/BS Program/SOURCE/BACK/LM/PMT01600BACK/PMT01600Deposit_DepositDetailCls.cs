...
{
    public class PMT01600Deposit_DepositDetailCls : R_BusinessObject<PMT01600Deposit_DepositDetailDTO>
    {
        ...
        protected override PMT01600Deposit_DepositDetailDTO R_Display(PMT01600Deposit_DepositDetailDTO poEntity)
        {
            ...
            try
            {
                ...
                _loggerPMT01600.LogInfo(string.Format("Convert the data in loRtn to data of PMT01600Deposit_DepositDetailDTO objects and assign it to loRtn in Method {0}", lcMethod));
                loRtn = R_Utility.R_ConvertTo<PMT01600Deposit_DepositDetailDTO>(loProfileDataTable).FirstOrDefault()!;
        ...
        protected override void R_Saving(PMT01600Deposit_DepositDetailDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            string? lcMethod = nameof(R_Saving);
            using Activity activity = _activitySource.StartActivity(lcMethod)!;
            _loggerPMT01600.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception? loException = new R_Exception();
            PMT01600Deposit_DepositDetailDTO loEntity;
            string? lcQuery;
            ...
            try
            {
                ...
                try
                {
                    ...
                    loEntity = R_Utility.R_ConvertTo<PMT01600Deposit_DepositDetailDTO>(loDataTable).FirstOrDefault()!;
        ...
        protected override void R_Deleting(PMT01600Deposit_DepositDetailDTO poEntity)
        {
