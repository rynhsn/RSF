...
{
    public class PMT02500ChargesInfo_RevenueSharingCls : R_BusinessObject<PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO>
    {
        private readonly LoggerPMT02500? _loggerLMT01500;
        private readonly ActivitySource _activitySource;

        public PMT02500ChargesInfo_RevenueSharingCls()
        {
        ...
        public List<PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO> GetRevenueSharingSchemeListDb(PMT02500UtilitiesParameterDTO poParameterInternal, PMT02500ParameterForChargesInfo_RevenueSharingDTO poParameter)
        {
            string? lcMethod = nameof(GetRevenueSharingSchemeListDb);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            List<PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO>? loReturn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            try
            {
                ...
                */
                ...
                loReturn = R_Utility.R_ConvertTo<PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO>(loDataTable).ToList();
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        //Yang Kanan
        public List<PMT02500ChargesInfo_RevenueMinimumRentDTO> GetRevenueMinimumRentListDb(PMT02500UtilitiesParameterDTO poParameterInternal, PMT02500ParameterForChargesInfo_RevenueSharingDTO poParameter)
        {
            string? lcMethod = nameof(GetRevenueMinimumRentListDb);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            List<PMT02500ChargesInfo_RevenueMinimumRentDTO>? loReturn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            try
            {
                ...
                loReturn = R_Utility.R_ConvertTo<PMT02500ChargesInfo_RevenueMinimumRentDTO>(loDataTable).ToList();
                _loggerLMT01500.LogDebug("{@ObjectReturn}", loReturn);
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        protected override PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO R_Display(PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO poEntity)
        {
            string? lcMethod = nameof(R_Display);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO? loRtn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
...
#pragma warning disable CS8600 // Converting null literal or possible null value to non-nullable type.
                loRtn = R_Utility.R_ConvertTo<PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO>(loProfileDataTable).FirstOrDefault();
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        protected override void R_Saving(PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO poNewEntity, eCRUDMode poCRUDMode)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception? loException = new R_Exception();
            PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO? loEntity;
            string? lcQuery;
            ...
            try
            {
                ...
                try
                {
                    ...
                    loEntity = R_Utility.R_ConvertTo<PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO>(loDataTable).FirstOrDefault();
        ...
        protected override void R_Deleting(PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO poEntity)
        {
