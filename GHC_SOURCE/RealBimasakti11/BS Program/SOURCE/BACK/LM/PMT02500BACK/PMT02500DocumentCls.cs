...
{
    public class PMT02500DocumentCls : R_BusinessObject<PMT02500DocumentDetailDTO>
    {
        private Resources_Dummy_Class _oRsp = new Resources_Dummy_Class();
        private RSP_GS_GET_STORAGE_TYPEResources.Resources_Dummy_Class _oRspStorage = new RSP_GS_GET_STORAGE_TYPEResources.Resources_Dummy_Class();

        private readonly LoggerPMT02500? _loggerLMT01500;
        private readonly ActivitySource _activitySource;

        public PMT02500DocumentCls()
        {
            _loggerLMT01500 = LoggerPMT02500.R_GetInstanceLogger();
            _activitySource = PMT02500Activity.R_GetInstanceActivitySource();
        }

        public PMT02500DocumentHeaderDTO GetDocumentHeaderDb(PMT02500UtilitiesParameterDTO poParameterInternal, PMT02500GetHeaderParameterDTO poParameter)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            ...
            PMT02500DocumentHeaderDTO? loRtn = null;
            ...
            try
            {
                ...
                loRtn = R_Utility.R_ConvertTo<PMT02500DocumentHeaderDTO>(loDataTable).FirstOrDefault();
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<PMT02500DocumentListDTO> GetDocumentListDb(PMT02500UtilitiesParameterDTO poParameterInternal, PMT02500GetHeaderParameterDTO poParameter)
        {
            string? lcMethod = nameof(GetDocumentListDb);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            List<PMT02500DocumentListDTO>? loReturn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            try
            {
                ...
                loReturn = R_Utility.R_ConvertTo<PMT02500DocumentListDTO>(loDataTable).ToList();
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        protected override PMT02500DocumentDetailDTO R_Display(PMT02500DocumentDetailDTO poEntity)
        {
            string? lcMethod = nameof(R_Display);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            PMT02500DocumentDetailDTO? loRtn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
...
#pragma warning disable CS8600 // Converting null literal or possible null value to non-nullable type.
                loRtn = R_Utility.R_ConvertTo<PMT02500DocumentDetailDTO>(loProfileDataTable).FirstOrDefault();
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
#pragma warning disable CS8604 // Possible null reference argument.
                _loggerLMT01500.LogDebug("{@ObjectReturn}", loRtn);
#pragma warning restore CS8604 // Possible null reference argument.
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        protected override void R_Saving(PMT02500DocumentDetailDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            var loEx = new R_Exception();
            PMT02500DocumentDetailDTO? loResult = null;
            R_Db? loDb = new R_Db();
            ...
            try
            {
                ...
                {
                    PMT02500StorageTypeDTO loDataStorageType = GetStorageType(loConn);
        ...
        private PMT02500StorageTypeDTO GetStorageType(DbConnection poConnection)
        {
            string? lcMethod = nameof(GetDocumentHeaderDb);
#pragma warning disable CS8600 // Converting null literal or possible null value to non-nullable type.
            using Activity activity = _activitySource.StartActivity(lcMethod);
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            var loEx = new R_Exception();
            PMT02500StorageTypeDTO? loResult = null;
            var loDb = new R_Db();
            DbConnection? loConn = null;
            ...
            try
            {
                ...
                try
                {
                    ...
                    loResult = R_Utility.R_ConvertTo<PMT02500StorageTypeDTO>(loDataTable).FirstOrDefault()!;
                    _loggerLMT01500.LogInfo("after exec RSP_GS_GET_STORAGE_TYPE", lcMethod);
                }
                catch (Exception ex)
                {
                    loEx.Add(ex);
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        private void SaveDataSP(PMT02500DocumentDetailDTO poNewEntity, eCRUDMode poCRUDMode, DbConnection poConnection)
        {
            var loEx = new R_Exception();
            string lcQuery = "";
            var loDb = new R_Db();
        ...
        private bool ValidateAlreadyExists(PMT02500DocumentDetailDTO poNewEntity, DbConnection poConnection)
        {
            var loEx = new R_Exception();
            string lcQuery = "";
            var loDb = new R_Db();
            DbConnection? loConn = null;
            DbCommand? loCmd = null;
            PMT02500ResultDocumentUploadDTO? loResult;
            bool llRtn = false;
            ...
            try
            {
                ...
                //Debug Logs
                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, false);
                loResult = loDataTable.DataSet != null ? R_Utility.R_ConvertTo<PMT02500ResultDocumentUploadDTO>(loDataTable).FirstOrDefault() : new PMT02500ResultDocumentUploadDTO();
        ...
        private PMT02500DocumentDetailDTO R_StorageId(ref PMT02500DocumentDetailDTO poNewEntity, PMT02500StorageTypeDTO poStorageType, bool plExists, DbConnection poConnection)
        {
            var loEx = new R_Exception();
            var loDb = new R_Db();
            DbConnection? loConn = null;
        ...
        protected override void R_Deleting(PMT02500DocumentDetailDTO poEntity)
        {
            var loEx = new R_Exception();
            string lcQuery = "";
            var loDb = new R_Db();
