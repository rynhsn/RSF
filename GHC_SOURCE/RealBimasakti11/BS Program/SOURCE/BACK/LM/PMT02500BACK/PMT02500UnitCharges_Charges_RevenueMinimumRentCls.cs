...
{
    public class PMT02500UnitCharges_Charges_RevenueMinimumRentCls : R_BusinessObject<PMT02500UnitCharges_Charges_RevenueMinimumRentDTO>
    {
        private readonly LoggerPMT02500? _loggerPMT02500;
        private readonly ActivitySource _activitySource;

        public PMT02500UnitCharges_Charges_RevenueMinimumRentCls()
        {
            _loggerPMT02500 = LoggerPMT02500.R_GetInstanceLogger();
            _activitySource = PMT02500Activity.R_GetInstanceActivitySource();
        }
        // Yang kanan
        public List<PMT02500UnitCharges_Charges_RevenueMinimumRentDTO> GetRevenueMinimumRentListDb(PMT02500UtilitiesParameterDTO poParameterInternal, PMT02500UtilitiesParameterChargesInfo_RevenueSharingDTO poParameter)
        {
            string? lcMethod = nameof(GetRevenueMinimumRentListDb);
            _loggerPMT02500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            List<PMT02500UnitCharges_Charges_RevenueMinimumRentDTO>? loReturn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            try
            {
                ...
                _loggerPMT02500.LogInfo(string.Format("Convert the data in loDataTable to a list of PMT02500ChargesInfo_RevenueMinimumRentDTO objects and assign it to loRtn in Method {0}", lcMethod));
                loReturn = R_Utility.R_ConvertTo<PMT02500UnitCharges_Charges_RevenueMinimumRentDTO>(loDataTable).ToList();
        ...
        protected override PMT02500UnitCharges_Charges_RevenueMinimumRentDTO R_Display(PMT02500UnitCharges_Charges_RevenueMinimumRentDTO poEntity)
        {
            string? lcMethod = nameof(R_Display);
            _loggerPMT02500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            PMT02500UnitCharges_Charges_RevenueMinimumRentDTO? loRtn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            ...
            try
            {
                ...
                _loggerPMT02500.LogInfo(string.Format("Set the query string for lcQuery in Method {0}", lcMethod));
                lcQuery = "RSP_PM_GET_REVENUE_MIN_RENT_INFO";
                _loggerPMT02500.LogDebug("{@ObjectTextQuery}", lcQuery);
                ...
                loDb.R_AddCommandParameter(loCommand, "@IYEAR", DbType.Int32, Int32.MaxValue, poEntity.IYEAR);
                ...
                _loggerPMT02500.LogInfo(string.Format("Convert the data in loRtn to data of PMT02500ChargesInfo_RevenueSharingSchemeOriginalDTO objects and assign it to loRtn in Method {0}", lcMethod));
                loRtn = R_Utility.R_ConvertTo<PMT02500UnitCharges_Charges_RevenueMinimumRentDTO>(loProfileDataTable).FirstOrDefault();
        ...
        protected override void R_Saving(PMT02500UnitCharges_Charges_RevenueMinimumRentDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCommand, "@IYEAR", DbType.Int32, Int32.MaxValue, poNewEntity.IYEAR); // DITANYAKAN DARIMANA
                loDb.R_AddCommandParameter(loCommand, "@NRENT_RATE", DbType.Decimal, Int16.MaxValue, poNewEntity.NRENT_RATE);
                loDb.R_AddCommandParameter(loCommand, "@NMINIMUM_RENT", DbType.Decimal, Int16.MaxValue, poNewEntity.NMINIMUM_RENT);
        ...
        protected override void R_Deleting(PMT02500UnitCharges_Charges_RevenueMinimumRentDTO poEntity)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCommand, "@IYEAR", DbType.Int32, Int32.MaxValue, poEntity.IYEAR); // DITANYAKAN DARIMANA
                loDb.R_AddCommandParameter(loCommand, "@NRENT_RATE", DbType.Decimal, Int16.MaxValue, poEntity.NRENT_RATE);
                loDb.R_AddCommandParameter(loCommand, "@NMINIMUM_RENT", DbType.Decimal, Int16.MaxValue, poEntity.NMINIMUM_RENT);
