...
{
    public class PMT02500UnitInfo_UtilitiesCls : R_BusinessObject<PMT02500UnitInfoUnit_UtilitiesDetailDTO>
    {
        private readonly Resources_Dummy_Class _oRSP = new();
        private readonly LoggerPMT02500? _loggerLMT01500;
        private readonly ActivitySource _activitySource;

        public PMT02500UnitInfo_UtilitiesCls()
        {
            _loggerLMT01500 = LoggerPMT02500.R_GetInstanceLogger();
            _activitySource = PMT02500Activity.R_GetInstanceActivitySource();
        }

        public List<PMT02500UnitInfoUnit_UtilitiesListDTO> GetUnitInfoListDb(PMT02500UtilitiesParameterDTO poParameterInternal, PMT02500GetUnitInfo_UtilitiesParameterDTO poParameter)
        {
            string? lcMethod = nameof(GetUnitInfoListDb);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            List<PMT02500UnitInfoUnit_UtilitiesListDTO>? loReturn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            try
            {
                ...
                loReturn = R_Utility.R_ConvertTo<PMT02500UnitInfoUnit_UtilitiesListDTO>(loDataTable).ToList();
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<PMT02500ComboBoxStartInvoicePeriodYearDTO> GetComboBoxDataCSTART_INV_PRDYearDb(string pcCCOMPANY_ID)
        {
            string? lcMethod = nameof(GetComboBoxDataCSTART_INV_PRDYearDb);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            List<PMT02500ComboBoxStartInvoicePeriodYearDTO>? loReturn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            try
            {
                ...
                loReturn = R_Utility.R_ConvertTo<PMT02500ComboBoxStartInvoicePeriodYearDTO>(loDataTable).ToList();
                _loggerLMT01500.LogDebug("{@ObjectReturn}", loReturn);
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<PMT02500ComboBoxStartInvoicePeriodMonthDTO> GetComboBoxDataCSTART_INV_PRDMonthDb(string pcCCOMPANY_ID)
        {
            string? lcMethod = nameof(GetComboBoxDataCSTART_INV_PRDMonthDb);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            List<PMT02500ComboBoxStartInvoicePeriodMonthDTO>? loReturn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            try
            {
                ...
                loReturn = R_Utility.R_ConvertTo<PMT02500ComboBoxStartInvoicePeriodMonthDTO>(loDataTable).ToList();
                _loggerLMT01500.LogDebug("{@ObjectReturn}", loReturn);
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<PMT02500ComboBoxDTO> GetComboBoxDataCCHARGES_TYPEDb(PMT02500UtilitiesWithCultureIDParameterDTO poParameterInternal)
        {
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<PMT02500ComboBoxCMeterNoDTO> GetComboBoxDataCMETER_NODb(PMT02500UtilitiesParameterDTO poParameterInternal, PMT02500GetUnitInfo_UtilitiesCMeterNoParameterDTO poParameter)
        {
            string? lcMethod = nameof(GetComboBoxDataCMETER_NODb);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            List<PMT02500ComboBoxCMeterNoDTO>? loReturn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            try
            {
                ...
                loReturn = R_Utility.R_ConvertTo<PMT02500ComboBoxCMeterNoDTO>(loDataTable).ToList();
                _loggerLMT01500.LogDebug("{@ObjectReturn}", loReturn);
                /*
                if (!loReturn.Any())
                {
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        protected override PMT02500UnitInfoUnit_UtilitiesDetailDTO R_Display(PMT02500UnitInfoUnit_UtilitiesDetailDTO poEntity)
        {
            string? lcMethod = nameof(R_Display);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            PMT02500UnitInfoUnit_UtilitiesDetailDTO? loRtn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            ...
            try
            {
                ...
                loRtn = R_Utility.R_ConvertTo<PMT02500UnitInfoUnit_UtilitiesDetailDTO>(loProfileDataTable).FirstOrDefault();
                if (loRtn != null)
                {
        ...
        protected override void R_Saving(PMT02500UnitInfoUnit_UtilitiesDetailDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            string? lcMethod = nameof(R_Saving);
            using Activity activity = _activitySource.StartActivity(lcMethod)!;
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception? loException = new R_Exception();
            PMT02500UnitInfoUnit_UtilitiesDetailDTO? loEntity;
            string? lcQuery;
            ...
            try
            {
                ...
                try
                {
                    ...
                    loEntity = R_Utility.R_ConvertTo<PMT02500UnitInfoUnit_UtilitiesDetailDTO>(loDataTable).FirstOrDefault();
        ...
        protected override void R_Deleting(PMT02500UnitInfoUnit_UtilitiesDetailDTO poEntity)
        {
