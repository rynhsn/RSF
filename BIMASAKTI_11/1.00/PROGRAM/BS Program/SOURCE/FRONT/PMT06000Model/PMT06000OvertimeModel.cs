...
{
    public class PMT06000OvertimeModel : R_BusinessObjectServiceClientBase<PMT06000OvtDTO>, IPMT06000Overtime
    {
        private const string DEFAULT_HTTP_NAME = "R_DefaultServiceUrlPM";
        private const string DEFAULT_SERVICEPOINT_NAME = "api/PMT06000Overtime";
        private const string DEFAULT_MODULE = "pm";

        public PMT06000OvertimeModel(
