...
namespace GSM04500Model.ViewModel
{
    public class GSM04500AccountSettingViewModel : R_ViewModel<GSM04500AccountSettingDTO>
    {
        ...
        private GSM04500AccountSettingModel _model = new();

        public ObservableCollection<GSM04500AccountSettingDTO> GridList = new();

        public GSM04500JournalGroupDTO ParentEntity = new();
        public GSM04500AccountSettingDTO Entity = new();
