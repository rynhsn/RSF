...
{
    public class GSM02570Model : R_BusinessObjectServiceClientBase<GSM02503ImageParameterDTO>, IGSM02570
    {
        private const string DEFAULT_HTTP_NAME = "R_DefaultServiceUrl";
        private const string DEFAULT_SERVICEPOINT_NAME = "api/GSM02570";
        private const string DEFAULT_MODULE = "gs";

        public GSM02570Model(string pcHttpClientName = DEFAULT_HTTP_NAME,
        ...
        public async Task<GSM02503ImageListDTO> GetUnitTypeImageListStreamAsync()
        {
            ...
            try
            {
                ...
                loResult = await R_HTTPClientWrapper.R_APIRequestStreamingObject<GSM02503ImageDTO>(
                    ...
                    nameof(IGSM02570.GetUnitTypeImageList),
                    DEFAULT_MODULE,
                    _SendWithContext,
                    _SendWithToken);
        ...
        public async Task<ShowUnitTypeImageResultDTO> ShowUnitTypeImageAsync(ShowUnitTypeImageParameterDTO poParam)
        {
            ...
            try
            {
                ...
                loRtn = await R_HTTPClientWrapper.R_APIRequestObject<ShowUnitTypeImageResultDTO, ShowUnitTypeImageParameterDTO>(
                    _RequestServiceEndPoint,
                    nameof(IGSM02570.ShowUnitTypeImage),
                    poParam,
                    DEFAULT_MODULE,
                    _SendWithContext,
                    _SendWithToken);
