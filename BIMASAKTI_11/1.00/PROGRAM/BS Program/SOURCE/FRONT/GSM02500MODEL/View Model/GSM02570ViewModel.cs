...
{
    public class GSM02570ViewModel : R_ViewModel<GSM02503ImageDTO>
    {
        ...
        public ShowUnitTypeImageParameterDTO loShowImageParam { get; set; } = new ShowUnitTypeImageParameterDTO();
        ...
        public void ImageValidation(GSM02503ImageDTO poParam)
        {
            ...
            try
            {
                llCancel = string.IsNullOrWhiteSpace(poParam.CFILE_ID);
                if (llCancel)
                {
        ...
        public async Task GetImageListStreamAsync()
        {
            ...
            try
            {
                ...
                R_FrontContext.R_SetStreamingContext(ContextConstant.GSM02503_UNIT_TYPE_ID_STREAMING_CONTEXT, loShowImageParam.CSELECTED_UNIT_TYPE_ID);
