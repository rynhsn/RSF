...
{
    public class GSM02540UtilitiesViewModel : R_ViewModel<GSM02531UtilityDetailDTO>
    {
        private GSM02540UtilitiesModel loModel = new GSM02540UtilitiesModel();
        ...
        public GSM02531UtilityResultDTO loRtn = new GSM02531UtilityResultDTO();

        public GSM02531UtilityTypeResultDTO loRtnUtilityType = new GSM02531UtilityTypeResultDTO();
        ...
        {
            R_Exception loException = new R_Exception();
            SelectedOtherUnitParameterDTO loParam = null;
            try
            {
                loParam = new SelectedOtherUnitParameterDTO()
                {
                    CPROPERTY_ID = loTabParameter.CSELECTED_PROPERTY_ID,
                    COTHER_UNIT_ID = loTabParameter.CSELECTED_OTHER_UNIT_ID
                };
                SelectedOtherUnit = await loSharedModel.GetSelectedOtherUnitAsync(loParam);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        public async Task GetUtilitiesListStreamAsync()
        {
            ...
            try
            {
                ...
                R_FrontContext.R_SetStreamingContext(ContextConstant.GSM02540_OTHER_UNIT_ID_STREAMING_CONTEXT, loTabParameter.CSELECTED_OTHER_UNIT_ID);
        ...
        public async Task ActiveInactiveProcessAsync()
        {
            ...
            try
            {
                ...
                {
                    CPROPERTY_ID = loTabParameter.CSELECTED_PROPERTY_ID,
                    CUNIT_ID = loTabParameter.CSELECTED_OTHER_UNIT_ID,
