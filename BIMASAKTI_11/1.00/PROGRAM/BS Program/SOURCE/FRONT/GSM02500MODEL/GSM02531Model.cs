...
{
    public class GSM02531Model : R_BusinessObjectServiceClientBase<GSM02531UtilityParameterDTO>, IGSM02531
    {
        private const string DEFAULT_HTTP_NAME = "R_DefaultServiceUrl";
        private const string DEFAULT_SERVICEPOINT_NAME = "api/GSM02531";
        private const string DEFAULT_MODULE = "gs";

        public GSM02531Model(string pcHttpClientName = DEFAULT_HTTP_NAME,
        ...
        public async Task<TemplateUnitUtilityDTO> DownloadTemplateUnitUtilityAsync()
        {
            ...
            try
            {
                ...
                var loTempResult = await R_HTTPClientWrapper.R_APIRequestObject<TemplateUnitUtilityDTO>(
                    ...
                    nameof(IGSM02531.DownloadTemplateUnitUtility),
                    DEFAULT_MODULE,
                    _SendWithContext,
                    _SendWithToken);
        ...
        public async Task<GSM02531UtilityResultDTO> GetUtilitiesListStreamAsync()
        {
            ...
            try
            {
                ...
                loResult = await R_HTTPClientWrapper.R_APIRequestStreamingObject<GSM02531UtilityDTO>(
                    _RequestServiceEndPoint,
                    nameof(IGSM02531.GetUtilitiesList),
                    DEFAULT_MODULE,
                    _SendWithContext,
                    _SendWithToken);
        ...
        public async Task<GSM02531UtilityTypeResultDTO> GetUtilityTypeListStreamAsync()
        {
            ...
            try
            {
                ...
                loResult = await R_HTTPClientWrapper.R_APIRequestStreamingObject<GSM02531UtilityTypeDTO>(
                    _RequestServiceEndPoint,
                    nameof(IGSM02531.GetUtilityTypeList),
                    DEFAULT_MODULE,
                    _SendWithContext,
                    _SendWithToken);
        ...
        public GSM02500ActiveInactiveResultDTO RSP_GS_ACTIVE_INACTIVE_BUILDING_UNIT_UTILITIESMethod(GSM02500ActiveInactiveParameterDTO poParam)
        {
            throw new NotImplementedException();
        }
        
        public async Task RSP_GS_ACTIVE_INACTIVE_BUILDING_UNIT_UTILITIESMethodAsync(GSM02500ActiveInactiveParameterDTO poParam)
        {
            R_Exception loEx = new R_Exception();
            ...
            try
            {
                ...
                loRtn = await R_HTTPClientWrapper.R_APIRequestObject<GSM02500ActiveInactiveResultDTO, GSM02500ActiveInactiveParameterDTO> (
                    _RequestServiceEndPoint,
                    nameof(IGSM02531.RSP_GS_ACTIVE_INACTIVE_BUILDING_UNIT_UTILITIESMethod),
                    poParam,
                    DEFAULT_MODULE,
                    _SendWithContext,
                    _SendWithToken);
