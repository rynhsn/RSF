...
namespace GLM00500Model.ViewModel
{
    ...
    {
        public ObservableCollection<GLM00500UploadForSystemDTO> UploadedList =
            new ObservableCollection<GLM00500UploadForSystemDTO>();
        ...
        public List<GLM00500UploadToSystemDTO> UploadListResult { get; set; } = new List<GLM00500UploadToSystemDTO>();
        ...
        public void AssignData(IEnumerable<GLM00500UploadFromFileDTO> poData)
        {
