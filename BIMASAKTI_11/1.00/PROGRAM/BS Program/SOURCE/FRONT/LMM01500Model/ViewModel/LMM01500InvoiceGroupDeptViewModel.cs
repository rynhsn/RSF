...
public class LMM01500InvoiceGroupDeptViewModel : R_ViewModel<LMM01500InvGrpDeptDTO>
{
    private LMM01500InitModel _initModel = new();
    private LMM01500InvoiceGroupDeptModel _model = new();

    public ObservableCollection<LMM01500InvGrpDeptGridDTO> GridList = new();
    public LMM01500InvGrpDeptDTO Entity = new();
    public LMM01500InvGrpDTO HeaderEntity = new();
    ...
    public async Task Init(object poParam)
    {
        ...
        HeaderEntity = (LMM01500InvGrpDTO)poParam;
    }
    ...
    public async Task GetGridList()
    {
        ...
        try
        {
            ...
            GridList = new ObservableCollection<LMM01500InvGrpDeptGridDTO>(loReturn);
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
    ...
    public async Task GetEntity(LMM01500InvGrpDeptDTO poParam)
    {
        var loEx = new R_Exception();
    ...
    public async Task DeleteEntity(LMM01500InvGrpDeptDTO poEntity)
    {
        var loEx = new R_Exception();
    ...
    public async Task SaveEntity(LMM01500InvGrpDeptDTO poNewEntity, eCRUDMode peCRUDMode)
    {
        var loEx = new R_Exception();
