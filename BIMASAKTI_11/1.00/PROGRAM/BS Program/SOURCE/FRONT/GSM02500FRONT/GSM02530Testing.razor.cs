...
{
    public partial class GSM02530Testing : R_Page
    {
        //Unit Info
        ...
        private TabParameterDTOTesting loTempParameter = new TabParameterDTOTesting();
        ...
        protected override async Task R_Init_From_Master(object poParameter)
        {
            ...
            try
            {
                ...
                loTempParameter = (TabParameterDTOTesting)poParameter;
                loUnitInfoViewModel.loTabParameter = new TabParameterDTO()
                {
                    CSELECTED_PROPERTY_ID = loTempParameter.CSELECTED_PROPERTY_ID,
                    CSELECTED_BUILDING_ID = loTempParameter.CSELECTED_BUILDING_ID,
                    CSELECTED_FLOOR_ID = loTempParameter.CSELECTED_FLOOR_ID,
                    CSELECTED_UNIT_ID = loTempParameter.CSELECTED_UNIT_ID
                };
