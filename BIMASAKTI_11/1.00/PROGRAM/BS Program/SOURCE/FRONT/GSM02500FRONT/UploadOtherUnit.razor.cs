...
namespace GSM02500FRONT
{
    public partial class UploadOtherUnit : R_Page
    {
        ...
        {
            var loData = (UploadOtherUnitDTO)eventArgs.Data;
       ...
            }
        ...
        public void ReadExcelFile()
        {
            ...
            try
            {
                var loDataSet = Excel.R_ReadExcel(loUploadOtherUnitViewModel.fileByte, action =>
                {
                    action.TableNames = new string[] { "OtherUnit" };
                });
