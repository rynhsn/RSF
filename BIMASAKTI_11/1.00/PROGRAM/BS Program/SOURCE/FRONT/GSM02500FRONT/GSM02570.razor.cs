...
{
    public partial class GSM02570 : R_Page
    {
        ...
        public GSM02570ViewModel loImageViewModel = new();
        ...
        protected override async Task R_Init_From_Master(object poParameter)
        {
            ...
            try
            {
                ...
                loImageViewModel.SelectedProperty.CPROPERTY_NAME = loParameter.CSELECTED_PROPERTY_NAME;
                loImageViewModel.loShowImageParam.CSELECTED_UNIT_TYPE_ID = loParameter.CSELECTED_UNIT_TYPE_ID;
                loImageViewModel.loShowImageParam.CSELECTED_PROPERTY_ID = loParameter.CSELECTED_PROPERTY_ID;
            ...
            try
            {
                if (eventArgs.Success)
                {
                    ...
                    if (loResult.LRESULT)
                    {
                        ...
                        {
                            CFILE_ID = loResult.CIMAGE_ID,
                            CFILE_NAME = loResult.CIMAGE_NAME
                        });
        ...
        private async Task Grid_DisplayImage(R_DisplayEventArgs eventArgs)
        {
            if (eventArgs.ConductorMode == R_eConductorMode.Normal)
            {
                ...
                loImageViewModel.SelectedImageId = loParam.CFILE_ID;
            }
        }
