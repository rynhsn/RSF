...
namespace LMT03500Model.ViewModel
{
    public class PMT03500UploadUtilityViewModel : R_IProcessProgressStatus
    {
        ...
        public async Task SaveBulkFile()
        {
            ...
            try
            {
                ...
                loBatchParUserParameters.Add(new R_KeyValue
                    { Key = PMT03500ContextConstant.CUTILITY_TYPE, Value = UploadParam.EUTILITY_TYPE == ELMT03500UtilityUsageType.EC ? "EC" : "WG" });
        ...
        private async Task ServiceGetError(string pcKeyGuid)
        {
            ...
            try
            {
                ...
                {
                    ELMT03500UtilityUsageType.EC => "RSP_PM_UPLOAD_UTILITY_USAGE_ECResources",
                    ELMT03500UtilityUsageType.WG => "RSP_PM_UPLOAD_UTILITY_USAGE_WGResources",
                ...
                else
                {
                    ...
                    if (UploadParam.EUTILITY_TYPE == ELMT03500UtilityUsageType.EC)
                    {
                        ...
                        // var loExcelData = R_FrontUtility.ConvertCollectionToCollection<PMT03500UploadUtilityExcelECDTO>(GridListUpload);

                        // var loDataTable = R_FrontUtility.R_ConvertTo<PMT03500UploadUtilityExcelECDTO>(loExcelData);
                    ...
                    else if (UploadParam.EUTILITY_TYPE == ELMT03500UtilityUsageType.WG)
                    {
    ...
    {
        public ELMT03500UtilityUsageType EUTILITY_TYPE { get; set; }
    ...
    {
        public ELMT03500UtilityUsageType EUTILITY_TYPE { get; set; }
        public LMT03500UtilityUsageDTO OUTILITY_HEADER { get; set; }
    }
}