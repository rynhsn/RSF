...
{
    public class LMT03500UpdateMeterViewModel : R_ViewModel<PMT03500UtilityMeterDetailDTO>
    {
        ...
        public async Task GetList(object poParam)
        {
            ...
            try
            {
                ...
                var loReturn = await _model.GetListStreamAsync<PMT03500UtilityMeterDTO>(nameof(ILMT03500UpdateMeter
        ...
        public async Task GetRecord(PMT03500UtilityMeterDTO poEntity)
        {
            ...
            try
            {
                ...
                var loReturn = await _model.GetAsync<LMT03500SingleDTO<PMT03500UtilityMeterDetailDTO>, LMT03500UtilityMeterDetailParam>(nameof(ILMT03500UpdateMeter.LMT03500GetUtilityMeterDetail), loParam);
        ...
        public async Task GetAgreementTenant(LMT03500UpdateMeterHeader poParam)
        {
            ...
            try
            {
                ...
                var loReturn = await _model.GetAsync<LMT03500SingleDTO<PMT03500AgreementUtilitiesDTO>, LMT03500AgreementUtilitiesParam>(nameof(ILMT03500UpdateMeter.LMT03500GetAgreementUtilities), loParam);
        ...
        public async Task UpdateMeterNo(PMT03500UtilityMeterDetailDTO poParam)
        {
            ...
            try
            {
                ...
                await _model.ExecuteAsync<PMT03500UtilityMeterDetailDTO, LMT03500UpdateChangeMeterNoParam>(nameof(ILMT03500UpdateMeter.LMT03500UpdateMeterNo), loParam);
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public async Task ChangeMeterNo(PMT03500UtilityMeterDetailDTO poParam)
        {
            ...
            try
            {
                ...
                await _model.ExecuteAsync<PMT03500UtilityMeterDetailDTO, LMT03500UpdateChangeMeterNoParam>(nameof(ILMT03500UpdateMeter.LMT03500ChangeMeterNo), loParam);
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public async Task GetUtilityTypeList()
        {
            ...
            try
            {
                var loReturn = await _modelUtility.GetAsync<LMT03500ListDTO<LMT03500FunctDTO>>(nameof(ILMT03500UtilityUsage.LMT03500GetUtilityTypeList));
