...
namespace PMT03500Model.ViewModel
{
    public class PMT03500UploadCutOffViewModel : R_IProcessProgressStatus
    {
        ...
        public async Task SaveBulkFile(PMT03500UploadParam poUploadParam, List<PMT03500UploadCutOffErrorValidateDTO> poDataList)
        {
        ...
        public async Task ConvertGrid(List<PMT03500UploadCutOffExcelDTO> poEntity)
        {
            ...
            try
            {
                ...
                var loData = new List<PMT03500UploadCutOffErrorValidateDTO>();

                if(UploadParam.EUTILITY_TYPE == EPMT03500UtilityUsageType.EC)
                {
                    loData = poEntity.Select((item, i) => new PMT03500UploadCutOffErrorValidateDTO
                    {
                        NO = i + 1,
        ...
        private async Task ServiceGetError(string pcKeyGuid)
        {
            ...
            try
            {
                ...
                {
                    EPMT03500UtilityUsageType.EC => "RSP_PM_UPLOAD_UTILITY_CUTOFF_ECResources",
                    EPMT03500UtilityUsageType.WG => "RSP_PM_UPLOAD_UTILITY_CUTOFF_WGResources",
