...
{
    public partial class PMT01350 : R_Page, R_ITabPage
    {
        #region ViewModel
        private PMT01350ViewModel _viewModel = new PMT01350ViewModel();
        ...
        #region Grid
        private R_Grid<PMT01351DTO> _gridLOIChargesListRef;
        private R_Grid<PMT01350DTO> _gridInvoiceListRef;
        #endregion
        ...
        private PMT01351DTO _SelectedCharges = new PMT01351DTO();
        #endregion
        ...
        protected override async Task R_Init_From_Master(object poParameter)
        {
            ...
            try
            {
                var loData = (PMT01300LOIParameterInvoicePlanDTO)poParameter;
                var loParam = R_FrontUtility.ConvertObjectToObject<PMT01300DTO>(poParameter);
        ...
        public async Task RefreshTabPageAsync(object poParam)
        {
            ...
            try
            {
                var loData = (PMT01300LOIParameterInvoicePlanDTO)poParam;
                if (string.IsNullOrWhiteSpace(loData.CREF_NO) ==  false && string.IsNullOrWhiteSpace(loData.CUNIT_ID) == false)
                {
                    var loParam = R_FrontUtility.ConvertObjectToObject<PMT01300DTO>(poParam);
                    var loHeaderData = await _viewModelDetail.GetLOIWithResult(loParam);
                    loHeaderData.CUNIT_ID = loData.CUNIT_ID;
                    loHeaderData.CUNIT_NAME = loData.CUNIT_NAME;
                    _viewModel.LOI = loHeaderData;
        ...
        private async Task Charges_ServiceGetListRecord(R_ServiceGetListRecordEventArgs eventArgs)
        {
            ...
            try
            {
                var loParameter = R_FrontUtility.ConvertObjectToObject<PMT01351DTO>(eventArgs.Parameter);
        ...
        private async Task Charges_Display(R_DisplayEventArgs eventArgs)
        {
            ...
            try
            {
                ...
                {
                    var loData = (PMT01351DTO)eventArgs.Data;
        ...
        private async Task InvoicePlan_ServiceGetListRecord(R_ServiceGetListRecordEventArgs eventArgs)
        {
            ...
            try
            {
                var loParameter = R_FrontUtility.ConvertObjectToObject<PMT01350DTO>(eventArgs.Parameter);
