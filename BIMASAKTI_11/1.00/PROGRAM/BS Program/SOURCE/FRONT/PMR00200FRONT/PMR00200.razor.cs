...
namespace PMR00200FRONT
{
    public partial class PMR00200 : R_Page
    {
        ...
        private PMR00200ParamDTO GenerateParam()
        {
            R_Exception loEx = new R_Exception();
            PMR00200ParamDTO loParam = new();
            try
            {
                loParam = new PMR00200ParamDTO()
                {
        ...
        private void Validation(PMR00200ParamDTO poParam)
        {
            R_Exception loEx = new R_Exception();
            try
            {
        ...
        private async Task GeneratePrintAsync(PMR00200ParamDTO poParam)
        {
            R_Exception loEx = new R_Exception();
            try
            {
                ...
                {
                    await LOIStats_PrintDetailAsync(poParam);
                }
                else
                {
                    await LOIStats_PrintSummaryAsync(poParam);
                }
            }
            catch (Exception ex)
            {
        ...
        private async Task LOIStats_PrintDetailAsync(PMR00200ParamDTO poParam)
        {
            R_Exception loEx = new R_Exception();
            try
            {
                await _reportService.GetReport(
                    "R_DefaultServiceUrlPM",
                    "PM",
                    "rpt/PMR00220Print/DownloadResultPrintPost",
                    "rpt/PMR00220Print/LOIStatusDetail_ReportListGet", poParam);
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        private void BeforeOpen_PopupSaveAsAsync(R_BeforeOpenPopupEventArgs eventArgs)
        {
            ...
            eventArgs.TargetPageType = typeof(PMR00201);
        }
