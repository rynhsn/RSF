...
namespace PMR00460Model
{
    public class PMR00460Model : R_BusinessObjectServiceClientBase<PMR00460DataResultDTO>, IPMR00460
    {
        private const string DEFAULT_HTTP_NAME = "R_DefaultServiceUrlPM";
        private const string DEFAULT_SERVICEPOINT_NAME = "api/PMR00460";
        private const string DEFAULT_MODULE = "PM";

        public PMR00460Model(
