...
using ContextConstant = PMT00500COMMON.ContextConstant;

namespace PMT00500FRONT
{
    public partial class PMT00520 : R_Page, R_ITabPage
    {
        #region ViewModel
        private PMT00502ViewModel _viewModelList = new PMT00502ViewModel();
        private PMT00520ViewModel _viewModelHeader = new PMT00520ViewModel();
        private PMT00521ViewModel _viewModel = new PMT00521ViewModel();
        ...
        private R_Grid<PMT00520DTO> _gridLOIUtilitiesListRef;
        #endregion
        ...
        private R_ComboBox<PMT00500UniversalDTO, string> UtilityType_ComboBox;
        private R_ComboBox<PMT00500AgreementBuildingUtilitiesDTO, string> BuildingUtilities_ComboBox;
        ...
        protected async override Task<bool> R_LockUnlock(R_LockUnlockEventArgs eventArgs)
        {
            ...
            try
            {
                var loData = (PMT00510DTO)eventArgs.Data;
        ...
        public async Task RefreshTabPageAsync(object poParam)
        {
            ...
            try
            {
                ...
                {
                    _viewModelHeader.LOI = new PMT00500DTO();
        ...
        private async Task Unit_ServiceGetRecord(R_ServiceGetRecordEventArgs eventArgs)
        {
            ...
            try
            {
                await _viewModelHeader.GetLOIUnit((PMT00510DTO)eventArgs.Data);
        ...
        private async Task Unit_ServiceDelete(R_ServiceDeleteEventArgs eventArgs)
        {
            ...
            try
            {
                await _viewModelHeader.DeleteLOIUnit((PMT00510DTO)eventArgs.Data);
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        private async Task Grid_R_SetOther(R_SetEventArgs eventArgs)
        {
            ...
            PMT00500LOICallBackParameterDTO loData = new PMT00500LOICallBackParameterDTO { CRUD_MODE = eventArgs.Enable, LIS_ADD_DATA_LOI = IsAddDataLOI, SELECTED_DATA_TAB_LOI = _viewModelHeader.LOI, SELECTED_DATA_TAB_UNIT = loUnitData, LIS_LOI_UNIT_HAS_DATA = loHasData };
        ...
        private void Unit_Before_Open_Grid_Lookup(R_BeforeOpenGridLookupColumnEventArgs eventArgs)
        {
            ...
            loParam.CUNIT_CATEGORY_LIST = "01,03";
            loParam.CPROGRAM_ID = ContextConstant.VAR_PROGRAM_ID;
        ...
        private void Unit_After_Open_Grid_Lookup(R_AfterOpenGridLookupColumnEventArgs eventArgs)
        {
            ...
            var loData = (PMT00510DTO)eventArgs.ColumnData;
        ...
        private async Task Unit_CellLostFocus(R_CellLostFocusedEventArgs eventArgs)
        {
            ...
            try
            {
                ...
                {
                    var loData = (PMT00510DTO)eventArgs.CurrentRow;
        ...
        private async Task Utilities_ServiceGetListRecord(R_ServiceGetListRecordEventArgs eventArgs)
        {
            ...
            try
            {
                var loParameter = R_FrontUtility.ConvertObjectToObject<PMT00520DTO>(eventArgs.Parameter);
        ...
        private async Task Utilities_ServiceGetRecord(R_ServiceGetRecordEventArgs eventArgs)
        {
            ...
            try
            {
                await _viewModel.GetLOIUtilities((PMT00520DTO)eventArgs.Data);
        ...
        private async Task Utilities_Display(R_DisplayEventArgs eventArgs)
        {
            ...
            try
            {
                var loData = (PMT00520DTO)eventArgs.Data;
        ...
        private async Task Utilities_ServiceDelete(R_ServiceDeleteEventArgs eventArgs)
        {
            ...
            try
            {
                await _viewModel.DeleteLOIUtilities((PMT00520DTO)eventArgs.Data);
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        {
            eventArgs.Data = R_FrontUtility.ConvertObjectToObject<PMT00520DTO>(_gridLOIUnitListRef.CurrentSelectedData);
            var loData = (PMT00520DTO)eventArgs.Data;
        ...
        private async Task ChargeTab_Before_Open_TabPage(R_BeforeOpenTabPageEventArgs eventArgs)
        {
            ...
            try
            {
                ...
                eventArgs.TargetPageType = typeof(PMT00530);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        private async Task Utility_Activate_Before_Open_Popup(R_BeforeOpenPopupEventArgs eventArgs)
        {
            ...
            try
            {
                var loGetData = (PMT00520DTO)_conductorRef.R_GetCurrentData();
                var loValidateViewModel = new GFF00900Model.ViewModel.GFF00900ViewModel();
                loValidateViewModel.ACTIVATE_INACTIVE_ACTIVITY_CODE = "PMT00501"; //Uabh Approval Code sesuai Spec masing masing
                ...
                {
                    var loParam = R_FrontUtility.ConvertObjectToObject<PMT00520ActiveInactiveDTO>(loGetData);
                ...
                else //Disini Approval Code yang didapat adalah 2, yang berarti Active Inactive akan dijalankan jika User yang diinput ada di RSP_ACTIVITY_VALIDITY
                {
                    eventArgs.Parameter = new GFF00900ParameterDTO()
                    {
                        ...
                        IAPPROVAL_CODE = "PMT00501" //Uabh Approval Code sesuai Spec masing masing
                    };
