...
{
    public partial class PMT00501 : R_Page
    {
        private PMT00501ViewModel _viewModel = new PMT00501ViewModel();
        #region Inject
        ...
        #region Grid
        private R_Grid<PMT00500UploadAgreementExcelDTO>? _gridUploadAgreementRef;
        private R_Grid<PMT00500UploadUnitExcelDTO>? _gridUploadUnitRef;
        private R_Grid<PMT00500UploadUtilityExcelDTO>? _gridUploadUtilityRef;
        private R_Grid<PMT00500UploadChargesExcelDTO>? _gridUploadChargesRef;
        private R_Grid<PMT00500UploadDepositExcelDTO>? _gridUploadDepositRef;
        #endregion
        ...
        private async Task ActionFuncDataSetExcel()
        {
            ...
            var lcName = "StrataManager_" + DateTime.Now.ToString("yyyyMMdd_HHmm") + ".xlsx";
        ...
        {
            await R_MessageBox.Show("", R_FrontUtility.R_GetMessage(typeof(PMT00500FrontResources.Resources_Dummy_Class), "_NotifSuccesUpload"), R_eMessageBoxButtonType.OK);
        ...
        protected override async Task R_Init_From_Master(object poParameter)
        {
            ...
            try
            {
                _viewModel.Property = (PMT00500PropertyDTO)poParameter;
        ...
        {
            var loData = (PMT00500UploadAgreementExcelDTO)eventArgs.Data;
        ...
        {
            var loData = (PMT00500UploadUnitExcelDTO)eventArgs.Data;
        ...
        {
            var loData = (PMT00500UploadUtilityExcelDTO)eventArgs.Data;
        ...
        {
            var loData = (PMT00500UploadChargesExcelDTO)eventArgs.Data;
        ...
        {
            var loData = (PMT00500UploadDepositExcelDTO)eventArgs.Data;
        ...
        private async Task OnChangeInputFileStrata(InputFileChangeEventArgs eventArgs)
        {
            var loEx = new R_Exception();
            R_Exception loTempException = new R_Exception();
            DataSet loDataSet = null;
            List<PMT00500UploadAgreementExcelDTO> loAgreementResult = null;
            List<PMT00500UploadUnitExcelDTO> loUnitResult = null;
            List<PMT00500UploadChargesExcelDTO> loChargesResult = null;
            List<PMT00500UploadUtilityExcelDTO> loUtilityResult = null;
            List<PMT00500UploadDepositExcelDTO> loDepositResult = null;
            ...
            try
            {
                ...
                try
                {
                    loDataSet = ExcelInject.R_ReadFromExcel(lofileByte, new string[] { "StrataManager" });
                }
                catch (Exception ex)
                {
                    loDataSet = null;
                ...
                if (loDataSet == null)
                {
                    loAgreementResult = new List<PMT00500UploadAgreementExcelDTO>();
                    FileHasData = false;
                }
                else
                {
                    loAgreementResult = R_FrontUtility.R_ConvertTo<PMT00500UploadAgreementExcelDTO>(loDataSet.Tables[0]).ToList();
                ...
                if (loDataSet == null)
                {
                    loUnitResult = new List<PMT00500UploadUnitExcelDTO>();
                }
                else
                {
                    loUnitResult = R_FrontUtility.R_ConvertTo<PMT00500UploadUnitExcelDTO>(loDataSet.Tables[0]).ToList();
                }
                ...
                if (loDataSet == null)
                {
                    loUtilityResult = new List<PMT00500UploadUtilityExcelDTO>();
                }
                else
                {
                    loUtilityResult = R_FrontUtility.R_ConvertTo<PMT00500UploadUtilityExcelDTO>(loDataSet.Tables[0]).ToList();
                }
                ...
                if (loDataSet == null)
                {
                    loChargesResult = new List<PMT00500UploadChargesExcelDTO>();
                }
                else
                {
                    loChargesResult = R_FrontUtility.R_ConvertTo<PMT00500UploadChargesExcelDTO>(loDataSet.Tables[0]).ToList();
                }
                ...
                if (loDataSet == null)
                {
                    loDepositResult = new List<PMT00500UploadDepositExcelDTO>();
                }
                else
                {
                    loDepositResult = R_FrontUtility.R_ConvertTo<PMT00500UploadDepositExcelDTO>(loDataSet.Tables[0]).ToList();
                }
