...
{
    public partial class PMT00530 : R_Page, R_ITabPage
    {
        #region ViewModel
        private PMT00530ViewModel _viewModel = new PMT00530ViewModel();
        #endregion
        ...
        #region Grid
        private R_Grid<PMT00530DTO> _gridLOIChargeListRef;
        private R_Grid<PMT00500AgreementChargeCalUnitDTO> _gridLOIChargeCallChargeListRef;
        private R_Grid<PMT00500AgreementChargeCalUnitDTO> _gridLOIChargeCallChargeListDisplayRef;
        #endregion
        ...
        protected override async Task R_Init_From_Master(object poParameter)
        {
            ...
            try
            {
                var loData = (PMT00510DTO)poParameter;
        ...
        private async Task Charge_ServiceGetListRecord(R_ServiceGetListRecordEventArgs eventArgs)
        {
            ...
            try
            {
                var loParameter = R_FrontUtility.ConvertObjectToObject<PMT00530DTO>(eventArgs.Parameter);
        ...
        private async Task Charge_ServiceGetRecord(R_ServiceGetRecordEventArgs eventArgs)
        {
            ...
            try
            {
                await _viewModel.GetLOICharge((PMT00530DTO)eventArgs.Data);
        ...
        private async Task Charge_ServiceSave(R_ServiceSaveEventArgs eventArgs)
        {
            ...
            try
            {
                ...
                if (_viewModel.Data.LCAL_UNIT)
                {
                    ...
                    {
                        loData.CHARGE_CALL_UNIT_LIST = new List<PMT00500AgreementChargeCalUnitDTO>(_gridLOIChargeCallChargeListRef.DataSource);
                    }
                    else
                    {
                        loData.CHARGE_CALL_UNIT_LIST = new List<PMT00500AgreementChargeCalUnitDTO>();
                    }
                }
                else
                {
        ...
        private async Task Charge_ServiceDelete(R_ServiceDeleteEventArgs eventArgs)
        {
            ...
            try
            {
                await _viewModel.DeleteLOICharge((PMT00530DTO)eventArgs.Data);
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        private async Task Grid_R_SetOther(R_SetEventArgs eventArgs)
        {
            ...
            PMT00500LOICallBackParameterDTO loData = new PMT00500LOICallBackParameterDTO { CRUD_MODE = eventArgs.Enable };
            ...
            try
            {
                ...
                if (loData.LBASED_OPEN_DATE == false)
                {
                    ...
                    if (loData.DEND_DATE != null && loData.DSTART_DATE != null)
                    {
                        ...
                        {
                            if (liStartDate < liPlanStartDate)
                            {
                                loEx.Add(R_FrontUtility.R_GetError(
                                    typeof(PMT00500FrontResources.Resources_Dummy_Class),
                                    "V037"));
        ...
        private async Task ChargesCallUnit_ServiceGetListRecord(R_ServiceGetListRecordEventArgs eventArgs)
        {
            ...
            try
            {
                var loParameter = R_FrontUtility.ConvertObjectToObject<PMT00500ParameterAgreementChargeCalUnitDTO>(eventArgs.Parameter);
        ...
        {
            var loData = (PMT00500AgreementChargeCalUnitDTO)eventArgs.Data;
            loData.CFLOOR_ID = _viewModel.LOI_Unit.CFLOOR_ID;
            loData.CBUILDING_ID = _viewModel.LOI_Unit.CBUILDING_ID;
        }
        ...
        private void ChargesCallUnit_After_Open_Grid_Lookup(R_AfterOpenGridLookupColumnEventArgs eventArgs)
        {
            ...
            var loData = (PMT00500AgreementChargeCalUnitDTO)eventArgs.ColumnData;
        ...
        private async Task Currency_OnLostFocus()
        {
            ...
            try
            {
                var loData = (PMT00530DTO)_conductorRef.R_GetCurrentData();
        ...
        public async Task RefreshTabPageAsync(object poParam)
        {
            ...
            try
            {
                if (poParam !=  null)
                {
                    var loData = (PMT00510DTO)poParam;
                    EnableGreaterClosesSts = int.Parse(loData.CTRANS_STATUS_LOI) >= 80 == false;
                    _viewModel.LOI_Unit = loData;
                ...
                {
                    _viewModel.LOI_Unit = new PMT00510DTO();
        ...
        private async Task InvoicePlanBTN_OnClick()
        {
            ...
            try
            {
                PMT00500LOICallBackParameterDTO loData = new PMT00500LOICallBackParameterDTO { CRUD_MODE = _conductorRef.R_ConductorMode == R_BlazorFrontEnd.Enums.R_eConductorMode.Normal, TO_INVOICE_TAB = true, SELECTED_DATA_TAB_CHARGES = _gridLOIChargeListRef.CurrentSelectedData };
                await InvokeTabEventCallbackAsync(loData);
            }
            catch (Exception ex)
            {
        ...
        private async Task Charge_Activate_Before_Open_Popup(R_BeforeOpenPopupEventArgs eventArgs)
        {
            ...
            try
            {
                var loGetData = (PMT00530DTO)_conductorRef.R_GetCurrentData();
                ...
                {
                    var loParam = R_FrontUtility.ConvertObjectToObject<PMT00530ActiveInactiveDTO>(loGetData);
