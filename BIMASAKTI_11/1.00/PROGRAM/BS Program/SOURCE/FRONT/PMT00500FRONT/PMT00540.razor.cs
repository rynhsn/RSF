...
{
    public partial class PMT00540 : R_Page, R_ITabPage
    {
        #region ViewModel
        private PMT00540ViewModel _viewModel = new PMT00540ViewModel();
        ...
        #region Grid
        private R_Grid<PMT00540DTO> _gridLOIDepositListRef;
        #endregion
        ...
        protected async override Task<bool> R_LockUnlock(R_LockUnlockEventArgs eventArgs)
        {
            ...
            try
            {
                var loData = (PMT00540DTO)eventArgs.Data;
        ...
        private async Task Deposit_ServiceGetListRecord(R_ServiceGetListRecordEventArgs eventArgs)
        {
            ...
            try
            {
                var loParameter = R_FrontUtility.ConvertObjectToObject<PMT00540DTO>(eventArgs.Parameter);
        ...
        private async Task Deposit_ServiceGetRecord(R_ServiceGetRecordEventArgs eventArgs)
        {
            ...
            try
            {
                await _viewModel.GetLOIDeposit((PMT00540DTO)eventArgs.Data);
        ...
        private async Task Deposit_ServiceDelete(R_ServiceDeleteEventArgs eventArgs)
        {
            ...
            try
            {
                await _viewModel.DeleteLOIDeposit((PMT00540DTO)eventArgs.Data);
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        private async Task Contractor_OnLostFocus()
        {
            var loEx = new R_Exception();

            try
            {
                if (string.IsNullOrWhiteSpace(_viewModel.Data.CCONTRACTOR_ID) == false)
                {
                    LML00600ParameterDTO loParam = new LML00600ParameterDTO()
                    {
                        CPROPERTY_ID = _viewModel.Data.CPROPERTY_ID,
                        CSEARCH_TEXT = _viewModel.Data.CCONTRACTOR_ID,
                        CCUSTOMER_TYPE = "02"
                    };
                    ...
                    if (loResult == null)
                    {
                        loEx.Add(R_FrontUtility.R_GetError(
                                typeof(Lookup_GSFrontResources.Resources_Dummy_Class),
                                "_ErrLookup01"));
                        _viewModel.Data.CCONTRACTOR_NAME = "";
                        goto EndBlock;
                    }

                    _viewModel.Data.CCONTRACTOR_ID = loResult.CTENANT_ID;
                    _viewModel.Data.CCONTRACTOR_NAME = loResult.CTENANT_NAME;
                }
                else
                {
                    _viewModel.Data.CCONTRACTOR_NAME = "";
        ...
        private void R_Before_Open_LookupContractor(R_BeforeOpenLookupEventArgs eventArgs)
        {
            if (string.IsNullOrWhiteSpace(_viewModel.Data.CPROPERTY_ID))
            {
                return;
        ...
        private void R_After_Open_LookupContractor(R_AfterOpenLookupEventArgs eventArgs)
        {
            ...
            _viewModel.Data.CCONTRACTOR_ID = loTempResult.CTENANT_ID;
            _viewModel.Data.CCONTRACTOR_NAME = loTempResult.CTENANT_NAME;
        }
        #endregion
    }
}
