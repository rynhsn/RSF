...
namespace APR00300Model
{
    public class APR00300Model : R_BusinessObjectServiceClientBase<APR00300DataResultDTO>, IAPR00300
    {
        private const string DEFAULT_HTTP_NAME = "R_DefaultServiceUrlAP";
        private const string DEFAULT_SERVICEPOINT_NAME = "api/APR00300";
        private const string DEFAULT_MODULE = "AP";

        public APR00300Model(
