    ...
    public partial class PMM00100 : R_Page
    {
        ...
        private void SysParam_AfterAdd(R_AfterAddEventArgs eventArgs)
        {
            ...
            try
            {
                ...
                loData.CPROPERTY_NAME = _viewModel.SystemParams.FirstOrDefault(x => x.CPROPERTY_ID == _viewModel.CurrentPropertyId)?.CPROPERTY_NAME ?? "";
                if (loData != null)
                {
        ...
        public void SysParam_CheckAdd(R_CheckAddEventArgs eventArgs)
        {
            ...
            try
            {
                // if (!string.IsNullOrEmpty(_viewModel.CurrentPropertyId))
