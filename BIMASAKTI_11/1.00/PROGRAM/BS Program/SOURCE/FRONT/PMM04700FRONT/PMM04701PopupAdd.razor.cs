...
{
    public partial class PMM04701PopupAdd : R_Page
    {
        private R_ConductorGrid _conGridPricing;

        private PMM04700ViewModel _pricingAdd_ViewModel = new();

        private R_Grid<PricingBulkSaveDTO> _gridPricing;

        [Inject] private R_ILocalizer<PMM04700FrontResources.Resources_Dummy_Class> _localizer { get; set; }
        ...
        protected override async Task R_Init_From_Master(object poParameter)
        {
            ...
            try
            {
                ...
                _pricingAdd_ViewModel._OtherUnitId = loParam.COTHER_UNIT_TYPE_ID;
                _pricingAdd_ViewModel._OtherUnitName = loParam.COTHER_UNIT_TYPE_NAME;
        ...
        private void Validation(R_ValidationEventArgs eventArgs)
        {
            ...
            try
            {
                ...
                {
                    var loErr = R_FrontUtility.R_GetError(typeof(PMM04700FrontResources.Resources_Dummy_Class), "_validationDuplicateRent");
                    loEx.Add(loErr);
                }
            }
            catch (Exception ex)
        ...
        private async Task PricingAdd_Process()
        {
            ...
            try
            {
                ...
                if (_pricingAdd_ViewModel._validDateForm < DateTime.Now.Date)
                {
                    ...
                    {
                        ACTIVATE_INACTIVE_ACTIVITY_CODE = "PMM04701"
                    };
