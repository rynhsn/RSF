...
using PMR00210MODEL.View_Models;
...
namespace PMR00210FRONT
{
    public partial class PMR00210 : R_Page
    {
        private PMR00210ViewModel _viewModel = new();
        ...
        private PMR00210ParamDTO GenerateParam()
        {
            R_Exception loEx = new R_Exception();
            PMR00210ParamDTO loParam = new();
            try
            {
                loParam = new PMR00210ParamDTO()
                {
        ...
        private void Validation(PMR00210ParamDTO poParam)
        {
            R_Exception loEx = new R_Exception();
            try
            {
        ...
        private async Task GeneratePrintAsync(PMR00210ParamDTO poParam)
        {
            R_Exception loEx = new R_Exception();
            try
            {
                ...
                {
                    await LOICasualLeasing_PrintDetailAsync(poParam);
                }
                else
                {
                    await LOICasualLeasing_PrintSummaryAsync(poParam);
                }
            }
            catch (Exception ex)
            {
        ...
        private async Task LOICasualLeasing_PrintSummaryAsync(PMR00210ParamDTO poParam)
        {
            R_Exception loEx = new R_Exception();
            try
            {
                await _reportService.GetReport(
                    ...
                    "PM",
                    "rpt/PMR00211Print/DownloadResultPrintPost",
                    "rpt/PMR00211Print/LOICasualLeasingSummary_ReportListGet", poParam);
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        private async Task LOICasualLeasing_PrintDetailAsync(PMR00210ParamDTO poParam)
        {
            R_Exception loEx = new R_Exception();
            try
            {
                await _reportService.GetReport(
                    "R_DefaultServiceUrlPM",
                    "PM",
                    "rpt/PMR00212Print/DownloadResultPrintPost",
                    "rpt/PMR00212Print/LOICasualLeasingDetail_ReportListGet", poParam);
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        private void BeforeOpen_PopupSaveAsAsync(R_BeforeOpenPopupEventArgs eventArgs)
        {
            ...
            eventArgs.TargetPageType = typeof(PMR00211);
        }
