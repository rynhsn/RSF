...
{
    public class PMT01350ViewModel : R_ViewModel<PMT01350DTO>
    {
        private PMT01350Model _PMT01350Model = new PMT01350Model();

        #region Property Class
        public PMT01300DTO LOI { get; set; } = new PMT01300DTO();
        public PMT01350DTO LOI_InvoicePlan { get; set; } = new PMT01350DTO();
        public ObservableCollection<PMT01350DTO> LOIInvoicePlanGrid { get; set; } = new ObservableCollection<PMT01350DTO>();
        public ObservableCollection<PMT01351DTO> LOIInvoicePlanChargesGrid { get; set; } = new ObservableCollection<PMT01351DTO>();
        ...
        public async Task GetLOIInvoicePlanList(PMT01350DTO poEntity)
        {
            ...
            try
            {
                ...
                var loResult = await _PMT01350Model.GetAgreementInvPlanListStreamAsync(poEntity);
                ...
                LOIInvoicePlanGrid = new ObservableCollection<PMT01350DTO>(loResult);
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public async Task GetLOIInvPlanChargeList(PMT01351DTO poEntity)
        {
            var loEx = new R_Exception();

            try
            {
                var loResult = await _PMT01350Model.GetLOIInvPlanChargeStreamAsync(poEntity);
                loResult.ForEach(x =>
                {
                ...
                LOIInvoicePlanChargesGrid = new ObservableCollection<PMT01351DTO>(loResult);
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
