...
namespace ICR00100Model
{
    public class ICR00100Model : R_BusinessObjectServiceClientBase<ICR00100DataResultDTO>, IICR00100
    {
        
        private const string DEFAULT_HTTP_NAME = "R_DefaultServiceUrlIC";
        private const string DEFAULT_SERVICEPOINT_NAME = "api/ICR00100";
        private const string DEFAULT_MODULE = "ic";

        public ICR00100Model(
