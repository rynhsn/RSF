...
namespace GLM00200FRONT
{
    public partial class GLM00203
    {
        ...
        [Inject] private R_ILocalizer<GLM00200FrontResources.Resources_Dummy_Class> _localizer { get; set; }
        ...
        private async Task RecurringUpload_GetlistAsync(R_ServiceGetListRecordEventArgs eventArgs)
        {
            ...
            try
            {
                var loData = new List<RecurringUploadErrorDTO>(
                    ...
                    .Select((item, index) =>
                    {
                        item.SEQ_NO = index + 1; // Assign row number starting from 1
                        return item;
                    }));
        ...
        private async Task Onchange_InputFIleRecurringUpload(InputFileChangeEventArgs eventArgs)
        {
            ...
            try
            {
                ...
                var loDataSet = loExcel.R_ReadFromExcel(loFileByte, new string[] { "RecurringUpload" });
