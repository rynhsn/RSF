...
namespace PMR00220MODEL.View_Models
{
    public class PMR00220ViewModel
    {
        #region Init Process
        
        public PMR00220Model _PMR00220model = new PMR00220Model();

        public PMR00221Model _PMR00221model = new PMR00221Model();
        ...
        public PMR00220SPParamDTO _ReportParam = new PMR00220SPParamDTO();
        ...
        public async Task<List<PropertyDTO>> GetPropertyAsync()
        {
            ...
            try
            {
                var loResult = await _PMR00220model.GetPropertyListAsync();
                loRtn = loResult;
            }
            catch (Exception ex)
            {
        ...
        public async Task<DateTime> GetTodayAsync()
        {
            ...
            try
            {
                var loData = await _PMR00220model.GetTodayDateAsync();
                loRtn = loData.DTODAY;
            }
            catch (Exception ex)
            {
        ...
        public async Task<List<PeriodDtDTO>> GetPeriodDtAsync(string pcYear)
        {
            ...
            try
            {
                R_FrontContext.R_SetStreamingContext(PMR00220ContextConstant.CYEAR, pcYear);
                var loResult = await _PMR00220model.GetPeriodDtListAsync();
        ...
        public async Task<PeriodYearDTO> GetPeriodYearAsync()
        {
            ...
            try
            {
                loRtn = await _PMR00220model.GetPeriodYearRecordAsync(new PeriodYearDTO() { CMODE = "", CYEAR = "" });
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
