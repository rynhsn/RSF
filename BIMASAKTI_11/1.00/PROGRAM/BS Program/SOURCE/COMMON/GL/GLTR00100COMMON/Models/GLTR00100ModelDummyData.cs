...
namespace GLTR00100COMMON.Models
{
    public static class GenerateDataModelGLTR00100
    {
        public static GLTR00100ResultPrintDTO DefaultData()
        {
            ...
            // Set Header Data
            GLTR00101DTO loHeaderData = new GLTR00101DTO();

            //Convert Header Data
            loHeaderData.DDOC_DATE = DateTime.Now;
            loHeaderData.DREF_DATE = DateTime.Now;
            loHeaderData.DREVERSE_DATE = DateTime.Now;
            loHeaderData.DUPDATE_DATE = DateTime.Now;
