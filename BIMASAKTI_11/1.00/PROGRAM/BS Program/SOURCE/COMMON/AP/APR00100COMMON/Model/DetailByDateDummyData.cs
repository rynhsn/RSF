...
{
    public static class DetailByDateDummyData
    {
        public static ReportPrintSummaryDTO Print()
        {
            ...
            for (int a = 1; a <= Data1; a++)
            {
                for (int b = 1; b <= Data2; b++)
                {
                    ...
                    foreach (string currency in currencies)
                    {
                        ...
                        // CREF_DATE in "yyyy-MM-dd" format
                        string crefDate = $"2024-05-{b:D2}";

                        // Convert CREF_DATE (string) to DREF_DATE (DateTime)
                        DateTime drefDate = DateTime.ParseExact(crefDate, "yyyy-MM-dd", CultureInfo.InvariantCulture);
          ...
          var loTempData = loCollection
            ...
            */
            loRtn.ReportData.SummaryDate = loTempData;
            return loRtn;
        }
    }
}
