...
{
    public class PMR00220SPResultDTO
    {
        ...
        public string CUNIT_DETAIL_TYPE_NAME { get; set; }
        public string CUNIT_DETAIL_TYPE_CATEGORY_ID { get; set; }
        public string CUNIT_DETAIL_TYPE_CATEGORY_NAME { get; set; }
        public string CUNIT_DETAIL_VIEW_ID { get; set; }
        public string CUNIT_DETAIL_VIEW_NAME { get; set; }
        public string CUNIT_DETAIL_CATEGORY_NAME { get; set; }
        ...
        public string CUNIT_DETAIL_STRATA_STATUS { get; set; }
        public string CUNIT_DETAIL_LEASE_STATUS { get; set; }
        ...
        public string CUTILITY_DETAIL_TYPE_NAME { get; set; }
        public string CUTILITY_DETAIL_UNIT_NAME { get; set; }
        public string CUTILITY_DETAIL_CHARGE_NAME { get; set; }
        public string CUTILITY_DETAIL_TAX_NAME { get; set; }
        public string CUTILITY_DETAIL_METER_NO { get; set; }
        public string IUTILITY_DETAIL_METER_START { get; set; }
        public string CUTILITY_DETAIL_START_INV_PRD { get; set; }
        public string IUTILITY_DETAIL_INVOICING_PERIOD { get; set; }
        public string CUTILITY_DETAIL_STATUS_NAME { get; set; }
