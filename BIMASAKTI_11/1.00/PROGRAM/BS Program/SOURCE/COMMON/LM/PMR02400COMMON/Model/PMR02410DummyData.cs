...
namespace PMR02400COMMON.DTO_s.Model
{
    public static class PMR02410DummyData
    {
        public static PMR02410PrintDisplayDTO PMR02410PrintDislpayWithBaseHeader()
        {
            ...
            loRtn.ReportDataDTO.Data = new List<DetailDTO>();
            ...
            var loSPDummyData = new List<PMR02401SPResultDTO>();
            foreach (var tenant in tenants)
            {
                foreach (var agreement in agreements)
                {
                    ...
                    {
                        loSPDummyData.Add(new PMR02401SPResultDTO
                        {
                            CCOMPANY_ID = "COMP001",
            ...
            var loGroupedData = loSPDummyData
                ...
                .Select(loTenantGroup => new DetailDTO
                {
                    ...
                    Agreements = loTenantGroup.Select(a => new AgreementDtDTO
                    {
                        ...
                        DDUE_DATE= DateTime.ParseExact(a.CDUE_DATE, "yyyyMMdd", CultureInfo.InvariantCulture),
