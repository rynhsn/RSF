...
namespace PMR00210COMMON.Model
{
    ...
    {
        public static PMR00210PrintDislpayDTO PMR00200PrintDislpayWithBaseHeader()
        {
            ...
            loRtn.SummaryData = new PMR00210ReportDataDTO();
            loRtn.SummaryData.Header = "PM";
            loRtn.SummaryData.Title = "LOI Status";
            loRtn.SummaryData.Column = new PMR00210LabelDTO();
            loRtn.SummaryData.HeaderParam = new PMR00210ParamDTO()
            {
                CCOMPANY_ID = "RCD",
            ...
            loRtn.SummaryData.Data = new List<PMR00210DataDTO>();
            int countData1 = 2, countData2 = 2, countData3 = 3;
            List<PMR00210DataDTO> loCollData = new List<PMR00210DataDTO>();
            ...
            for (int i = 0; i < transCodes.Length; i++)
            {
                ...
                for (int j = 0; j < salesmen.GetLength(0); j++)
                {
                    ...
                    for (int k = 1; k <= 2; k++)
                    {
                        PMR00210DataDTO dto = new PMR00210DataDTO
                        {
