...
namespace PMR00210COMMON.Model
{
    public class PMR00210DummyData
    {
        public static PMR00211PrintDislpayDTO PMR00210PrintDislpayWithBaseHeader()
        {
            ...
            loRtn.DetailData = new PMR00211ReportDataDTO();
            loRtn.DetailData.Header = "PM";
            loRtn.DetailData.Title = "LOI Status";
            loRtn.DetailData.Column = new PMR00210LabelDTO();
            loRtn.DetailData.HeaderParam = new PMR00210ParamDTO()
            {
                CCOMPANY_ID = "RCD",
            ...
            //loRtn.DetailData.Data = new List<PMR00211DataDTO>();
            ...
            //        for (int k = 1; k <= 2; k++)
            //        {
            //            PMR00211DataDTO dto = new PMR00211DataDTO
            //            {
