...
namespace PMR02400SERVICE
{
    public class PMR02410PrintController : R_ReportControllerBase
    {
        ...
        private PMR02400PrintDisplayDTO GenerateDataPrint(PMR02400ParamDTO poParam)
        {
            ...
            PMR02400PrintDisplayDTO loRtn = new();
            ...
            try
            {
                ...
                // Create an instance
                PMR02400ReportDataDTO loData = new()
                {
                ...
                loData.Data = loCollData.Any() ? GroupingData(loCollData) : new List<SummaryDTO>();
        ...
        private List<SummaryDTO> GroupingData(List<PMR02400SPResultDTO> poCollectionDataRaw)
        {
            R_Exception loException = new ();
            using Activity activity = _activitySource.StartActivity(nameof(GroupingData))!;
            _logger.LogInfo(string.Format("START method {0} ", nameof(GroupingData)));
            List<SummaryDTO> loReturn = new List<SummaryDTO>();
            ...
            loException.ThrowExceptionIfErrors();
            _logger.LogInfo(string.Format("END process method {0} on Cls", nameof(GroupingData)));
            return loReturn;
        }

        private List<SubtotalCurrencyDTO> GroupingGrandTotalData(List<PMR02400SPResultDTO> poCollectionDataRaw)
        {
