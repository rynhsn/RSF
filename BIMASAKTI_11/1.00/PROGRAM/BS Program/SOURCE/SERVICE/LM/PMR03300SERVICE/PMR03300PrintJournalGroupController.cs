...
{
    public class PMR03300PrintJournalGroupController : R_ReportControllerBase
    {
        ...
        public PMR03300PrintJournalGroupController(ILogger<LoggerPMR03300Print> logger)
        {
            LoggerPMR03300Print.R_InitializeLogger(logger);
            _logger = LoggerPMR03300Print.R_GetInstanceLogger();
            _activitySource = PMR03300Activity.R_InitializeAndGetActivitySource(nameof(PMR03300PrintJournalGroupController));
        ...
        {
            pcFileTemplate = System.IO.Path.Combine("Reports", "PMR03300ReportJournalGroup.frx");
        }
