...
{
    public class PMR03300PrintCustomerCategoryController : R_ReportControllerBase
    {
        ...
        public PMR03300PrintCustomerCategoryController(ILogger<LoggerPMR03300Print> logger)
        {
            LoggerPMR03300Print.R_InitializeLogger(logger);
            _logger = LoggerPMR03300Print.R_GetInstanceLogger();
            _activitySource = PMR03300Activity.R_InitializeAndGetActivitySource(nameof(PMR03300PrintCustomerCategoryController));
        ...
        {
            pcFileTemplate = System.IO.Path.Combine("Reports", "PMR03300ReportCustomerCategory.frx");
        }
        ...
        public R_DownloadFileResultDTO DownloadResultPrintPost(PMR03300ReportParamDTO poParameter)
        {
            ...
            _logger.LogInfo("End - Print PMR03300");
            return loRtn;
        }

        [HttpGet, AllowAnonymous]
        public FileStreamResult CustomerCategory_ReportListGet(string pcGuid)
        {
            using Activity activity = _activitySource.StartActivity($"{GetType().Name}.{MethodBase.GetCurrentMethod().Name}");
            ...
            loException.ThrowExceptionIfErrors();
            _logger.LogInfo("End - PMR03300 Report Generation");
            return loRtn;
        }
        ...
        private PMR03300ReportWithBaseHeaderDTO GeneratePrint(PMR03300ReportParamDTO poParam)
        {
            ...
            try
            {
                ...
                loData.Header = new PMR03300ReportHeaderDTO
                {
                    ...
                    CCUSTOMER_DISPLAY = poParam.CFR_CODE + "-" + $"{poParam.CFR_CODE_NAME}",
