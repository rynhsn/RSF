...
{
    public class PMR03300PrintCustomerIdController : R_ReportControllerBase
    {
        ...
        public PMR03300PrintCustomerIdController(ILogger<LoggerPMR03300Print> logger)
        {
        ...
        {
            pcFileTemplate = System.IO.Path.Combine("Reports", "PMR03300ReportCustomerId.frx");
        }
