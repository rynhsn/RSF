...
using PMR00210COMMON.Print_DTO.Detail;
using PMR00210COMMON.Print_DTO.Detail.SubDetail;


namespace PMR00210SERVICE
{
    public class PMR00212PrintController : R_ReportControllerBase
    {
        ...
        public PMR00212PrintController(ILogger<PMR00210PrintLogger> logger)
        {
        ...
        {
            pcFileTemplate = System.IO.Path.Combine("Reports", "PMR00210Detail.frx");
        }
        ...
        public FileStreamResult LOICasualLeasingDetail_ReportListGet(string pcGuid)
        {
            using Activity activity = _activitySource.StartActivity($"{GetType().Name}.{MethodBase.GetCurrentMethod().Name}");
        ...
        private PMR00211PrintDislpayDTO GenerateDataPrint(PMR00210ParamDTO poParam)
        {
            using Activity activity = _activitySource.StartActivity($"{GetType().Name}.{MethodBase.GetCurrentMethod().Name}");

            var loEx = new R_Exception();
            PMR00211PrintDislpayDTO loRtn = new PMR00211PrintDislpayDTO();
            ...
            try
            {
                ...
                PMR00210LabelDTO loColumnObject = new PMR00210LabelDTO();
                ...
                // Create an instance 
                PMR00211ReportDataDTO loData = new PMR00211ReportDataDTO()
                {
        ...
        private List<TransactionDTO> ConvertResultToFormatPrint(List<PMR00211SPResultDTO> poCollectionDataRaw)
        {
