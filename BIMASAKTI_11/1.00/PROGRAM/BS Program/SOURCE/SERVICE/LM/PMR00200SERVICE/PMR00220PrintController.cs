...
{
    public class PMR00220PrintController : R_ReportControllerBase
    {
        ...
        public PMR00220PrintController(ILogger<PMR00200PrintLogger> logger)
        {
        ...
        {
            pcFileTemplate = System.IO.Path.Combine("Reports", "PMR00200Detail.frx");
        }
        ...
        public FileStreamResult LOIStatusDetail_ReportListGet(string pcGuid)
        {
            using Activity activity = _activitySource.StartActivity($"{GetType().Name}.{MethodBase.GetCurrentMethod().Name}");
        ...
        private PMR00210PrintDislpayDTO GenerateDataPrint(PMR00200ParamDTO poParam)
        {
            using Activity activity = _activitySource.StartActivity($"{GetType().Name}.{MethodBase.GetCurrentMethod().Name}");
            ...
            try
            {
                ...
                PMR00200LabelDTO loColumnObject = new();
        ...
        private List<TransactionDTO> ConvertResultToFormatPrint(List<PMR00210SPResultDTO> poCollectionDataRaw)
        {
