...
public class CBB00200Controller : ControllerBase, ICBB00200
{
    ...
    {
        using var loActivity = _activitySource.StartActivity(nameof(CBB00200ClosePeriodToDoListStream));
        _logger.LogInfo("Start - Get ClosePeriodToDo List Stream");
        var loEx = new R_Exception();
        var loCls = new CBB00200Cls();
        var loDbParams = new CBB00200ParameterDb();
        ...
        try
        {
            ...
            _logger.LogInfo("Get ClosePeriodToDo List Stream");
            loResult = loCls.CBB00200GetClosePeriodToDoList(loDbParams);
        ...
        loEx.ThrowExceptionIfErrors();
        _logger.LogInfo("End - Get ClosePeriodToDo List Stream");
        return loReturn;
    }
