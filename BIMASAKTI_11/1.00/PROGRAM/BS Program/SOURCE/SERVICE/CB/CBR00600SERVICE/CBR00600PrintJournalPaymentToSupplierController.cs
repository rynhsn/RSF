...
{
    public class CBR00600PrintJournalPaymentToSupplierController : R_ReportControllerBase
    {
        ...
        #region instantiate
        public CBR00600PrintJournalPaymentToSupplierController(ILogger<CBR00600DTO> logger)
        {
            //Initial and Get Logger
            LoggerCBR00600.R_InitializeLogger(logger);
            _LoggerPrint = LoggerCBR00600.R_GetInstanceLogger();
            _activitySource = CBR00600ActivitySourceBase.R_InitializeAndGetActivitySource(nameof(CBR00600PrintJournalPaymentToSupplierController));
        ...
        {
            pcFileTemplate = System.IO.Path.Combine("Reports", "CBR00600JournalPaymentToSupplier.frx");
        }
        ...
        [HttpPost]
        public R_DownloadFileResultDTO AllPrintJournalPaymentToSupplierCBTransactionPost(CBR00600DTO poParameter)
        {
            using Activity activity = _activitySource.StartActivity("AllPrintJournalPaymentToSupplierCBTransactionPost");
            _LoggerPrint.LogInfo("Start AllPrintJournalPaymentToSupplierCBTransactionPost");
            ...
            try
            {
                ...
                // Set Guid Param 
                _LoggerPrint.LogInfo("Set GUID Param AllPrintJournalPaymentToSupplierCBTransactionPost");
            ...
            _LoggerPrint.LogInfo("End AllPrintJournalPaymentToSupplierCBTransactionPost");
            loException.ThrowExceptionIfErrors();
            return loRtn;
        }

        [HttpGet, AllowAnonymous]
        public FileStreamResult AllStreamPrintJournalPaymentToSupplierCBTransactionsGet(string pcGuid)
        {
            using Activity activity = _activitySource.StartActivity("AllStreamPrintJournalPaymentToSupplierCBTransactionsGet");
            R_Exception loException = new R_Exception();
            CBR00600PrintLogKeyDTO<CBR00600DTO> loResultGUID = null;
            _LoggerPrint.LogInfo("Start AllStreamPrintJournalPaymentToSupplierCBTransactionsGet");
            ...
            loException.ThrowExceptionIfErrors();
            _LoggerPrint.LogInfo("End AllStreamPrintJournalPaymentToSupplierCBTransactionsGet");
