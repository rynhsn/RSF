...
{
    public class CBR00600PrintAllocationController : R_ReportControllerBase
    {
        ...
        #region instantiate
        public CBR00600PrintAllocationController(ILogger<CBR00600DTO> logger)
        {
            //Initial and Get Logger
            LoggerCBR00600.R_InitializeLogger(logger);
            _LoggerPrint = LoggerCBR00600.R_GetInstanceLogger();
            _activitySource = CBR00600ActivitySourceBase.R_InitializeAndGetActivitySource(nameof(CBR00600PrintAllocationController));
        ...
        {
            pcFileTemplate = System.IO.Path.Combine("Reports", "CBR00600AllocationFooter.frx");
        }
        ...
        [HttpPost]
        public R_DownloadFileResultDTO AllPrintAllocationCBTransactionPost(CBR00600DTO poParameter)
        {
            using Activity activity = _activitySource.StartActivity("AllPrintAllocationCBTransactionPost");
            _LoggerPrint.LogInfo("Start AllPrintAllocationCBTransactionPost");
            ...
            try
            {
                ...
                // Set Guid Param 
                _LoggerPrint.LogInfo("Set GUID Param AllPrintAllocationCBTransactionPost");
            ...
            _LoggerPrint.LogInfo("End AllPrintAllocationCBTransactionPost");
            loException.ThrowExceptionIfErrors();
            return loRtn;
        }

        [HttpGet, AllowAnonymous]
        public FileStreamResult AllStreamPrintAllocationCBTransactionsGet(string pcGuid)
        {
            using Activity activity = _activitySource.StartActivity("AllStreamPrintAllocationCBTransactionsGet");
            R_Exception loException = new R_Exception();
            CBR00600PrintLogKeyDTO<CBR00600DTO> loResultGUID = null;
            _LoggerPrint.LogInfo("Start AllStreamPrintAllocationCBTransactionsGet");
            ...
            loException.ThrowExceptionIfErrors();
            _LoggerPrint.LogInfo("End AllStreamPrintAllocationCBTransactionsGet");
