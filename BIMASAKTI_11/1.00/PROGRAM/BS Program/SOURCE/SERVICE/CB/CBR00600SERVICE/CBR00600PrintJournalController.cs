...
{
    public class CBR00600PrintJournalController : R_ReportControllerBase
    {
        ...
        #region instantiate
        public CBR00600PrintJournalController(ILogger<CBR00600DTO> logger)
        {
            //Initial and Get Logger
            LoggerCBR00600.R_InitializeLogger(logger);
            _LoggerPrint = LoggerCBR00600.R_GetInstanceLogger();
            _activitySource = CBR00600ActivitySourceBase.R_InitializeAndGetActivitySource(nameof(CBR00600PrintJournalController));
        ...
        {
            pcFileTemplate = System.IO.Path.Combine("Reports", "CBR00600Journal.frx");
        }
        ...
        [HttpPost]
        public R_DownloadFileResultDTO AllPrintJournalCBTransactionPost(CBR00600DTO poParameter)
        {
            using Activity activity = _activitySource.StartActivity("AllPrintJournalCBTransactionPost");
            _LoggerPrint.LogInfo("Start AllPrintJournalCBTransactionPost");
            ...
            try
            {
                ...
                // Set Guid Param 
                _LoggerPrint.LogInfo("Set GUID Param AllPrintJournalCBTransactionPost");
            ...
            _LoggerPrint.LogInfo("End AllPrintJournalCBTransactionPost");
            loException.ThrowExceptionIfErrors();
            return loRtn;
        }

        [HttpGet, AllowAnonymous]
        public FileStreamResult AllStreamPrintJournalCBTransactionsGet(string pcGuid)
        {
            using Activity activity = _activitySource.StartActivity("AllStreamPrintJournalCBTransactionsGet");
            R_Exception loException = new R_Exception();
            CBR00600PrintLogKeyDTO<CBR00600DTO> loResultGUID = null;
            _LoggerPrint.LogInfo("Start AllStreamPrintJournalCBTransactionsGet");
            ...
            loException.ThrowExceptionIfErrors();
            _LoggerPrint.LogInfo("End AllStreamPrintJournalCBTransactionsGet");
