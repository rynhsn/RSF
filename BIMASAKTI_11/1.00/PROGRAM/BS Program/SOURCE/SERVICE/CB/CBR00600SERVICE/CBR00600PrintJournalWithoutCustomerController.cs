...
{
    public class CBR00600PrintJournalWithoutCustomerController : R_ReportControllerBase
    {
        ...
        #region instantiate
        public CBR00600PrintJournalWithoutCustomerController(ILogger<CBR00600DTO> logger)
        {
            //Initial and Get Logger
            LoggerCBR00600.R_InitializeLogger(logger);
            _LoggerPrint = LoggerCBR00600.R_GetInstanceLogger();
            _activitySource = CBR00600ActivitySourceBase.R_InitializeAndGetActivitySource(nameof(CBR00600PrintJournalWithoutCustomerController));
        ...
        {
            pcFileTemplate = System.IO.Path.Combine("Reports", "CBR00600JournalWithoutCustomer.frx");
        }
        ...
        [HttpPost]
        public R_DownloadFileResultDTO AllPrintJournalWithoutCustomerCBTransactionPost(CBR00600DTO poParameter)
        {
            using Activity activity = _activitySource.StartActivity("AllPrintJournalWithoutCustomerCBTransactionPost");
            _LoggerPrint.LogInfo("Start AllPrintJournalWithoutCustomerCBTransactionPost");
            ...
            try
            {
                ...
                // Set Guid Param 
                _LoggerPrint.LogInfo("Set GUID Param AllPrintJournalWithoutCustomerCBTransactionPost");
            ...
            _LoggerPrint.LogInfo("End AllPrintJournalWithoutCustomerCBTransactionPost");
            loException.ThrowExceptionIfErrors();
            return loRtn;
        }

        [HttpGet, AllowAnonymous]
        public FileStreamResult AllStreamPrintJournalWithoutCustomerCBTransactionsGet(string pcGuid)
        {
            using Activity activity = _activitySource.StartActivity("AllStreamPrintJournalWithoutCustomerCBTransactionsGet");
            R_Exception loException = new R_Exception();
            CBR00600PrintLogKeyDTO<CBR00600DTO> loResultGUID = null;
            _LoggerPrint.LogInfo("Start AllStreamPrintJournalWithoutCustomerCBTransactionsGet");
            ...
            loException.ThrowExceptionIfErrors();
            _LoggerPrint.LogInfo("End AllStreamPrintJournalWithoutCustomerCBTransactionsGet");
            ...
            try
            {
                ...
                if (poParam.LJOURNAL)
                {
                    ...
                    if (loJournalData.Count > 0)
                    {
                        ...
                        loRtn.BaseHeaderData.CPRINT_NAME = loJournalData[0].CREPORT_TITLE;
                    }
                }
            }
            catch (Exception ex)
