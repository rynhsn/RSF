...
{
    public class GLR00300ReportFormatBController : R_ReportControllerBase
    {
        ...
        #region instantiate
        public GLR00300ReportFormatBController(ILogger<GLR00300ReportFormatBController> logger)
        {
            //Initial and Get instance
            LoggerGLR00300.R_InitializeLogger(logger);
            _loggerGLR00300Report = LoggerGLR00300.R_GetInstanceLogger();
            _activitySource = GLR00300Activity.R_InitializeAndGetActivitySource(nameof(GLR00300ReportFormatBController));
        ...
        {
            pcFileTemplate = System.IO.Path.Combine("Reports", "GLR00300AccountTrialBalanceB.frx");
        }
        ...
        public R_DownloadFileResultDTO AllTrialBalanceReportPost(GLR00300ParamDBToGetReportDTO poParameter)
        {
            ...
            _loggerGLR00300Report.LogInfo(string.Format("START method {0} on Format B", lcMethodName));
            ...
            _loggerGLR00300Report.LogInfo(string.Format("END method {0} on Format B", lcMethodName));
            return loRtn;
            ...
            try
            {
                ...
                loReturn = poCollectionDataRaw.Select(item
                    => new GLR00300DataAccountTrialBalanceAD
                    {
                        ...
                        NEND_BALANCE = item.NEND_BALANCE,
