...
[ApiController]
[Route("api/[controller]/[action]")]
public class GSM05000ApprovalUserController : ControllerBase, IGSM05000ApprovalUserAsync
{
    private LoggerGSM05000 _logger;
    private readonly ActivitySource _activitySource;
    ...
    [HttpPost]
    public async Task<R_ServiceGetRecordResultDTO<GSM05000ApprovalUserDTO>> R_ServiceGetRecord(
        R_ServiceGetRecordParameterDTO<GSM05000ApprovalUserDTO> poParameter)
    {
        using var loActivity = _activitySource.StartActivity(nameof(R_ServiceGetRecord));
        _logger.LogInfo("Start - Get Approval User Record");
    ...
    [HttpPost]
    public async Task<R_ServiceSaveResultDTO<GSM05000ApprovalUserDTO>> R_ServiceSave(
        R_ServiceSaveParameterDTO<GSM05000ApprovalUserDTO> poParameter)
    {
        using var loActivity = _activitySource.StartActivity(nameof(R_ServiceSave));
        _logger.LogInfo("Start - Save Approval User Entity");
    ...
    [HttpPost]
    public async Task<R_ServiceDeleteResultDTO> R_ServiceDelete(R_ServiceDeleteParameterDTO<GSM05000ApprovalUserDTO> poParameter)
    {
        using var loActivity = _activitySource.StartActivity(nameof(R_ServiceDelete));
        _logger.LogInfo("Start - Delete Approval User Entity");
        R_Exception loEx = new();
    ...
    [HttpPost]
    public async IAsyncEnumerable<GSM05000ApprovalUserDTO> GSM05000GetApprovalListStream()
    {
        using var loActivity = _activitySource.StartActivity(nameof(GSM05000GetApprovalListStream));
        _logger.LogInfo("Start - Get Approval User List Stream");
        R_Exception loEx = new();
        List<GSM05000ApprovalUserDTO> loResult = new();
        GSM05000ParameterDb loDbPar;
        GSM05000ApprovalUserCls loCls;
        ...
        try
        {
            ...
            _logger.LogInfo("Get Approval User List");
            loCls = new GSM05000ApprovalUserCls();
            loResult = await loCls.GSM05000GetApprovalUserAsync(loDbPar);
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
    ...
    [HttpPost]
    public async Task<GSM05000ApprovalHeaderDTO> GSM05000GetApprovalHeader(GSM05000TrxCodeParamsDTO poParams)
    {
        using var loActivity = _activitySource.StartActivity(nameof(GSM05000GetApprovalHeader));
        _logger.LogInfo("Start - Get Approval Header");
        R_Exception loEx = new();
        ...
        try
        {
            ...
            _logger.LogInfo("Get Approval Header");
            loRtn = await loCls.GSM05000GetApprovalHeaderAsync(loDbPar);
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
    ...
    [HttpPost]
    public async Task<string> GSM05000ValidationForAction(GSM05000TrxDeptParamsDTO poParams)
    {
        using var loActivity = _activitySource.StartActivity(nameof(GSM05000ValidationForAction));
        _logger.LogInfo("Start - Validate For Action");
        R_Exception loEx = new();
        ...
        try
        {
            ...
            _logger.LogInfo("Validate For Action");
            loRtn = await loCls.GSM05000ValidationForActionAsync(loDbPar);
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
    ...
    [HttpPost]
    public async IAsyncEnumerable<GSM05000ApprovalDepartmentDTO> GSM05000GetApprovalDepartmentStream()
    {
        using var loActivity = _activitySource.StartActivity(nameof(GSM05000GetApprovalDepartmentStream));
        _logger.LogInfo("Start - Get Approval Department Stream");
        R_Exception loEx = new();
        List<GSM05000ApprovalDepartmentDTO> loResult = new();
        GSM05000ParameterDb loDbPar;
        GSM05000ApprovalUserCls loCls;
        ...
        try
        {
            ...
            _logger.LogInfo("Get Approval Department");
            loResult = await loCls.GSM05000GetApprovalDepartmentAsync(loDbPar);
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
    ...
    [HttpPost]
    public async IAsyncEnumerable<GSM05000ApprovalDepartmentDTO> GSM05000DepartmentChangeSequenceStream(GSM05000TrxCodeParamsDTO poParams)
    {
        using var loActivity = _activitySource.StartActivity(nameof(GSM05000DepartmentChangeSequenceStream));
        _logger.LogInfo("Start - Department Change Sequence Stream");
        R_Exception loEx = new();
        ...
        try
        {
            ...
            _logger.LogInfo("Department Change Sequence");
            loResult = await loCls.GSM05000DepartmentChangeSequenceAsync(loDbPar);
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
    ...
    [HttpPost]
    public async IAsyncEnumerable<GSM05000ApprovalUserDTO> GSM05000GetUserSequenceDataStream()
    {
        using var loActivity = _activitySource.StartActivity(nameof(GSM05000GetUserSequenceDataStream));
        _logger.LogInfo("Start - Get User Sequence Data Stream");
        R_Exception loEx = new();
        ...
        try
        {
            ...
            _logger.LogInfo("Get User Sequence Data");
            loResult = await loCls.GSM05000GetUserSequenceDataAsync(loDbPar);
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
    ...
    [HttpPost]
    public async Task GSM05000UpdateSequence(List<GSM05000ApprovalUserDTO> poEntity)
    {
        using var loActivity = _activitySource.StartActivity(nameof(GSM05000UpdateSequence));
        _logger.LogInfo("Start - Update Sequence");
        var loEx = new R_Exception();
        ...
        try
        {
            ...
            poEntity.ForEach(x => x.CUSER_LOGIN_ID = R_BackGlobalVar.USER_ID);
            await loCls.GSM05000UpdateSequenceAsync(poEntity);
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
    ...
    [HttpPost]
    // public async IAsyncEnumerable<GSM05000ApprovalDepartmentDTO> GSM05000LookupApprovalDepartmentStream(GSM05000DeptCodeParamsDTO poParams)
    public async IAsyncEnumerable<GSM05000ApprovalDepartmentDTO> GSM05000LookupApprovalDepartmentStream()
    {
        using var loActivity = _activitySource.StartActivity(nameof(GSM05000LookupApprovalDepartmentStream));
        _logger.LogInfo("Start - Lookup Approval Department Stream");
        R_Exception loEx = new();
        ...
        try
        {
            ...
            _logger.LogInfo("Lookup Approval Department");
            loResult = await loCls.GSM05000LookupApprovalDepartmentAsync(loDbPar);
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
    ...
    [HttpPost]
    public async Task<GSM05000SingleDTO<GSM05000ApprovalDepartmentDTO>> GSM05000LookupApprovalDepartmentRecord(GSM05000SearchTextDTO poText)
    {
        using Activity activity = _activitySource.StartActivity(nameof(GSM05000LookupApprovalDepartmentRecord));
        _logger.LogInfo("Start Start - Lookup Approval Department Record");
        ...
        try
        {
            ...
            _logger.LogInfo("Call Back Method - Lookup Approval Department Record");
            var loResult = await loCls.GSM05000LookupApprovalDepartmentAsync(loDbPar);
    ...
    [HttpPost]
    public async Task<GSM05000SingleDTO<string>> GSM05000CopyToApproval(GSM05000CopyToParamsDTO poParams)
    {
        using var loActivity = _activitySource.StartActivity(nameof(GSM05000CopyToApproval));
        _logger.LogInfo("Start - Copy To Approval");
        R_Exception loEx = new();
        ...
        try
        {
            ...
            _logger.LogInfo("Copy To Approval");
            await loCls.GSM05000ApprovalCopyToAsync(loDbPar);
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
    ...
    [HttpPost]
    public async Task<GSM05000SingleDTO<string>> GSM05000CopyFromApproval(GSM05000CopyFromParamsDTO poParams)
    {
        using var loActivity = _activitySource.StartActivity(nameof(GSM05000CopyFromApproval));
        _logger.LogInfo("Start - Copy From Approval");
        R_Exception loEx = new();
        ...
        try
        {
            ...
            _logger.LogInfo("Copy From Approval");
            await loCls.GSM05000ApprovalCopyFromAsync(loDbPar);
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
...
public interface IGSM05000ApprovalUserAsync : R_IServiceCRUDAsyncBase<GSM05000ApprovalUserDTO>
{
    Task<GSM05000ApprovalHeaderDTO> GSM05000GetApprovalHeader(GSM05000TrxCodeParamsDTO poParams);
    IAsyncEnumerable<GSM05000ApprovalUserDTO> GSM05000GetApprovalListStream();
    Task<string> GSM05000ValidationForAction(GSM05000TrxDeptParamsDTO poParams);
    ...
    Task GSM05000UpdateSequence(List<GSM05000ApprovalUserDTO> poEntity);
    ...
    Task<GSM05000SingleDTO<GSM05000ApprovalDepartmentDTO>> GSM05000LookupApprovalDepartmentRecord(GSM05000SearchTextDTO poText);
    Task<GSM05000SingleDTO<string>> GSM05000CopyToApproval(GSM05000CopyToParamsDTO poParams);
    Task<GSM05000SingleDTO<string>> GSM05000CopyFromApproval(GSM05000CopyFromParamsDTO poParams);
}
