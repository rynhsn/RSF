...
namespace GSM02500SERVICE
{
    ...
    public class GSM02530Controller : ControllerBase, GSM02500BACK.IGSM02530
    {
        ...
        {
            return GetUnitInfoStream();
        }
        private async IAsyncEnumerable<GSM02530DTO> GetUnitInfoStream()
        {
            ...
            try
            {
                ...
                loRtn = await loCls.GetUnitInfoList(loParam);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
            ...
            foreach (GSM02530DTO item in loRtn)
            {
                yield return item;
            }
        }
        ...
        [HttpPost]
        public async Task<TemplateUnitDTO> DownloadTemplateUnit()
        {
        ...
        {
            return GetStrataLeaseStream();
        }
        private async IAsyncEnumerable<GetStrataLeaseDTO> GetStrataLeaseStream()
        {
            ...
            R_Exception loException = new R_Exception();
            List<GetStrataLeaseDTO> loRtn = null;
            ...
            try
            {
                ...
                loRtn = await loCls.GetStrataLeaseList(loParam);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
            ...
            foreach (GetStrataLeaseDTO item in loRtn)
            {
                yield return item;
            }
        }
        ...
        [HttpPost]
        public async Task<GSM02500ActiveInactiveResultDTO> RSP_GS_ACTIVE_INACTIVE_BUILDING_UNITMethod(GSM02500ActiveInactiveParameterDTO poParam)
        {
            ...
            try
            {
                ...
                await loCls.RSP_GS_ACTIVE_INACTIVE_BUILDING_UNITMethod(poParam);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        [HttpPost]
        public async Task<R_ServiceDeleteResultDTO> R_ServiceDelete(R_ServiceDeleteParameterDTO<GSM02530ParameterDTO> poParameter)
        {
        ...
        [HttpPost]
        public async Task<R_ServiceGetRecordResultDTO<GSM02530ParameterDTO>> R_ServiceGetRecord(R_ServiceGetRecordParameterDTO<GSM02530ParameterDTO> poParameter)
        {
        ...
        [HttpPost]
        public async Task<R_ServiceSaveResultDTO<GSM02530ParameterDTO>> R_ServiceSave(R_ServiceSaveParameterDTO<GSM02530ParameterDTO> poParameter)
        {
