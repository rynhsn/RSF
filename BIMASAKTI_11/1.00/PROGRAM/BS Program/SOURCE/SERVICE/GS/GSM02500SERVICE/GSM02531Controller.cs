...
namespace GSM02500SERVICE
{
    ...
    public class GSM02531Controller : ControllerBase, GSM02500BACK.IGSM02531
    {
        private LoggerGSM02531 _logger;
        private readonly ActivitySource _activitySource;
        public GSM02531Controller(ILogger<GSM02531Controller> logger)
        {
            LoggerGSM02531.R_InitializeLogger(logger);
            _logger = LoggerGSM02531.R_GetInstanceLogger();
            _activitySource = GSM02531ActivitySourceBase.R_InitializeAndGetActivitySource(nameof(GSM02531Controller));
        }
        ...
        private async IAsyncEnumerable<GSM02531UtilityDTO> GetUtilitiesStream()
        {
            ...
            GSM02531Cls loCls = new GSM02531Cls();
            ...
            try
            {
                ...
                loParam.CSELECTED_UNIT_ID = R_Utility.R_GetStreamingContext<string>(ContextConstant.GSM02530_UNIT_ID_STREAMING_CONTEXT);
        ...
        [HttpPost]
        public async Task<GSM02500ActiveInactiveResultDTO> RSP_GS_ACTIVE_INACTIVE_BUILDING_UNIT_UTILITIESMethod(GSM02500ActiveInactiveParameterDTO poParam)
        {
            ...
            try
            {
                ...
                await loCls.RSP_GS_ACTIVE_INACTIVE_BUILDING_UNIT_UTILITIESMethod(poParam);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
