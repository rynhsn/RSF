...
[ApiController]
[Route("api/[controller]/[action]")]
public class GSM02000TaxController : ControllerBase, IGSM02000TaxAsync
{
    ...
    [HttpPost]
    public async Task<R_ServiceGetRecordResultDTO<GSM02000TaxDTO>> R_ServiceGetRecord(
        R_ServiceGetRecordParameterDTO<GSM02000TaxDTO> poParameter)
    {
        using Activity loActivity = _activitySource.StartActivity(nameof(R_ServiceGetRecord));
        _logger.LogInfo("Start - Get Tax % Record");
    ...
    [HttpPost]
    public async Task<R_ServiceSaveResultDTO<GSM02000TaxDTO>> R_ServiceSave(R_ServiceSaveParameterDTO<GSM02000TaxDTO> poParameter)
    {
        using Activity loActivity = _activitySource.StartActivity(nameof(R_ServiceSave));
        _logger.LogInfo("Start - Save Tax % Entity");
        R_Exception loEx = new R_Exception();
    ...
    [HttpPost]
    public async Task<R_ServiceDeleteResultDTO> R_ServiceDelete(R_ServiceDeleteParameterDTO<GSM02000TaxDTO> poParameter)
    {
        using Activity loActivity = _activitySource.StartActivity(nameof(R_ServiceDelete));
        _logger.LogInfo("Start - Delete Tax % Entity");
        R_Exception loEx = new R_Exception();
    ...
    [HttpPost]
    public async IAsyncEnumerable<GSM02000TaxSalesDTO> GSM02000GetAllSalesTaxListStream()
    {
        using Activity loActivity = _activitySource.StartActivity(nameof(GSM02000GetAllSalesTaxListStream));
        _logger.LogInfo("Start - Get All Tax List");
        ...
        List<GSM02000TaxSalesDTO> loResult = new();
        GSM02000ParameterDb loDbPar;
        ...
        try
        {
            ...
            _logger.LogInfo("Get All Tax List");
            loResult = await loCls.SalesTaxListDbAsync(loDbPar);
    ...
    [HttpPost]
    public async IAsyncEnumerable<GSM02000TaxDTO> GSM02000GetAllTaxListStream()
    {
        using Activity loActivity = _activitySource.StartActivity(nameof(GSM02000GetAllTaxListStream));
        _logger.LogInfo("Start - Get All Tax % List");
        R_Exception loEx = new R_Exception();
        ...
        List<GSM02000TaxDTO> loResult = new();
        GSM02000ParameterDb loDbPar;
        ...
        try
        {
            ...
            _logger.LogInfo("Get All Tax % List");
            loResult = await loCls.TaxListDbAsync(loDbPar);
