...
{
    public class APR00100PrintController : R_ReportControllerBase
    {
        ...
        public APR00100PrintController(ILogger<APR00100PrintLogger> logger)
        {
            APR00100PrintLogger.R_InitializeLogger(logger);
            _logger = APR00100PrintLogger.R_GetInstanceLogger();
            _activitySource = APR00100Activity.R_InitializeAndGetActivitySource(nameof(APR00100PrintController));
        ...
        {
            pcFileTemplate = System.IO.Path.Combine("Reports", "APR00100BySupplier.frx");
        }
        ...
        private ReportPrintSummaryDTO GenerateDataPrint(ReportParamDTO poParam)
        {
            ...
            try
            {
                ...
                ReportSummaryDataDTO loData = new ReportSummaryDataDTO()
                {
                    ...
                    Param = poParam,
                    Data = new List<APR00100DataResultDTO>(),
                };
                
                poParam.CLANG_ID = R_BackGlobalVar.CULTURE;
                
                var loCollection = loCls.GetSummaryData(poParam);
                //buat ulang loCollection dimana nbegining dan nremaining  dan ntax dan gain/loss dan allocation != 0
                ...
                /*loRtn.ReportData.Total = new List<ReportTotalDTO>();
                loRtn.ReportData.Total = loCollection?
                .GroupBy(data => new 
                { 
                    data.CCURRENCY_CODE, 
