...
{
    public class APR00103PrintController : R_ReportControllerBase
    {
        ...
        public APR00103PrintController(ILogger<APR00100PrintLogger> logger)
        {
            APR00100PrintLogger.R_InitializeLogger(logger);
            _logger = APR00100PrintLogger.R_GetInstanceLogger();
            _activitySource = APR00100Activity.R_InitializeAndGetActivitySource(nameof(APR00103PrintController));
        ...
        {
            pcFileTemplate = System.IO.Path.Combine("Reports", "APR00100DetailByDate.frx");
        }
        ...
        private ReportPrintSummaryDTO GenerateDataPrint(ReportParamDTO poParam)
        {
            ...
            try
            {
                ...
                {    data1a.CREF_DATE,
                     ...
                     data1a.CDEPT_NAME,
                     data1a.CREF_PRD,
                }).Select(data1b => new APR00100SummaryByDateDTO()
                {
                    CREF_DATE =  data1b.Key.CREF_DATE,
                    DREF_DATE =  data1b.Key.DREF_DATE,
                    CREF_PRD = data1b.Key.CREF_PRD,
                    Detail1 = data1b.GroupBy(data2a => new
                    {
                        ...
                        data2a.CREF_NO,
                        data2a.CSUPPLIER_ID,
                        data2a.CSUPPLIER_NAME,
                        data2a.CTRANS_CODE,
                        data2a.CTRANS_NAME,
                    }).Select(data2b => new APR00100SummaryByDate1DTO()
                    {
                        CSUPPLIER_ID = data2b.Key.CSUPPLIER_ID,
                        CSUPPLIER_NAME = data2b.Key.CSUPPLIER_NAME,
                        ...
                        }).Select(data3b => new APR00100SummaryByDate2DTO()
                        {
