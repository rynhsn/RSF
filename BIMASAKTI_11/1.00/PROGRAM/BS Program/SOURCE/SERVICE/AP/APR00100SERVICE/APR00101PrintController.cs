...
{
    public class APR00101PrintController : R_ReportControllerBase
    {
        ...
        public APR00101PrintController(ILogger<APR00100PrintLogger> logger)
        {
            APR00100PrintLogger.R_InitializeLogger(logger);
            _logger = APR00100PrintLogger.R_GetInstanceLogger();
            _activitySource = APR00100Activity.R_InitializeAndGetActivitySource(nameof(APR00101PrintController));
        ...
        {
            pcFileTemplate = System.IO.Path.Combine("Reports", "APR00100ByDate.frx");
        }
