...
public class HDR00200PrintPrivateController : R_ReportControllerBase
{
    ...
    public HDR00200PrintPrivateController(ILogger<HDR00200PrintPrivateController> logger)
    {
        LoggerHDR00200.R_InitializeLogger(logger);
        _logger = LoggerHDR00200.R_GetInstanceLogger();
        _activitySource = HDR00200Activity.R_InitializeAndGetActivitySource(nameof(HDR00200PrintPrivateController));
    ...
    {
        pcfiletemplate = Path.Combine("Reports", "HDR00200CareReportPrivate.frx");
    }
    ...
    public R_DownloadFileResultDTO ActivityReportPost(HDR00200ReportParam poParam)
    {
        ...
        _logger.LogInfo("Start - Post Care Report Private");
        ...
        try
        {
            ...
            _logger.LogInfo("Set GUID Param - Post Care Report Private");
        ...
        _logger.LogInfo("End - Post Care Report Private");
        return loRtn;
    }
    ...
    public FileStreamResult ActivityReportGet(string pcGuid)
    {
        ...
        _logger.LogInfo("Start - Get Care Report Private");
        R_Exception loException = new();
        ...
        try
        {
            ...
            {
                _logger.LogInfo("Print Care Report Private");
            ...
            {
                _logger.LogInfo("Save As Care Report Private");
        ...
        loException.ThrowExceptionIfErrors();
        _logger.LogInfo("End - Get Care Report Private");
        return loRtn;
    }
    ...
    private HDR00200ReportWithBaseHeaderDTO GeneratePrint(HDR00200ReportParam poParam)
    {
        ...
        try
        {
            ...
            var loData = new HDR00200ReportResultDTO()
            {
                ...
                Header = null,
                DataPrivate = new List<HDR00200GroupCarePrivateDTO>(),
            };
            ...
            var loTempDataPrivate = loCollection.Where(x => x.LMAINTENANCE == false && x.LPRIVATE).GroupBy(data1a => new
            {
                data1a.CBUILDING_ID,
            ...
            loData.DataPrivate = loTempDataPrivate;
