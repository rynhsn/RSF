...
{
    public class GSM02531Cls : R_BusinessObjectAsync<GSM02531UtilityParameterDTO>
    {
        ...
        public async Task RSP_GS_ACTIVE_INACTIVE_BUILDING_UNIT_UTILITIESMethod(GSM02500ActiveInactiveParameterDTO poEntity)
        {
        ...
        private async Task RSP_GS_MAINTAIN_BUILDING_UNIT_UTILITIESMethod(GSM02531UtilityParameterDTO poEntity)
        {
        ...
        protected override async Task R_SavingAsync(GSM02531UtilityParameterDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            ...
            try
            {
                await RSP_GS_MAINTAIN_BUILDING_UNIT_UTILITIESMethod(poNewEntity);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        protected override async Task R_DeletingAsync(GSM02531UtilityParameterDTO poEntity)
        {
            ...
            try
            {
                await RSP_GS_MAINTAIN_BUILDING_UNIT_UTILITIESMethod(poEntity);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
