...
{
    public class UploadOtherUnitTypeCls : R_IBatchProcessAsync
    {
        ...
        private async Task _R_BatchProcessAsync(R_BatchProcessPar poBatchProcessPar)
        {
            ...
            try
            {
                ...
                await loDb.R_BulkInsertAsync<UploadOtherUnitTypeSaveDTO>((SqlConnection)loConn, "#OTHER_UNIT_TYPE", loParam);
                _logger.LogInfo("End Inser Bulk");
                ...
                _logger.LogDebug("EXEC RSP_GS_UPLOAD_OTHER_UNIT_TYPE {@poParameter}", loDbParam);
