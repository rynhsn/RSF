...
{
    public class GSM02570Cls : R_BusinessObjectAsync<GSM02503ImageParameterDTO>
    {
        ...
        public GSM02570Cls()
        {
            ...
            _activitySource = GSM02570ActivitySourceBase.R_GetInstanceActivitySource();
        }
        ...
        public async Task<ShowUnitTypeImageDTO> ShowUnitTypeImage(ShowUnitTypeImageParameterDTO poEntity)
        {
            ...
            try
            {
                ...
                lcQuery = $"EXEC RSP_GS_GET_PROPERTY_GALLERY_DETAIL " +
                    $"@CLOGIN_COMPANY_ID, " +
                ...
                _logger.LogDebug("EXEC RSP_GS_GET_PROPERTY_GALLERY_DETAIL {@Parameters} || ShowUnitTypeImage(Cls) ", loDbParam);
        ...
        private async Task RSP_GS_MAINTAIN_PROPERTY_GALLERYMethod(GSM02503ImageParameterDTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity("RSP_GS_MAINTAIN_PROPERTY_GALLERYMethod");
            R_Exception loException = new R_Exception();
            R_Db loDb = new R_Db();
            DbConnection loConn = null;
            DbCommand loCmd = null;
            ...
            try
            {
                ...
                lcQuery = $"EXEC RSP_GS_MAINTAIN_PROPERTY_GALLERY " +
                                 $"@CCOMPANY_ID, " +
                                 $"@CPROPERTY_ID, " +
                                 $"@CFILE_ID, " +
                                 $"@CFILE_NAME, " +
                ...
                loDb.R_AddCommandParameter(loCmd, "@CFILE_ID", DbType.String, 20, poEntity.Data.CFILE_ID);
                loDb.R_AddCommandParameter(loCmd, "@CFILE_NAME", DbType.String, 200, poEntity.Data.CFILE_NAME);
                ...
                _logger.LogDebug("EXEC RSP_GS_MAINTAIN_PROPERTY_GALLERY {@Parameters} || RSP_GS_MAINTAIN_PROPERTY_GALLERYMethod(Cls) ", loDbParam);
        ...
        public async Task<List<GSM02503ImageDTO>> GetUnitTypeImageList(GetUnitTypeImageListParameterDTO poEntity)
        {
            ...
            try
            {
                ...
                lcQuery = $"EXEC RSP_GS_GET_PROPERTY_GALLERY_LIST " +
                    $"@CLOGIN_COMPANY_ID, " +
                    $"@CSELECTED_PROPERTY_ID, " +
                ...
                _logger.LogDebug("EXEC RSP_GS_GET_PROPERTY_GALLERY_LIST {@Parameters} || GetUnitTypeImageList(Cls) ", loDbParam);
        ...
        protected override async Task R_DeletingAsync(GSM02503ImageParameterDTO poEntity)
        {
            ...
            try
            {
                ...
                await RSP_GS_MAINTAIN_PROPERTY_GALLERYMethod(poEntity);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        protected override async Task<GSM02503ImageParameterDTO> R_DisplayAsync(GSM02503ImageParameterDTO poEntity)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@CFILE_ID", DbType.String, 50, poEntity.Data.CFILE_ID);
                ...
                _logger.LogDebug("EXEC RSP_GS_GET_PROPERTY_GALLERY_DETAIL {@Parameters} || R_Display(Cls) ", loDbParam);
        ...
        protected override async Task R_SavingAsync(GSM02503ImageParameterDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            ...
            try
            {
                ...
                await RSP_GS_MAINTAIN_PROPERTY_GALLERYMethod(poNewEntity);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
            ...
            try
            {
                ...
                loAddParameter = new R_AddParameter()
                {
                    ...
                    BusinessKeyParameter = new R_BusinessKeyParameter()
                    {
                        ...
                        CDATA_TYPE = "GSM_PROPERTY_GALLERY",
                        CKEY01 = poNewEntity.CSELECTED_PROPERTY_ID,
                        CKEY02 = poNewEntity.Data.CFILE_ID
                    }
                };
