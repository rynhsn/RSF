...
{
    public class GSM02540UtilitiesCls : R_BusinessObjectAsync<GSM02531UtilityParameterDTO>
    {
        private LoggerGSM02540Utilities _logger;
        private readonly ActivitySource _activitySource;
        public GSM02540UtilitiesCls()
        {
            _logger = LoggerGSM02540Utilities.R_GetInstanceLogger();
            _activitySource = GSM02540UtilityActivitySourceBase.R_GetInstanceActivitySource();
        }

        public async Task RSP_GS_ACTIVE_INACTIVE_OTHER_UNIT_UTILITIESMethod(GSM02500ActiveInactiveParameterDTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity("RSP_GS_ACTIVE_INACTIVE_OTHER_UNIT_UTILITIESMethod");
            ...
            try
            {
                ...
                lcQuery = $"EXEC RSP_GS_ACTIVE_INACTIVE_OTHER_UNIT_UTILITIES " +
                                 $"@CCOMPANY_ID, " +
                                 $"@CPROPERTY_ID, " +
                                 $"@CUNIT_ID, " +
                                 $"@CUTILITIES_TYPE, " +
                ...
                _logger.LogDebug("EXEC RSP_GS_ACTIVE_INACTIVE_OTHER_UNIT_UTILITIES {@Parameters} || RSP_GS_ACTIVE_INACTIVE_OTHER_UNIT_UTILITIESMethod(Cls) ", loDbParam);
        ...
        private async Task RSP_GS_MAINTAIN_BUILDING_OTHER_UNIT_UTILITIESMethod(GSM02531UtilityParameterDTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity("RSP_GS_MAINTAIN_BUILDING_OTHER_UNIT_UTILITIES");
            R_Exception loException = new R_Exception();
            R_Db loDb = new R_Db();
            DbConnection loConn = null;
            DbCommand loCmd = null;
            ...
            try
            {
                ...
                lcQuery = $"EXEC RSP_GS_MAINTAIN_BUILDING_OTHER_UNIT_UTILITIES  " +
                                 $"@CLOGIN_COMPANY_ID, " +
                ...
                loDb.R_AddCommandParameter(loCmd, "@CSELECTED_UNIT_ID", DbType.String, 20, poEntity.CSELECTED_UNIT_ID);
                loDb.R_AddCommandParameter(loCmd, "@CSELECTED_UTILITIES_TYPE_ID", DbType.String, 2, poEntity.CSELECTED_UTILITIES_TYPE_ID);
                loDb.R_AddCommandParameter(loCmd, "@CSEQUENCE", DbType.String, 3, poEntity.Data.CSEQUENCE);
                ...
                _logger.LogDebug("EXEC RSP_GS_MAINTAIN_BUILDING_OTHER_UNIT_UTILITIES {@Parameters} || RSP_GS_MAINTAIN_BUILDING_OTHER_UNIT_UTILITIESMethod(Cls) ", loDbParam);
        ...
        public async Task<List<GSM02531UtilityTypeDTO>> GetUtilityTypeList(GetUtilityTypeParameterDTO poEntity)
        {
        ...
        public async Task<List<GSM02531UtilityDTO>> GetUtilitiesList(GetUtilitiesListParameterDTO poEntity)
        {
            ...
            try
            {
                ...
                lcQuery = $"EXEC RSP_GS_GET_BUILDING_OTHER_UTILITIES_LIST  " +
                                 $"@CLOGIN_COMPANY_ID, " +
                                 $"@CSELECTED_PROPERTY_ID, " +
                                 $"@CSELECTED_OTHER_UNIT_ID, " +
                                 $"@CSELECTED_UTILITIES_TYPE_ID, " +
                                 $"@CLOGIN_USER_ID";
                ...
                loDb.R_AddCommandParameter(loCmd, "@CSELECTED_OTHER_UNIT_ID", DbType.String, 50, poEntity.CSELECTED_OTHER_UNIT_ID);
                ...
                _logger.LogDebug("EXEC RSP_GS_GET_BUILDING_OTHER_UTILITIES_LIST  {@Parameters} || GetUtilitiesList(Cls) ", loDbParam);
        ...
        protected override async Task<GSM02531UtilityParameterDTO> R_DisplayAsync(GSM02531UtilityParameterDTO poEntity)
        {
            ...
            {
                loConn = await loDb.GetConnectionAsync();
                lcQuery = $"EXEC RSP_GS_GET_BUILDING_OTHER_UTILITIES_DETAIL " +
                                 $"@CLOGIN_COMPANY_ID, " +
                                 $"@CSELECTED_PROPERTY_ID, " +
                                 $"@CSELECTED_UNIT_ID, " +
                                 $"@CSELECTED_UTILITIES_TYPE_ID, " +
                ...
                _logger.LogDebug("EXEC RSP_GS_GET_BUILDING_OTHER_UTILITIES_DETAIL {@Parameters} || R_Display(Cls) ", loDbParam);
        ...
        protected override async Task R_SavingAsync(GSM02531UtilityParameterDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            ...
            try
            {
                await RSP_GS_MAINTAIN_BUILDING_OTHER_UNIT_UTILITIESMethod(poNewEntity);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        protected override async Task R_DeletingAsync(GSM02531UtilityParameterDTO poEntity)
        {
            ...
            try
            {
                await RSP_GS_MAINTAIN_BUILDING_OTHER_UNIT_UTILITIESMethod(poEntity);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
