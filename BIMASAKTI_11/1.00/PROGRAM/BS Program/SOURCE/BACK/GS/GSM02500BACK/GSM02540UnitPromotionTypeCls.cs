...
namespace GSM02500BACK
{
    ...
    {
        RSP_GS_MAINTAIN_UNIT_PROMOTION_TYPEResources.Resources_Dummy_Class _loRsp = new RSP_GS_MAINTAIN_UNIT_PROMOTION_TYPEResources.Resources_Dummy_Class();
        ...
        public GSM02540UnitPromotionTypeCls()
        {
            ...
            _activitySource = GSM02540UnitPromotionTypeActivitySourceBase.R_GetInstanceActivitySource();
        }
        ...
        {
            using Activity activity = _activitySource.StartActivity("RSP_GS_MAINTAIN_UNIT_PROMOTION_TYPEMethod");
            R_Exception loException = new R_Exception();
            R_Db loDb = new R_Db();
            DbConnection loConn = null;
            DbCommand loCmd = null;
