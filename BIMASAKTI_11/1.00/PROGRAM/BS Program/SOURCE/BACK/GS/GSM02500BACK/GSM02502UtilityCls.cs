...
{
    public class GSM02502UtilityCls : R_BusinessObject<GSM02502UtilityParameterDTO>
    {
        ...
        public List<GSM02502UtilityDTO> GetUtilityList(GetUtilityListDTO poEntity)
        {
        ...
        private void RSP_GS_MAINTAIN_UNIT_TYPE_CATEGORY_UTILITYMethod(GSM02502UtilityParameterDTO poEntity)
        {
...
/*
        protected override void R_Deleting(GSM02502UtilityParameterDTO poEntity)
        {
            R_Exception loException = new R_Exception();

            try
            {
                RSP_GS_MAINTAIN_UNIT_TYPE_CATEGORY_UTILITYMethod(poEntity);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        protected override GSM02502UtilityParameterDTO R_Display(GSM02502UtilityParameterDTO poEntity)
        {
        ...
        protected override void R_Saving(GSM02502UtilityParameterDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            ...
            try
            {
                RSP_GS_MAINTAIN_UNIT_TYPE_CATEGORY_UTILITYMethod(poNewEntity);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
