...
{
    public class GSM02540OtherUnitTypeCls : R_BusinessObjectAsync<GSM02540ParameterDTO>
    {
        ...
        public async Task RSP_GS_ACTIVE_INACTIVE_OTHER_UNIT_TYPEMethod(GSM02500ActiveInactiveParameterDTO poEntity)
        {
        ...
        private async Task RSP_GS_MAINTAIN_OTHER_UNIT_TYPEMethod(GSM02540ParameterDTO poEntity)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@COTHER_UNIT_TYPE_NAME", DbType.String, 200, poEntity.Data.COTHER_UNIT_TYPE_NAME);
        ...
        public async Task<List<GSM02540DTO>> GetOtherUnitTypeList(GetOtherUnitTypeListParameterDTO poEntity)
        {
        ...
        protected override async Task R_DeletingAsync(GSM02540ParameterDTO poEntity)
        {
            ...
            try
            {
                await RSP_GS_MAINTAIN_OTHER_UNIT_TYPEMethod(poEntity);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        protected override async Task<GSM02540ParameterDTO> R_DisplayAsync(GSM02540ParameterDTO poEntity)
        {
        ...
        protected override async Task R_SavingAsync(GSM02540ParameterDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            ...
            try
            {
                await RSP_GS_MAINTAIN_OTHER_UNIT_TYPEMethod(poNewEntity);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
