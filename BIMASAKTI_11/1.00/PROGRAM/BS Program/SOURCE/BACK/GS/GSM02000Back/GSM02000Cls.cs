...
public class GSM02000Cls : R_BusinessObjectAsync<GSM02000DTO>
{
    Resources_Dummy_Class _resources = new();
    ...
    protected override async Task<GSM02000DTO> R_DisplayAsync(GSM02000DTO poEntity)
    {
    ...
    protected override async Task R_SavingAsync(GSM02000DTO poNewEntity, eCRUDMode poCRUDMode)
    {
        ...
        try
        {
            ...
            var loListTempTable =
                R_Utility.R_ConvertCollectionToCollection<GSM02000DeductionGridDTO, GSM02000DeductionBatchDTO>(
                    poNewEntity.ODEDUCTION_LIST);
            ...
            loDb.R_AddCommandParameter(loCmd, "@CROUNDING_MODE", DbType.String, 10, poNewEntity.CROUNDING_MODE);
            loDb.R_AddCommandParameter(loCmd, "@IROUNDING", DbType.Int32, 10, poNewEntity.IROUNDING);
            loDb.R_AddCommandParameter(loCmd, "@CTAXIN_GLACCOUNT_NO", DbType.String, 20,
                poNewEntity.CTAXIN_GLACCOUNT_NO);
            loDb.R_AddCommandParameter(loCmd, "@CTAXOUT_GLACCOUNT_NO", DbType.String, 60,
                poNewEntity.CTAXOUT_GLACCOUNT_NO);
            loDb.R_AddCommandParameter(loCmd, "@LACTIVE", DbType.Boolean, 1, poNewEntity.LACTIVE);
            loDb.R_AddCommandParameter(loCmd, "@CACTION", DbType.String, 10, lcAction);
            loDb.R_AddCommandParameter(loCmd, "@CUSER_ID", DbType.String, 50, poNewEntity.CUSER_ID);
            loDb.R_AddCommandParameter(loCmd, "@cDEDUCTION_TAX_ID", DbType.String, 20, poNewEntity.CDEDUCTION_TAX_ID);
    ...
    protected override async Task R_DeletingAsync(GSM02000DTO poEntity)
    {
    ...
    public async Task<List<GSM02000GridDTO>> SalesTaxListDbAsync(GSM02000ParameterDb poParameter)
    {
    ...
    public async Task<List<GSM02000DeductionGridDTO>> DeductionListDbAsync(GSM02000ParameterDb poParameter)
    {
        using var loActivity = _activitySource.StartActivity(nameof(DeductionListDbAsync));
        R_Exception loEx = new();
        List<GSM02000DeductionGridDTO> loRtn = null;
        R_Db loDb;
        DbConnection loConn;
    ...
    public async Task<List<GSM02000PropertyDTO>> PropertyListDbAsync(GSM02000ParameterDb poParameter)
    {
        using var loActivity = _activitySource.StartActivity(nameof(PropertyListDbAsync));
        R_Exception loEx = new();
        List<GSM02000PropertyDTO> loRtn = null;
        R_Db loDb;
        DbConnection loConn;
    ...
    public async Task<List<GSM02000RoundingDTO>> RoundingListDbAsync(GSM02000ParameterDb poParameter)
    {
        using var loActivity = _activitySource.StartActivity(nameof(RoundingListDbAsync));
        R_Exception loEx = new();
        List<GSM02000RoundingDTO> loRtn = null;
        R_Db loDb;
        DbConnection loConn;
    ...
    public async Task SetActiveInactiveDbAsync(GSM02000ActiveInactiveDb poParameter)
    {
        using var loActivity = _activitySource.StartActivity(nameof(SetActiveInactiveDbAsync));
        R_Exception loEx = new();
        R_Db loDb;
        DbConnection loConn;
        DbCommand loCmd;
