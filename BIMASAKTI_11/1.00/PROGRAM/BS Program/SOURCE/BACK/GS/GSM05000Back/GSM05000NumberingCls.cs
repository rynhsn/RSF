...
public class GSM05000NumberingCls : R_BusinessObject<GSM05000NumberingGridDTO>
{
    ...
    protected override void R_Saving(GSM05000NumberingGridDTO poNewEntity, eCRUDMode poCRUDMode)
    {
        ...
        try
        {
            ...
            loDb.R_AddCommandParameter(loCmd, "@CCOMPANY_ID", DbType.String, 1, poNewEntity.CCOMPANY_ID);
            loDb.R_AddCommandParameter(loCmd, "@CTRANSACTION_CODE", DbType.String, 1, poNewEntity.CTRANSACTION_CODE);
            loDb.R_AddCommandParameter(loCmd, "@CCYEAR", DbType.String, 1, poNewEntity.CCYEAR);
            loDb.R_AddCommandParameter(loCmd, "@CPERIOD_NO", DbType.String, 4, poNewEntity.CPERIOD_NO);
            loDb.R_AddCommandParameter(loCmd, "@CDEPT_CODE", DbType.String, 10, poNewEntity.CDEPT_CODE);
    ...
    protected override void R_Deleting(GSM05000NumberingGridDTO poEntity)
    {
        ...
        try
        {
            ...
            loDb.R_AddCommandParameter(loCmd, "@CCOMPANY_ID", DbType.String, 1, poEntity.CCOMPANY_ID);
            loDb.R_AddCommandParameter(loCmd, "@CTRANSACTION_CODE", DbType.String, 1, poEntity.CTRANSACTION_CODE);
            loDb.R_AddCommandParameter(loCmd, "@CCYEAR", DbType.String, 1, poEntity.CCYEAR);
            loDb.R_AddCommandParameter(loCmd, "@CPERIOD_NO", DbType.String, 4, poEntity.CPERIOD_NO);
