...
public class GLI00100Cls
{
    ...
    public GLI00100AccountAnalysisDTO GLI00100GetDetailAccountAnalysisDb(GLI00100ParameterDb poParam, GLI00100AccountAnalysisParamDb poOptParam)
    {
        var loEx = new R_Exception();
    ...
    public GLI00100AccountAnalysisDTO GLI00100GetDetailAccountAnalysisReportDb(GLI00100ParameterDb poParam, GLI00100AccountAnalysisParamDb poOptParam)
    {
        var loEx = new R_Exception();
        GLI00100AccountAnalysisDTO loReturn = null;
        R_Db loDb;
