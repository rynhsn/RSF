...
{
    public class CBT01100Cls : R_BusinessObject<CBT01100JournalHDParam>
    {
        ...
        public List<CBT01100DTO> GetJournalList(CBT01100JournalHDParam poEntity)
        {
        ...
        public void UpdateJournalStatus(CBT01100UpdateStatusDTO poEntity)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@LAUTO_COMMIT", DbType.Boolean, 2, poEntity.LAUTO_COMMIT);
                loDb.R_AddCommandParameter(loCmd, "@LUNDO_COMMIT", DbType.Boolean, 2, poEntity.LUNDO_COMMIT);
        ...
        public CBT01100RapidApprovalValidationDTO ValidationRapidApprove(CBT01100RapidApprovalValidationDTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity(MethodBase.GetCurrentMethod().Name);
            var loEx = new R_Exception();
        ...
        protected override CBT01100JournalHDParam R_Display(CBT01100JournalHDParam poEntity)
        {
            var loEx = new R_Exception();
            CBT01100JournalHDParam loResult = null;
            ...
            try
            {
                ...
                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);
                loResult = R_Utility.R_ConvertTo<CBT01100JournalHDParam>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        protected override void R_Saving(CBT01100JournalHDParam poNewEntity, eCRUDMode poCRUDMode)
        {
        ...
        protected override void R_Deleting(CBT01100JournalHDParam poEntity)
        {
            using Activity activity = _activitySource.StartActivity(MethodBase.GetCurrentMethod().Name);
            R_Exception loEx = new R_Exception();
            R_Db loDb = new R_Db();
