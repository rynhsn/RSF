...
{
    public class CBT01110Cls : R_BusinessObject<CBT01110ParamDTO>
    {
        ...
        public List<CBT01101DTO> GetJournalDetailList(CBT01110ParamDTO poParam)
        {
        ...
        protected override CBT01110ParamDTO R_Display(CBT01110ParamDTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity(MethodBase.GetCurrentMethod().Name);
            var loEx = new R_Exception();
            CBT01110ParamDTO loResult = null;
            ...
            try
            {
                ...
                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);
                loResult = R_Utility.R_ConvertTo<CBT01110ParamDTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        protected override void R_Saving(CBT01110ParamDTO poNewEntity, eCRUDMode poCRUDMode)
        {
        ...
        protected override void R_Deleting(CBT01110ParamDTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity(MethodBase.GetCurrentMethod().Name);
            var loEx = new R_Exception();
            CBT01110ParamDTO loResult = null;
