...
public class PMT06500InitCls
{
    ...
    public List<PMT06500PropertyDTO> GetPropertyList(PMT06500ParameterDb poParam)
    {
        ...
        try
        {
            ...
            loRtn = R_Utility.R_ConvertTo<PMT06500PropertyDTO>(loDataTable).ToList();
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
    ...
    public PMT06500YearRangeDTO GetYearRange(PMT06500ParameterDb poParams)
    {
        using var loActivity = _activitySource.StartActivity(nameof(GetYearRange));
        R_Exception loEx = new();
        PMT06500YearRangeDTO loReturn = new();
        R_Db loDb;
        DbConnection loConn;
        DbCommand loCmd;
        string lcQuery;
        ...
        try
        {
            ...
            loReturn = R_Utility.R_ConvertTo<PMT06500YearRangeDTO>(DataTable).FirstOrDefault();
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
    ...
    public List<PMT06500PeriodDTO> GetPeriodList(PMT06500ParameterDb poParam)
    {
        using Activity loActivity = _activitySource.StartActivity(nameof(GetPeriodList));
        R_Exception loEx = new();
        List<PMT06500PeriodDTO> loRtn = null;
        R_Db loDb;
        DbConnection loConn;
        DbCommand loCmd;
        string lcQuery;
        try
        {
            ...
            loRtn = R_Utility.R_ConvertTo<PMT06500PeriodDTO>(loDataTable).ToList();
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
    ...
    public PMT06500TransCodeDTO GetTransCodeInfo(PMT06500ParameterDb poParam)
    {
        using Activity loActivity = _activitySource.StartActivity(nameof(GetTransCodeInfo));
        R_Exception loEx = new();
        PMT06500TransCodeDTO loRtn = null;
        R_Db loDb;
        DbConnection loConn;
        DbCommand loCmd;
        string lcQuery;
        try
        {
            ...
            loRtn = R_Utility.R_ConvertTo<PMT06500TransCodeDTO>(loDataTable).FirstOrDefault();
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
