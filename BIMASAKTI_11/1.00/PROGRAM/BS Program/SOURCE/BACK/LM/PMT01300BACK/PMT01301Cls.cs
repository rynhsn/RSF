...
{
    public class PMT01301Cls : R_IBatchProcess
    {
        ...
        private async Task _BatchProcess(R_BatchProcessPar poBatchProcessPar)
        {
            ...
            try
            {
                ...
                PMT01300UploadBigObjectParameterDTO loObject = R_NetCoreUtility.R_DeserializeObjectFromByte<PMT01300UploadBigObjectParameterDTO>(poBatchProcessPar.BigObject);
                ...
                loDb.R_BulkInsert<PMT01300UploadAgreementDTO>((SqlConnection)loConn, "#LEASE_AGREEMENT", loObject.AgreementList);
                #endregion
                ...
                loDb.SqlExecNonQuery(lcQuery, loConn, false);
                loDb.R_BulkInsert<PMT01300UploadUnitDTO>((SqlConnection)loConn, "#LEASE_AGREEMENT_UNIT", loObject.UnitList);
                #endregion
                ...
                loDb.SqlExecNonQuery(lcQuery, loConn, false);
                loDb.R_BulkInsert<PMT01300UploadUtilitiesDTO>((SqlConnection)loConn, "#LEASE_AGREEMENT_UTILITY", loObject.UtilityList);
                #endregion
                ...
                loDb.SqlExecNonQuery(lcQuery, loConn, false);
                loDb.R_BulkInsert<PMT01300UploadChargesDTO>((SqlConnection)loConn, "#LEASE_AGREEMENT_CHARGES", loObject.ChargesList);
                #endregion
                ...
                loDb.SqlExecNonQuery(lcQuery, loConn, false);
                loDb.R_BulkInsert<PMT01300UploadDepositDTO>((SqlConnection)loConn, "#LEASE_AGREEMENT_DEPOSIT", loObject.DepositList);
                #endregion
