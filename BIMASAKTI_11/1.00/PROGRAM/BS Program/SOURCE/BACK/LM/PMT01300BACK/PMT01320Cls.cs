...
{
    public class PMT01320Cls : R_BusinessObject<PMT01320DTO>
    {
        ...
        public PMT01320Cls()
        {
            ...
            _activitySource = PMT01320ActivitySourceBase.R_GetInstanceActivitySource();
        }

        public List<PMT01320DTO> GetAllLOIUtilities(PMT01320DTO poEntity)
        {
            ...
            try
            {
                ...
                loResult = R_Utility.R_ConvertTo<PMT01320DTO>(loDataTable).ToList();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        protected override PMT01320DTO R_Display(PMT01320DTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity("R_Display");
            var loEx = new R_Exception();
            PMT01320DTO loResult = null;
            ...
            try
            {
             ...
             .Where(x => x != null && x.ParameterName.StartsWith("@")).Select(x => x.Value);
                ...
                loResult = R_Utility.R_ConvertTo<PMT01320DTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        protected override void R_Saving(PMT01320DTO poNewEntity, eCRUDMode poCRUDMode)
        {
        ...
        protected override void R_Deleting(PMT01320DTO poEntity)
        {
        ...
        public void ChangeStatusLOIUtility(PMT01320ActiveInactiveDTO poNewEntity)
        {
