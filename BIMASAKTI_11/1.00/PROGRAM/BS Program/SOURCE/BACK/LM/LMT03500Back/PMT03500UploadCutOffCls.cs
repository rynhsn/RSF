...
public class PMT03500UploadCutOffCls : R_IBatchProcess
{
    RSP_PM_UPLOAD_UTILITY_CUTOFF_ECResources.Resources_Dummy_Class _rscUploadEC = new();
    ...
    public async Task _batchProcess(R_BatchProcessPar poBatchProcessPar)
    {
        ...
        var lcQuery = "";
        List<PMT03500UploadCutOffErrorValidateDTO> loTempObject = new();
        IList<PMT03500UploadCutOffRequestECDTO> loObjectEC = new List<PMT03500UploadCutOffRequestECDTO>();
        IList<PMT03500UploadCutOffRequestWGDTO> loObjectWG = new List<PMT03500UploadCutOffRequestWGDTO>();
        //object loTempVar = "";
        var LcGroupCode = "";
        ...
        try
        {
            ...
            if (lcUtility == "EC")
            {
                loObjectEC = R_Utility
                    .R_ConvertCollectionToCollection<PMT03500UploadCutOffErrorValidateDTO,
                        PMT03500UploadCutOffRequestECDTO>(loTempObject);
            }
            ...
            lcQuery = $"RSP_PM_UPLOAD_UTILITY_CUTOFF_{lcUtility}";
