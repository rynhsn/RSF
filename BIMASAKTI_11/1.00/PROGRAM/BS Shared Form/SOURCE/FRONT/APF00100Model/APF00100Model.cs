...
namespace APF00100Model
{
    public class APF00100Model : R_BusinessObjectServiceClientBase<APF00100HeaderParameterDTO>, IAPF00100
    {
        ...
        public APF00100HeaderResultDTO GetCAWTCustReceipt(APF00100HeaderParameterDTO poParam)
        {
            throw new NotImplementedException();
        }
        public async Task<APF00100HeaderResultDTO> GetCAWTCustReceiptAsync(APF00100HeaderParameterDTO poParam)
        {
            R_Exception loEx = new R_Exception();
            APF00100HeaderResultDTO loRtn = null;
            ...
            try
            {
                ...
                loRtn = await R_HTTPClientWrapper.R_APIRequestObject<APF00100HeaderResultDTO, APF00100HeaderParameterDTO>(
                    _RequestServiceEndPoint,
                    nameof(IAPF00100.GetCAWTCustReceipt),
                    poParam,
                    DEFAULT_MODULE,
                    _SendWithContext,
                    _SendWithToken);
        ...
        public APF00100HeaderResultDTO GetCQCustReceipt(APF00100HeaderParameterDTO poParam)
        {
            throw new NotImplementedException();
        }
        public async Task<APF00100HeaderResultDTO> GetCQCustReceiptAsync(APF00100HeaderParameterDTO poParam)
        {
            R_Exception loEx = new R_Exception();
            APF00100HeaderResultDTO loRtn = null;
            ...
            try
            {
                ...
                loRtn = await R_HTTPClientWrapper.R_APIRequestObject<APF00100HeaderResultDTO, APF00100HeaderParameterDTO>(
                    _RequestServiceEndPoint,
                    nameof(IAPF00100.GetCQCustReceipt),
                    poParam,
                    DEFAULT_MODULE,
                    _SendWithContext,
                    _SendWithToken);
