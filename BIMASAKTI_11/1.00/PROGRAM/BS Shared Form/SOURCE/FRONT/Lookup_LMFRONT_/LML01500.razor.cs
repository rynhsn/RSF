...
{
    public partial class LML01500 : R_Page
    {
        private LookupLML01500ViewModel _viewModel = new LookupLML01500ViewModel();
        private R_Grid<LML01500DTO> GridRef;
        ...
        public async Task R_ServiceGetListRecordAsync(R_ServiceGetListRecordEventArgs eventArgs)
        {
            ...
            try
            {
                var loParam = (LML01500ParameterDTO)eventArgs.Parameter;
                await _viewModel.GetSLACategoryList(loParam);
