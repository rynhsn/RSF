    ...
    public partial class APF00100 : R_Page
    {
        ...
        protected override async Task R_Init_From_Master(object poParameter)
        {
            ...
            try
            {
                ...
                if (loAllocationViewModel.loAllocationParameter.CTRANS_CODE != TransCodeConstant.VAR_PAYMENT_TO_SUPPLIER)
                {
                ...
                if (loAllocationViewModel.loHeader != null)
                {
        ...
        private async Task R_After_OpenAllocationEntry_TabPage(R_AfterOpenTabPageEventArgs eventArgs)
        {
            R_Exception loEx = new R_Exception();
