...
namespace APF00100COMMON
{
    public interface IAPF00100
    {
        ...
        APF00100HeaderResultDTO GetCAWTCustReceipt(APF00100HeaderParameterDTO poParam);
        APF00100HeaderResultDTO GetCQCustReceipt(APF00100HeaderParameterDTO poParam);
