...
namespace APF00100BACK
{
    public class APF00100Cls
    {
        ...
        public async Task<List<APF00100ListDTO>> GetAllocationList(APF00100ListParameterDTO poParam)
        {
        ...
        public async Task<APF00100HeaderDTO> GetHeader(APF00100HeaderParameterDTO poParam)
        {
        ...
        public async Task<APF00100HeaderDTO> GetCAWTCustReceipt(APF00100HeaderParameterDTO poParam)
        {
            ...
            try
            {
                ...
                lcQuery = "EXEC RSP_AP_GET_CA_WT_SUPP_PAYMENT " +
                    "@CLOGIN_COMPANY_ID, " +
                    "@CREC_ID, " +
                    "@CLANGUAGE_ID";
                ...
                _logger.LogDebug("EXEC RSP_AP_GET_CA_WT_SUPP_PAYMENT {@Parameters} || GetCAWTCustReceipt(Cls) ", loDbParam);
        ...
        public async Task<APF00100HeaderDTO> GetCQCustReceipt(APF00100HeaderParameterDTO poParam)
        {
            ...
            try
            {
                ...
                lcQuery = "EXEC RSP_AP_GET_CQ_SUPP_PAYMENT " +
                    "@CLOGIN_COMPANY_ID, " +
                    "@CREC_ID, " +
                    "@CLANGUAGE_ID";
                ...
                _logger.LogDebug("EXEC RSP_AP_GET_CQ_SUPP_PAYMENT {@Parameters} || GetCQCustReceipt(Cls) ", loDbParam);
        ...
        public async Task<GetCallerTrxInfoDTO> GetCallerTrxInfo(GetCallerTrxInfoParameterDTO poParam)
        {
        ...
        public async Task<GetCompanyInfoDTO> GetCompanyInfo(GetCompanyInfoParameterDTO poParam)
        {
        ...
        public async Task<GetGLSystemParamDTO> GetGLSystemParam(GetGLSystemParamParameterDTO poParam)
        {
        ...
        public async Task<GetPeriodDTO> GetPeriod(GetPeriodParameterDTO poEntity)
        {
        ...
        public async Task<GetTransactionFlagDTO> GetTransactionFlag(GetTransactionFlagParameterDTO poParam)
        {
