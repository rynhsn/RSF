...
{
    public class APF00110Cls : R_BusinessObjectAsync<APF00110ParameterDTO>
    {
        ...
        public async Task<List<GetTransactionTypeDTO>> GetTransactionTypeList(GetTransactionTypeParameterDTO poParameter)
        {
        ...
        public async Task SubmitAllocationProcess(SubmitAllocationParameterDTO poParameter)
        {
        ...
        public async Task RedraftAllocationProcess(RedraftAllocationParameterDTO poParameter)
        {
        ...
        public async Task<APF00110DTO> GetAllocationDetail(GetAllocationDetailParameterDTO poParam)
        {
        ...
        protected override async Task<APF00110ParameterDTO> R_DisplayAsync(APF00110ParameterDTO poEntity)
        {
            ...
            try
            {
                ...
                loResult.Data = await GetAllocationDetail(loParameter);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        protected override async Task R_SavingAsync(APF00110ParameterDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@CLOGIN_COMPANY_ID", DbType.String, 20, poNewEntity.CLOGIN_COMPANY_ID);
                loDb.R_AddCommandParameter(loCmd, "@CPROPERTY_ID", DbType.String, 20, poNewEntity.CPROPERTY_ID);
                loDb.R_AddCommandParameter(loCmd, "@CLOGIN_USER_ID", DbType.String, 20, poNewEntity.CLOGIN_USER_ID);
                ...
                loDb.R_AddCommandParameter(loCmd, "@CALLOC_DATE", DbType.String, 8, poNewEntity.CALLOC_DATE);
                loDb.R_AddCommandParameter(loCmd, "@CSUPPLIER_ID", DbType.String, 20, poNewEntity.CSUPPLIER_ID);
                loDb.R_AddCommandParameter(loCmd, "@CSUPPLIER_SEQ_NO", DbType.String, 10, poNewEntity.CSUPPLIER_SEQ_NO);
                ...
                loDb.R_AddCommandParameter(loCmd, "@CFR_DEPT_CODE", DbType.String, 20, poNewEntity.CFR_DEPT_CODE);
                loDb.R_AddCommandParameter(loCmd, "@CFR_TRANS_CODE", DbType.String, 10, poNewEntity.CFR_TRANS_CODE);
                loDb.R_AddCommandParameter(loCmd, "@CFR_REF_NO", DbType.String, 30, poNewEntity.CFR_REF_NO);
                loDb.R_AddCommandParameter(loCmd, "@CFR_CURRENCY_CODE", DbType.String, 3, poNewEntity.CFR_CURRENCY_CODE);
                ...
                loDb.R_AddCommandParameter(loCmd, "@CTO_DEPT_CODE", DbType.String, 20, poNewEntity.CTO_DEPT_CODE);
                loDb.R_AddCommandParameter(loCmd, "@CTO_TRANS_CODE", DbType.String, 10, poNewEntity.CTO_TRANS_CODE);
                loDb.R_AddCommandParameter(loCmd, "@CTO_REF_NO", DbType.String, 30, poNewEntity.CTO_REF_NO);
                loDb.R_AddCommandParameter(loCmd, "@CTO_CURRENCY_CODE", DbType.String, 3, poNewEntity.CTO_CURRENCY_CODE);
        ...
        protected override async Task R_DeletingAsync(APF00110ParameterDTO poEntity)
        {
            ...
            try
            {
                ...
                lcQuery = "EXEC RSP_AP_DELETE_ALLOCATION " +
                    "@CALLOCATION_ID, " +
                    "@CUSER_ID";
