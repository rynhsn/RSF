...
{
    public class PMF00200HeaderPrintDTO
    {
        ...
        public DateTime? DREF_DATE_DISPLAY { get; set; }
        public string CDOC_NO { get; set; }
        public string CDOC_DATE { get; set; }
        public DateTime? DDOC_DATE_DISPLAY { get; set; }
        public string CCHEQUE_NO { get; set; }
        public string CCHEQUE_DATE { get; set; }
        public DateTime? DCHEQUE_DATE_DISPLAY { get; set; }
