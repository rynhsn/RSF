...
namespace GLF00100BACK
{
    public class GLF00100Cls
    {
        ...
        public async Task<GLF00100InitialDTO> GetInfoCompany(string poCompanyID)
        {
        ...
        public async Task<GLF00100DTO> GetJournalDetail(GLF00100ParameterDTO poEntity)
        {
        ...
        public async Task<List<GLF00101DTO>> GetAllJournalDetailList(GLF00101DTO poEntity)
        {
