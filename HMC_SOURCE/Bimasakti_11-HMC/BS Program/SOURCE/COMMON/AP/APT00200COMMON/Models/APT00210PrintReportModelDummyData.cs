...
namespace APT00200COMMON.Models
{
    public class APT00210PrintReportModelDummyData
    {
        public static APT00210PrintReportResultDTO DefaultDataReport()
        {
            ...
            int lnHeader = 5;
            int lnDetail;
            List<APT00210PrintReportDTO> loCollection = new List<APT00210PrintReportDTO>();
            for (int j = 1; j <= lnHeader; j++)
            {
                loCollection.Add(new APT00210PrintReportDTO()
                {
                    CREF_NO = "REF001",
                    CREF_DATE = "20230101",
                    CDOC_NO = "DOC001",
            ...
            for (int j = 1; j <= lnHeader; j++)
            {
                loSubDetail.Add(new APT00210PrintReportSubDetailDTO()
                {
        ...
        public static APT00210PrintReportResultWithBaseHeaderPrintDTO DefaultDataWithHeader()
        {
            ...
            loRtn.ReportData = APT00210PrintReportModelDummyData.DefaultDataReport();
