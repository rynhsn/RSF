...
{
    public class PMT50610PrintReportColumnDTO
    {
        //HEADER
        public string CREF_NO { get; set; } = "Ref. No.";
        public string CREF_DATE { get; set; } = "Date";
        public string CDOC_NO { get; set; } = "Document No";
        public string CDOC_DATE { get; set; } = "Date";
        public string CTENANT_NAME { get; set; } = "Customer";
        public string CTENANT_ADDRESS { get; set; } = "Address";
        public string CCURRENCY_CODE { get; set; } = "Currency";
        public string CPAY_TERM_NAME { get; set; } = "Terms";
        public string CTENANT_PHONE_FAX1 { get; set; } = "Phone / Fax";
        public string CTENANT_EMAIL1 { get; set; } = "Email";
