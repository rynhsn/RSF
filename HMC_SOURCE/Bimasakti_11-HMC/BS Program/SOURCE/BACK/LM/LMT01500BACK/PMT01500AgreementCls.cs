...
{
    public class PMT01500AgreementCls : R_BusinessObject<PMT01500AgreementDetailDTO>
    {
        ...
        public PMT01500AgreementCls()
        {
            _loggerLMT01500 = LoggerPMT01500.R_GetInstanceLogger();
            _activitySource = PMT01500Activity.R_GetInstanceActivitySource();
        }

        public List<PMT01500ComboBoxDTO> GetComboBoxDataCLeaseModeDb(PMT01500UtilitiesWithCultureIDParameterDTO poParameterInternal)
        {
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<PMT01500ComboBoxDTO> GetComboBoxDataCChargesModeDb(PMT01500UtilitiesWithCultureIDParameterDTO poParameterInternal)
        {
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        protected override PMT01500AgreementDetailDTO R_Display(PMT01500AgreementDetailDTO poEntity)
        {
            string? lcMethod = nameof(R_Display);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            PMT01500AgreementDetailDTO loRtn = new PMT01500AgreementDetailDTO();
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
...
#pragma warning disable CS8600 // Converting null literal or possible null value to non-nullable type.
                loRtn = R_Utility.R_ConvertTo<PMT01500AgreementDetailDTO>(loProfileDataTable).FirstOrDefault();
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        protected override void R_Saving(PMT01500AgreementDetailDTO poNewEntity, eCRUDMode poCRUDMode)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
        ...
        protected override void R_Deleting(PMT01500AgreementDetailDTO poEntity)
        {
