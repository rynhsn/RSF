...
{
    public class PMT50621Cls : R_BusinessObject<PMT50621ParameterDTO>
    {
        //RSP_PM_DELETE_TRANS_HDResources.Resources_Dummy_Class _loRspDeleteTransHd = new RSP_PM_DELETE_TRANS_HDResources.Resources_Dummy_Class();
        RSP_PM_DELETE_TRANS_PDResources.Resources_Dummy_Class _loRspDeleteTransPd = new RSP_PM_DELETE_TRANS_PDResources.Resources_Dummy_Class();
        RSP_PM_SAVE_TRANS_PDResources.Resources_Dummy_Class _loRspSaveTransPd = new RSP_PM_SAVE_TRANS_PDResources.Resources_Dummy_Class();
        ...
        public PMT50621Cls()
        {
            ...
            _activitySource = PMT50621ActivitySourceBase.R_GetInstanceActivitySource();
        }
        ...
        public List<GetProductTypeDTO> GetProductTypeList(GetProductTypeParameterDTO poParameter)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@CCLASS_ID", DbType.String, 50, "_PM_PRODUCT_TYPE");
        ...
        public PMT50621DTO RefreshInvoiceItem(PMT50621RefreshParameterDTO poParameter)
        {
            using Activity activity = _activitySource.StartActivity("RefreshInvoiceItem");
            R_Exception loException = new R_Exception();
            PMT50621DTO loResult = null;
            R_Db loDb = new R_Db();
            DbConnection loConn = null;
            DbCommand loCmd = null;
            string lcQuery;
            ...
            try
            {
                ...
                _logger.LogDebug("EXEC RSP_PM_GET_TRANS_PD {@Parameters} || RefreshInvoiceItem(Cls) ", loDbParam);

                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);

                loResult = R_Utility.R_ConvertTo<PMT50621DTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        protected override void R_Deleting(PMT50621ParameterDTO poEntity)
        {
            ...
            try
            {
                ...
                lcQuery = "EXEC RSP_PM_DELETE_TRANS_PD @CREC_ID";
                ...
                _logger.LogDebug("EXEC RSP_PM_DELETE_TRANS_PD {@Parameters} || R_Deleting(Cls) ", loDbParam);
        ...
        protected override PMT50621ParameterDTO R_Display(PMT50621ParameterDTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity("R_Display");
            R_Exception loException = new R_Exception();
            PMT50621ParameterDTO loResult = new PMT50621ParameterDTO();
        ...
        protected override void R_Saving(PMT50621ParameterDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            using Activity activity = _activitySource.StartActivity("R_Saving");
            R_Exception loEx = new R_Exception();
            PMT50621SaveResultDTO loResult = null;
            string lcQuery = "";
            R_Db loDb = new R_Db();
            DbConnection loConn = null;
            DbCommand loCmd = null;
            ...
            try
            {
                ...
                try
                {
                    ...
                    _logger.LogDebug("EXEC RSP_PM_SAVE_TRANS_PD {@poParameter}", loDbParam);

                    var loDataTable = loDb.SqlExecQuery(loConn, loCmd, false);

                    loResult = R_Utility.R_ConvertTo<PMT50621SaveResultDTO>(loDataTable).FirstOrDefault();
