...
{
    public class PMT01900Unit_UnitInfoDetailCls : R_BusinessObject<PMT01900Unit_UnitInfoDetailDTO>
    {

        private readonly LoggerPMT01900? _loggerPMT01100;
        private readonly ActivitySource _activitySource;

        public PMT01900Unit_UnitInfoDetailCls()
        {
            _loggerPMT01100 = LoggerPMT01900.R_GetInstanceLogger();
            _activitySource = PMT01900Activity.R_GetInstanceActivitySource();
        }

        protected override PMT01900Unit_UnitInfoDetailDTO R_Display(PMT01900Unit_UnitInfoDetailDTO poEntity)
        {
            string? lcMethod = nameof(R_Display);
            _loggerPMT01100.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            PMT01900Unit_UnitInfoDetailDTO? loRtn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            ...
            try
            {
                ...
                _loggerPMT01100.LogInfo(string.Format("Convert the data in loRtn to data of PMT01900Unit_UnitInfoDetailDTO objects and assign it to loRtn in Method {0}", lcMethod));
                loRtn = R_Utility.R_ConvertTo<PMT01900Unit_UnitInfoDetailDTO>(loProfileDataTable).FirstOrDefault()!;
        ...
        protected override void R_Saving(PMT01900Unit_UnitInfoDetailDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            string? lcMethod = nameof(R_Saving);
            using Activity activity = _activitySource.StartActivity(lcMethod)!;
            _loggerPMT01100.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception? loException = new R_Exception();
            //PMT01900Unit_UnitInfoDetailDTO loEntity;
            string? lcQuery;
            ...
            try
            {
                ...
                try
                {
                    ...
                    loDb.SqlExecNonQuery(loConn, loCommand, false);
                    //loEntity = R_Utility.R_ConvertTo<PMT01900Unit_UnitInfoDetailDTO>(loDataTable).FirstOrDefault()!;
                    /*
        ...
        protected override void R_Deleting(PMT01900Unit_UnitInfoDetailDTO poEntity)
        {
