...
{
    public class APT00221Cls : R_BusinessObject<APT00221ParameterDTO>
    {
        ...
        public APT00221Cls()
        {
            ...
            _activitySource = APT00221ActivitySourceBase.R_GetInstanceActivitySource();
        }
        ...
        public APT00221DTO RefreshPurchaseReturnItem(APT00221RefreshParameterDTO poParameter)
        {
            using Activity activity = _activitySource.StartActivity("RefreshPurchaseReturnItem");
            R_Exception loException = new R_Exception();
            APT00221DTO loResult = null;
            R_Db loDb = new R_Db();
            DbConnection loConn = null;
            DbCommand loCmd = null;
            string lcQuery;
            ...
            try
            {
                ...
                _logger.LogDebug("EXEC RSP_AP_GET_TRANS_PD {@Parameters} || RefreshPurchaseReturnItem(Cls) ", loDbParam);

                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);

                loResult = R_Utility.R_ConvertTo<APT00221DTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        protected override void R_Deleting(APT00221ParameterDTO poEntity)
        {
        ...
        protected override APT00221ParameterDTO R_Display(APT00221ParameterDTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity("R_Display");
            R_Exception loException = new R_Exception();
            APT00221ParameterDTO loResult = new APT00221ParameterDTO();
            ...
            try
            {
                ...
                loResult.Data = RefreshPurchaseReturnItem(loParam);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        protected override void R_Saving(APT00221ParameterDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            using Activity activity = _activitySource.StartActivity("R_Saving");
            R_Exception loEx = new R_Exception();
            APT00221SaveResultDTO loResult = null;
            string lcQuery = "";
            R_Db loDb = new R_Db();
            DbConnection loConn = null;
            DbCommand loCmd = null;
            ...
            try
            {
                ...
                try
                {
                    ...
                    loResult = R_Utility.R_ConvertTo<APT00221SaveResultDTO>(loDataTable).FirstOrDefault();
