...
{
    public class PMM01030PrintController : R_ReportControllerBase
    {
        private R_ReportFastReportBackClass _ReportCls;
        private PMM01030PrintParamDTO _AllRatePGParameter;
        private LoggerPMM01030Print _LoggerPrint;
        private readonly ActivitySource _activitySource;

        #region instantiate
        public PMM01030PrintController(ILogger<LoggerPMM01030Print> logger)
        {
            //Initial and Get Logger
            LoggerPMM01030Print.R_InitializeLogger(logger);
            _LoggerPrint = LoggerPMM01030Print.R_GetInstanceLogger();
            _activitySource = PMM01030PrintActivitySourceBase.R_InitializeAndGetActivitySource(nameof(PMM01030PrintController));
        ...
        [HttpPost]
        public R_DownloadFileResultDTO AllRatePGReportPost(PMM01030PrintParamDTO poParameter)
        {
            using Activity activity = _activitySource.StartActivity("AllRatePGReportPost");
            R_Exception loException = new R_Exception();
            PMM01000PrintLogKeyDTO<PMM01030PrintParamDTO> loCache = null;
            _LoggerPrint.LogInfo("Start AllRatePGReportPost");
            R_DownloadFileResultDTO loRtn = null;
            try
            {
                loRtn = new R_DownloadFileResultDTO();
                loCache = new PMM01000PrintLogKeyDTO<PMM01030PrintParamDTO>
                {
                    poParam = poParameter,
                ...
                R_DistributedCache.R_Set(loRtn.GuidResult, R_NetCoreUtility.R_SerializeObjectToByte<PMM01000PrintLogKeyDTO<PMM01030PrintParamDTO>>(loCache));
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        public FileStreamResult AllStreamRatePGReportGet(string pcGuid)
        {
            ...
            R_Exception loException = new R_Exception();
            PMM01000PrintLogKeyDTO<PMM01030PrintParamDTO> loResultGUID = null;
            FileStreamResult loRtn = null;
            _LoggerPrint.LogInfo("Start AllStreamRatePGReportGet");
            try
            {
                //Get Parameter
                loResultGUID = R_NetCoreUtility.R_DeserializeObjectFromByte<PMM01000PrintLogKeyDTO<PMM01030PrintParamDTO>>(R_DistributedCache.Cache.Get(pcGuid));
        ...
        #region Helper
        private PMM01030ResultWithBaseHeaderPrintDTO GenerateDataPrint(PMM01030PrintParamDTO poParam)
        {
            ...
            PMM01030ResultWithBaseHeaderPrintDTO loRtn = new PMM01030ResultWithBaseHeaderPrintDTO();
            ...
            try
            {
                ...
                var loCls = new PMM01030Cls(_LoggerPrint);

                var loHeaderParam = R_Utility.R_ConvertObjectToObject<PMM01030PrintParamDTO, PMM01030DTO>(poParam);
