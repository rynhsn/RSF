...
namespace PMT01500Service
{
    ...
    [ApiController]
    public class PMT01500UnitInfo_UnitInfoController : ControllerBase, IPMT01500UnitInfo_UnitInfo
    {
        private readonly LoggerPMT01500? _loggerPMT01500;
        private readonly ActivitySource _activitySource;

        public PMT01500UnitInfo_UnitInfoController(ILogger<PMT01500UnitInfo_UnitInfoController> logger)
        {
        ...
        public PMT01500UnitInfoHeaderDTO GetUnitInfoHeader(PMT01500GetHeaderParameterDTO poParameter)
        {
            ...
            PMT01500UnitInfoHeaderDTO? loReturn = null;
            PMT01500UnitInfo_UnitInfoCls loCls;
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public IAsyncEnumerable<PMT01500UnitInfoUnitInfoListDTO> GetUnitInfoList()
        {
            ...
            PMT01500UtilitiesParameterDTO? loDbParameterInternal;
            PMT01500GetHeaderParameterDTO? loDbParameter;
            List<PMT01500UnitInfoUnitInfoListDTO> loRtnTmp;
            PMT01500UnitInfo_UnitInfoCls loCls;
            IAsyncEnumerable<PMT01500UnitInfoUnitInfoListDTO>? loReturn = null;
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        [HttpPost]
        public R_ServiceGetRecordResultDTO<PMT01500UnitInfoUnitInfoDetailDTO> R_ServiceGetRecord(R_ServiceGetRecordParameterDTO<PMT01500UnitInfoUnitInfoDetailDTO> poParameter)
        {
            string? lcMethod = nameof(R_ServiceGetRecord);
            _loggerPMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            var loEx = new R_Exception();
            var loRtn = new R_ServiceGetRecordResultDTO<PMT01500UnitInfoUnitInfoDetailDTO>();

            try
            {
                _loggerPMT01500.LogInfo(string.Format("Initialize the loCls in method {0}", lcMethod));
                var loCls = new PMT01500UnitInfo_UnitInfoCls();
                _loggerPMT01500.LogDebug("{@PMT01500UnitInfo_UnitInfoCls}", loCls);
        ...
        [HttpPost]
        public R_ServiceSaveResultDTO<PMT01500UnitInfoUnitInfoDetailDTO> R_ServiceSave(R_ServiceSaveParameterDTO<PMT01500UnitInfoUnitInfoDetailDTO> poParameter)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
        ...
        [HttpPost]
        public R_ServiceDeleteResultDTO R_ServiceDelete(R_ServiceDeleteParameterDTO<PMT01500UnitInfoUnitInfoDetailDTO> poParameter)
        {
