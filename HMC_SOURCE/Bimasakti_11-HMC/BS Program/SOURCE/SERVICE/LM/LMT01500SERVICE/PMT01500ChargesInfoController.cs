...
namespace PMT01500Service
{
    ...
    [ApiController]
    public class PMT01500ChargesInfoController : ControllerBase, IPMT01500ChargesInfo
    {
        private readonly LoggerPMT01500? _loggerPMT01500;
        private readonly ActivitySource _activitySource;

        public PMT01500ChargesInfoController(ILogger<PMT01500ChargesInfoController> logger)
        {
        ...
        public PMT01500ChargesInfoHeaderDTO GetChargesInfoHeader(PMT01500GetHeaderParameterDTO poParameter)
        {
            ...
            PMT01500ChargesInfoHeaderDTO? loReturn = null;
            PMT01500ChargesInfoCls loCls;
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public IAsyncEnumerable<PMT01500ChargesInfoListDTO> GetChargesInfoList()
        {
            ...
            PMT01500UtilitiesParameterDTO? loDbParameterInternal;
            PMT01500GetHeaderParameterDTO? loDbParameter;
            List<PMT01500ChargesInfoListDTO> loRtnTmp;
            PMT01500ChargesInfoCls loCls;
            IAsyncEnumerable<PMT01500ChargesInfoListDTO>? loReturn = null;
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public IAsyncEnumerable<PMT01500FrontChargesInfo_FeeCalculationDetailDTO> GetChargesInfoCalUnitList()
        {
            ...
            R_Exception loException = new R_Exception();
            PMT01500UtilitiesParameterDTO? loDbParameterInternal;
            PMT01500GetHeaderParameterChargesInfoCalUnitDTO? loDbParameter;
            List<PMT01500FrontChargesInfo_FeeCalculationDetailDTO> loRtnTmp;
            PMT01500ChargesInfoCls loCls;
            IAsyncEnumerable<PMT01500FrontChargesInfo_FeeCalculationDetailDTO>? loReturn = null;
            PMT01500Utilities? loUtilities = null;
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(loDbParameterInternal.CCOMPANY_ID))
                {
                    loDbParameter.CPROPERTY_ID = R_Utility.R_GetStreamingContext<string>(PMT01500GetHeaderParameterChargesInfoCalUnitContextDTO.CPROPERTY_ID);
                    loDbParameter.CDEPT_CODE = R_Utility.R_GetStreamingContext<string>(PMT01500GetHeaderParameterChargesInfoCalUnitContextDTO.CDEPT_CODE);
                    loDbParameter.CREF_NO = R_Utility.R_GetStreamingContext<string>(PMT01500GetHeaderParameterChargesInfoCalUnitContextDTO.CREF_NO);
                    loDbParameter.CTRANS_CODE = R_Utility.R_GetStreamingContext<string>(PMT01500GetHeaderParameterChargesInfoCalUnitContextDTO.CTRANS_CODE);
                    loDbParameter.CSEQ_NO = R_Utility.R_GetStreamingContext<string>(PMT01500GetHeaderParameterChargesInfoCalUnitContextDTO.CSEQ_NO);
                    loDbParameterInternal.CUSER_ID = R_BackGlobalVar.USER_ID;
                }
                _loggerPMT01500.LogDebug("{@ObjectParameterInternal}", loDbParameterInternal);
                _loggerPMT01500.LogDebug("{@ObjectParameter}", loDbParameter);
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        [HttpPost]
        public R_ServiceGetRecordResultDTO<PMT01500ChargesInfoDetailDTO> R_ServiceGetRecord(R_ServiceGetRecordParameterDTO<PMT01500ChargesInfoDetailDTO> poParameter)
        {
            string? lcMethod = nameof(R_ServiceGetRecord);
            _loggerPMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            var loEx = new R_Exception();
            var loRtn = new R_ServiceGetRecordResultDTO<PMT01500ChargesInfoDetailDTO>();

            try
            {
                _loggerPMT01500.LogInfo(string.Format("Initialize the loCls in method {0}", lcMethod));
                var loCls = new PMT01500ChargesInfoCls();
                _loggerPMT01500.LogDebug("{@PMT01500ChargesInfoCls}", loCls);
        ...
        [HttpPost]
        public R_ServiceSaveResultDTO<PMT01500ChargesInfoDetailDTO> R_ServiceSave(R_ServiceSaveParameterDTO<PMT01500ChargesInfoDetailDTO> poParameter)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
        ...
        [HttpPost]
        public R_ServiceDeleteResultDTO R_ServiceDelete(R_ServiceDeleteParameterDTO<PMT01500ChargesInfoDetailDTO> poParameter)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            ...
            var loEx = new R_Exception();
            var loRtn = new PMT01500ChargesInfoResultActiveDTO();
            PMT01500ChargesInfoParameterActiveDTO loDbPar = poParameter;
