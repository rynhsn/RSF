...
{
    public partial class CBT02300UndoClear
    {
        ...
        {
            await R_MessageBox.Show("", $"Undo Clear cheque(s) processed successfully!”", R_eMessageBoxButtonType.OK);
        }
        protected override async Task R_Init_From_Master(object poParameter)
        {
            ...
            try
            {
                ...
                _viewModel._typeBankIn = "UNDO_CLEAR";
        ...
        private async Task GetListRecord(R_ServiceGetListRecordEventArgs eventArgs)
        {
            ...
            try
            {
                await _viewModel.GetBankInChequeList("UNDO_CLEAR");
        ...
        private async Task BtnUndoClear()
        {
            var loEx = new R_Exception();
            ...
            {
                _viewModel._typeBankIn = "UNDO_CLEAR";
                _viewModel.leTypeBank = CBT02300BankInChequeViewModel.TYPE_BANK_IM_CHEQUE.Undo_Clear;
        ...
        private async Task ServiceSaveBatch(R_ServiceSaveBatchEventArgs eventArgs)
        {
            ...
            try
            {
                ...
                var lcMessage = R_FrontUtility.R_GetMessage(typeof(Resources_CBT02300_Class), "ConfirmationUndoClear");
                if (await R_MessageBox.Show("Confirmation", lcMessage,
