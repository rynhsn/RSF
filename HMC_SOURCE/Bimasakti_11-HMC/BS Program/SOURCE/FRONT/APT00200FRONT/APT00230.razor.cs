...
{
    public partial class APT00230 : R_Page
    {
        [Inject] private R_ILocalizer<APT00200FrontResources.Resources_Dummy_Class> _localizer { get; set; }

        private APT00230ViewModel loViewModel = new APT00230ViewModel();
        ...
        private void Summary_Validation(R_ValidationEventArgs eventArgs)
        {
            ...
            try
            {
                APT00230DTO loData = (APT00230DTO)eventArgs.Data;
        ...
        private async Task Summary_ServiceSave(R_ServiceSaveEventArgs eventArgs)
        {
            ...
            try
            {
                await loViewModel.SaveSummaryAsync((APT00230DTO)eventArgs.Data, (eCRUDMode)eventArgs.ConductorMode);
        ...
        private void Before_Open_Deduction_Popup(R_BeforeOpenPopupEventArgs eventArgs)
        {
            ...
            eventArgs.TargetPageType = typeof(APT00231);
        }
