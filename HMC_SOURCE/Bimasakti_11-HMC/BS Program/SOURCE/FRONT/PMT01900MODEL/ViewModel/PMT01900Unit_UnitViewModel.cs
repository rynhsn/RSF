...
{
    public class PMT01900UnitCharges_UnitViewModel : R_ViewModel<PMT01900Unit_UnitInfoDetailDTO>
    {
        #region From Back
        ...
        private readonly PMT01900Unit_UnitInfoDetailModel _model = new PMT01900Unit_UnitInfoDetailModel();
        ...
        public PMT01900ParameterFrontChangePageToChargesDTO oParameterChargesList = new PMT01900ParameterFrontChangePageToChargesDTO();
        ...
        public async Task GetEntity(PMT01900Unit_UnitInfoDetailDTO poEntity)
        {
        ...
        public async Task ServiceSave(PMT01900Unit_UnitInfoDetailDTO poNewEntity, eCRUDMode peCRUDMode)
        {
            var loEx = new R_Exception();
        ...
        public async Task ServiceDelete(PMT01900Unit_UnitInfoDetailDTO poEntity)
        {
            var loEx = new R_Exception();
