    ...
    public partial class APT00121
    {
        ...
        private async Task InvoiceItem_ServiceGetRecord(R_ServiceGetRecordEventArgs eventArgs)
        {
            ...
            try
            {
                ...
                loViewModel.loInvoiceItem.NTOTAL_AMOUNT = loViewModel.loInvoiceItem.NTAXABLE_AMOUNT + loViewModel.loInvoiceItem.NTAX_AMOUNT + loViewModel.loInvoiceItem.NOTHER_TAX_AMOUNT;
        ...
        private void InvoiceItem_SetEdit(R_SetEventArgs eventArgs)
        {
            if (eventArgs.Enable)
            {
                IsTransStatus00 = false;
        ...
        private async Task InvoiceItem_BeforeDelete(R_BeforeDeleteEventArgs eventArgs)
        {
        ...
        private async Task InvoiceItem_AfterDelete()
        {
            await R_MessageBox.Show("", _localizer["M008"], R_eMessageBoxButtonType.OK);
        }

        private async Task InvoiceItem_BeforeCancel(R_BeforeCancelEventArgs eventArgs)
        {
        ...
        private async Task OnLostFocusProductDepartment()
        {
            ...
            try
            {
                APT00121DTO loGetData = (APT00121DTO)loViewModel.Data;
