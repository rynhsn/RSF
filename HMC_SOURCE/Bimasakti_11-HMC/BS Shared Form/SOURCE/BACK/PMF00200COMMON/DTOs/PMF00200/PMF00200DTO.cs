...
namespace PMF00200COMMON
{
    public class PMF00200DTO
    {
        ...
        public string CCHEQUE_DATE_DISPLAY { get; set; }
        public string CREF_PRD { get; set; }
        public string CTRANS_DESC { get; set; }
        public string CCURRENCY_CODE { get; set; }
        public string CAMOUNT_WORDS { get; set; }
    ...
    public class PMF00200InputParameterDTO
    {
        //Caller Parameter
        public string PARAM_CALLER_ID { get; set; }
        public string PARAM_PROPERTY_ID { get; set; }
        public string PARAM_RECEIPT_ID { get; set; }
        public string PARAM_RECEIPT_TYPE { get; set; }

        //Parameter Print
        public string PRINT_OPTION { get; set; }
        public string RECEIPT_TEMPLATE { get; set; }
