...
namespace PMF00100COMMON.DTOs.PMF00110
{
    public class PMF00110DTO
    {
        ...
        public decimal NTARGET_TAX_RATE { get; set; } = 0;
        ...
        public decimal NCALLER_TAX_RATE { get; set; } = 0; //cek dulu di sql
        ...
        //WH Tax Amount
        public decimal NWH_TAX { get; set; } = 0;

        //Remaining WH Tax
        public decimal NWH_TAX_REMAINING { get; set; } = 0;
