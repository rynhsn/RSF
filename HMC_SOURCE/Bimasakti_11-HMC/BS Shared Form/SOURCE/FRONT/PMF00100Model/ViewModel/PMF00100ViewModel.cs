...
namespace PMF00100Model.ViewModel
{
    public class PMF00100ViewModel : R_ViewModel<PMF00100ListDTO>
    {
        ...
        //private PMF00110Model loAllocationEntryModel = new PMF00110Model();
        ...
        //public PMF00100HeaderDTO loCallerTrxInfo = null;
        ...
        public async Task GetHeaderAsync()
        {
            ...
            try
            {
                loResult = await loModel.GetHeaderAsync(new PMF00100HeaderParameterDTO()
                {
                    CPROPERTY_ID = loAllocationParameter.CPROPERTY_ID,
                    CDEPT_CODE = loAllocationParameter.CDEPT_CODE,
                    CTRANSACTION_CODE = loAllocationParameter.CTRANS_CODE,
                    CREC_ID = loAllocationParameter.CREC_ID,
                    CREFERENCE_NO = loAllocationParameter.CREF_NO
                });
                loHeader = loResult.Data;
                //loHeader.DDOC_DATE = DateTime.ParseExact(loHeader.CDOC_DATE, "yyyyMMdd", null);
                if (!string.IsNullOrEmpty(loHeader.CREF_DATE))
                {
        ...
        public async Task GetCAWTCustReceiptAsync()
        {
            ...
            try
            {
                loResult = await loModel.GetCAWTCustReceiptAsync(new PMF00100HeaderParameterDTO()
                {
                    CREC_ID = loAllocationParameter.CREC_ID
                });
                loHeader = loResult.Data;
        ...
        public async Task GetCQCustReceiptAsync()
        {
            ...
            try
            {
                loResult = await loModel.GetCQCustReceiptAsync(new PMF00100HeaderParameterDTO()
                {
                    CREC_ID = loAllocationParameter.CREC_ID
                });
                loHeader = loResult.Data;
        ...
        //    try
        //    {
        //        loResult = await loModel.GetCallerTrxInfoAsync(new PMF00100HeaderParameterDTO()
        //        {
        //            CREC_ID = loAllocationParameter.CREC_ID
        //        });
