    ...
    public partial class GLT00110 : R_Page
    {
        ...
        private async Task JournalForm_AfterAddAsync(R_AfterAddEventArgs eventArgs)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    //new(_gridDetailRef.DataSource.ToList());//store detail to temp
        ...
        private async Task JournalForm_BeforeCancel(R_BeforeCancelEventArgs eventArgs)
        {
            ...
            try
            {
                ...
                {
                    _JournalEntryViewModel.JournalDetailGrid = new ObservableCollection<GLT00101DTO>(_JournalEntryViewModel.JournalDetailGridTemp); //assign detail back from temp
        ...
        private async Task JournalDet_ServiceGetListRecord(R_ServiceGetListRecordEventArgs eventArgs)
        {
            ...
            try
            {
                ...
                {
                    eventArgs.ListEntityResult = new ObservableCollection<GLT00101DTO>();
                }
            }
            catch (Exception ex)
            {
        ...
        private void JournalDet_After_Open_Lookup(R_AfterOpenGridLookupColumnEventArgs eventArgs)
        {
            ...
            if (_conductorDetailRef.R_ConductorMode == R_eConductorMode.Edit && (loTempResult.CBSIS == "I" && !_JournalEntryViewModel.VAR_GSM_COMPANY.LENABLE_CENTER_IS)
