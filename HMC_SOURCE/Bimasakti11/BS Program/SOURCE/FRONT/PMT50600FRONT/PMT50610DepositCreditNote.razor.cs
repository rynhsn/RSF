...
{
    public partial class PMT50610DepositCreditNote : R_Page
    {
        ...
        private async Task InvoiceHeader_AfterAdd(R_AfterAddEventArgs eventArgs)
        {
            ...
            if (loViewModel.loTabParameter.PARAM_CALLER_ID == "PMT05500" && loViewModel.loTabParameter.PARAM_CALLER_ACTION == "NEW")
            {
                ...
                if (!string.IsNullOrWhiteSpace(loViewModel.loTabParameter.PARAM_DOC_DATE))
                {
                    //loData.DDOC_DATE = DateTime.Parse(loViewModel.loTabParameter.PARAM_DOC_DATE);
                    loData.DDOC_DATE = DateTime.ParseExact(loViewModel.loTabParameter.PARAM_DOC_DATE, "yyyyMMdd", System.Globalization.CultureInfo.InvariantCulture);
                loData.CDOC_DATE = loViewModel.loTabParameter.PARAM_DOC_DATE;
            }
        ...
        {
            var lcResult = "ref_no 090218980717";
