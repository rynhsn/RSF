...
{
    public partial class CBT02300Clear
    {
        ...
        {
            await R_MessageBox.Show("", $"Clear cheque(s) processed successfully!”", R_eMessageBoxButtonType.OK);
        }
        ...
        private async Task GetListRecord(R_ServiceGetListRecordEventArgs eventArgs)
        {
            ...
            try
            {
                await _viewModel.GetBankInChequeList("CLEAR");
        ...
        private async Task BtnClear()
        {
            ...
            {
                _viewModel._typeBankIn = "CLEAR";
                _viewModel.leTypeBank = CBT02300BankInChequeViewModel.TYPE_BANK_IM_CHEQUE.Clear;
        ...
        private async Task ServiceSaveBatch(R_ServiceSaveBatchEventArgs eventArgs)
        {
            ...
            try
            {
                ...
                if (await R_MessageBox.Show("Confirmation", $"Are you sure want to Clear selected cheque(s)?",
