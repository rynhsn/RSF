...
{
    public class PMM01010SaveBatchViewModel : R_IProcessProgressStatus
    {
        private string Message;
        private int Percentage;
        public List<R_BlazorFrontEnd.Exceptions.R_Error> ErrorList { get; set; } = new List<R_BlazorFrontEnd.Exceptions.R_Error>();
        public async Task SaveDeleteRateEC(PMM01010DTO poNewEntity, eCRUDMode peCRUDMode, string pcCompanyId, string pcUserId)
        {
            ...
            try
            {
                ...
                loUploadPar.ClassName = "PMM01000BACK.PMM01010Cls";
                ...
                var loKeyGuid = await loCls.R_BatchProcess<PMM01010DTO>(loUploadPar, 5);
            } catch (Exception ex)
            {
                loEx.Add(ex);
            }
        ...
        private async Task ServiceGetError(string pcKeyGuid)
        {
            ...
            try
            {
                ...
                loParameterData = new R_GetErrorWithMultiLanguageParameter()
                {
                    ...
                    USER_ID = UserId,
                    KEY_GUID = pcKeyGuid,
                    RESOURCE_NAME = "RSP_PM_MAINTAIN_RATE_ECResources"
                };
