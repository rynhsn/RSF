    ...
    public class PMT01500AgreementListCls
    {
        ...
        public List<PMT01500AgreementListOriginalDTO> GetAgreementListDb(PMT01500UtilitiesParameterDTO poParameterInternal, string pcCPROPERTY_ID)
        {
            ...
            try
            {
                ...
                loReturn = R_Utility.R_ConvertTo<PMT01500AgreementListOriginalDTO>(loDataTable).ToList();
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<PMT01500UnitListOriginalDTO> GetUnitListDb(PMT01500UtilitiesParameterDTO poParameterInternal, PMT01500GetHeaderParameterDTO poParameter)
        {
            string? lcMethod = nameof(GetUnitListDb);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            List<PMT01500UnitListOriginalDTO>? loReturn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            try
            {
                ...
                loReturn = R_Utility.R_ConvertTo<PMT01500UnitListOriginalDTO>(loDataTable).ToList();
                _loggerLMT01500.LogDebug("{@ObjectReturn}", loReturn);
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<PMT01500PropertyListDTO> GetPropertyListDb(PMT01500UtilitiesParameterDTO poParameterInternal)
        {
            string? lcMethod = nameof(GetPropertyListDb);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            List<PMT01500PropertyListDTO>? loReturn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            try
            {
                ...
                loReturn = R_Utility.R_ConvertTo<PMT01500PropertyListDTO>(loDataTable).ToList();
                _loggerLMT01500.LogDebug("{@ObjectReturn}", loReturn);
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<PMT01500VarGsmTransactionCodeDTO> GetVarGsmTransactionCodeDb(string pcCCOMPANY_ID, string pcCTRANS_CODE)
        {
            string? lcMethod = nameof(GetVarGsmTransactionCodeDb);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            List<PMT01500VarGsmTransactionCodeDTO>? loReturn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            try
            {
                ...
                loReturn = R_Utility.R_ConvertTo<PMT01500VarGsmTransactionCodeDTO>(loDataTable).ToList();
                _loggerLMT01500.LogDebug("{@ObjectReturn}", loReturn);
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<PMT01500ComboBoxDTO> GetComboBoxDataCTransStatusDb(PMT01500UtilitiesWithCultureIDParameterDTO poParameterInternal)
        {
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public PMT01500SelectedAgreementGetUnitDescriptionDTO GetSelectedAgreementGetUnitDescriptionDb(PMT01500UtilitiesParameterDTO poParameterInternal, PMT01500GetHeaderParameterDTO poParameter)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            ...
            PMT01500SelectedAgreementGetUnitDescriptionDTO loRtn = new PMT01500SelectedAgreementGetUnitDescriptionDTO();
...
#pragma warning disable CS8600 // Converting null literal or possible null value to non-nullable type.
                loRtn = R_Utility.R_ConvertTo<PMT01500SelectedAgreementGetUnitDescriptionDTO>(loDataTable).FirstOrDefault();
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public PMT01500ChangeStatusDTO GetChangeStatusDb(PMT01500UtilitiesParameterDTO poParameterInternal, PMT01500GetHeaderParameterDTO poParameter)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loEx = new R_Exception();
            PMT01500ChangeStatusDTO? loRtn = null;
            DataTable? loDataTable;
            DbConnection loConn;
            DbCommand loCmd;
            string lcQuery;
            ...
            try
            {
                ...
                loRtn = R_Utility.R_ConvertTo<PMT01500ChangeStatusDTO>(loDataTable).FirstOrDefault();
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public PMT01500ProcessResultDTO ProcessChangeStatusDb(PMT01500ChangeStatusParameterDTO poParameter)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            PMT01500ProcessResultDTO? loRtn = new PMT01500ProcessResultDTO();
