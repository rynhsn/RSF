...
{
    public class PMT01500ChargesInfoCls : R_BusinessObject<PMT01500ChargesInfoDetailDTO>
    {
        private Resources_Dummy_Class _oRsp = new Resources_Dummy_Class();
        private readonly LoggerPMT01500? _loggerLMT01500;
        private readonly ActivitySource _activitySource;

        public PMT01500ChargesInfoCls()
        {
            _loggerLMT01500 = LoggerPMT01500.R_GetInstanceLogger();
            _activitySource = PMT01500Activity.R_GetInstanceActivitySource();
        }

        public PMT01500ChargesInfoHeaderDTO GetChargesInfoHeaderDb(PMT01500UtilitiesParameterDTO poParameterInternal, PMT01500GetHeaderParameterDTO poParameter)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            ...
            PMT01500ChargesInfoHeaderDTO? loRtn = null;
            ...
            try
            {
                ...
                loRtn = R_Utility.R_ConvertTo<PMT01500ChargesInfoHeaderDTO>(loDataTable).FirstOrDefault();
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<PMT01500ChargesInfoListDTO> GetChargesInfoListDb(PMT01500UtilitiesParameterDTO poParameterInternal, PMT01500GetHeaderParameterDTO poParameter)
        {
            string? lcMethod = nameof(GetChargesInfoListDb);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            List<PMT01500ChargesInfoListDTO>? loReturn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            try
            {
                ...
                loReturn = R_Utility.R_ConvertTo<PMT01500ChargesInfoListDTO>(loDataTable).ToList();
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<PMT01500FrontChargesInfo_FeeCalculationDetailDTO> GetChargesInfoCalUnitListDb(PMT01500UtilitiesParameterDTO poParameterInternal, PMT01500GetHeaderParameterChargesInfoCalUnitDTO poParameter)
        {
            string? lcMethod = nameof(GetChargesInfoCalUnitListDb);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            List<PMT01500FrontChargesInfo_FeeCalculationDetailDTO>? loReturn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
            try
            {
                ...
                _loggerLMT01500.LogInfo(string.Format("Convert the data in loDataTable to a list of LMT01500ChargesInfoListDTO objects and assign it to loRtn in Method {0}", lcMethod));
                loReturn = R_Utility.R_ConvertTo<PMT01500FrontChargesInfo_FeeCalculationDetailDTO>(loDataTable).ToList();
                _loggerLMT01500.LogDebug("{@ObjectReturn}", loReturn);
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<PMT01500ComboBoxDTO> GetComboBoxDataCFEE_METHODDb(PMT01500UtilitiesWithCultureIDParameterDTO poParameterInternal)
        {
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public PMT01500ChargesInfoResultActiveDTO ProcessChangeStatusChargesInfoActiveDb(PMT01500ChargesInfoParameterActiveDTO poParameter)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            PMT01500ChargesInfoResultActiveDTO? loRtn = new PMT01500ChargesInfoResultActiveDTO();
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public List<PMT01500ComboBoxDTO> GetComboBoxDataCINVOICE_PERIODDb(PMT01500UtilitiesWithCultureIDParameterDTO poParameterInternal)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCommand, "@BIMASAKTI", DbType.String, 10, "BIMASAKTI");
                loDb.R_AddCommandParameter(loCommand, "@CCOMPANY_ID", DbType.String, 20, poParameterInternal.CCOMPANY_ID);
                loDb.R_AddCommandParameter(loCommand, "@BS_INVOICE_PERIOD", DbType.String, 20, "_BS_INVOICE_PERIOD");
                loDb.R_AddCommandParameter(loCommand, "@NONE", DbType.String, 20, "");
                loDb.R_AddCommandParameter(loCommand, "@CULTURE_ID", DbType.String, 8, poParameterInternal.CULTURE_ID);
                var loDbParam = loCommand.Parameters.Cast<DbParameter>()
                    .Where(x => x != null && x.ParameterName.StartsWith("@"))
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        protected override PMT01500ChargesInfoDetailDTO R_Display(PMT01500ChargesInfoDetailDTO poEntity)
        {
            string? lcMethod = nameof(R_Display);
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception loException = new R_Exception();
            PMT01500ChargesInfoDetailDTO? loRtn = null;
            string lcQuery;
            DbCommand loCommand;
            R_Db loDb;
...
#pragma warning disable CS8600 // Converting null literal or possible null value to non-nullable type.
                loRtn = R_Utility.R_ConvertTo<PMT01500ChargesInfoDetailDTO>(loProfileDataTable).FirstOrDefault();
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
#pragma warning disable CS8604 // Possible null reference argument.
                _loggerLMT01500.LogDebug("{@ObjectReturn}", loRtn);
#pragma warning restore CS8604 // Possible null reference argument.
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        protected override void R_Saving(PMT01500ChargesInfoDetailDTO poNewEntity, eCRUDMode poCRUDMode)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            _loggerLMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception? loException = new R_Exception();
            PMT01500ChargesInfoDetailDTO loEntity;
            string? lcQuery;
            DbConnection? loConn = null;
            DbCommand? loCommand;
            string? lcAction;
            ...
            try
            {
                ...
                {
                    var tempData = R_Utility.R_ConvertCollectionToCollection<PMT01500FrontChargesInfo_FeeCalculationDetailDTO, PMT01500FrontChargesInfo_FeeCalculationDetailDTO>(poNewEntity.ODATA_FEE_CALCULATION);
                ...
                try
                {
                    ...
                    loEntity = R_Utility.R_ConvertTo<PMT01500ChargesInfoDetailDTO>(loDataTable).FirstOrDefault()!;
        ...
        protected override void R_Deleting(PMT01500ChargesInfoDetailDTO poEntity)
        {
