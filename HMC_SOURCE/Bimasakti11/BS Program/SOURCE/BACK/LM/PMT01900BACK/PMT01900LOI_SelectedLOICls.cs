...
{
    public class PMT01900LOI_SelectedLOICls : R_BusinessObject<PMT01900LOI_SelectedLOIDTO>
    {
        ...
        protected override PMT01900LOI_SelectedLOIDTO R_Display(PMT01900LOI_SelectedLOIDTO poEntity)
        {
            ...
            try
            {
                ...
                _loggerPMT01900.LogInfo(string.Format("Convert the data in loRtn to data of PMT01900LOI_SelectedLOIDTO objects and assign it to loRtn in Method {0}", lcMethod));
                loRtn = R_Utility.R_ConvertTo<PMT01900LOI_SelectedLOIDTO>(loProfileDataTable).FirstOrDefault()! != null
                    ? R_Utility.R_ConvertTo<PMT01900LOI_SelectedLOIDTO>(loProfileDataTable).FirstOrDefault()!
                    : new PMT01900LOI_SelectedLOIDTO();
        ...
        protected override void R_Saving(PMT01900LOI_SelectedLOIDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var loTakeRefNo = R_Utility.R_ConvertTo<PMT01900LOI_SelectedLOIDTO>(loDataTable).FirstOrDefault()!;
        ...
        protected override void R_Deleting(PMT01900LOI_SelectedLOIDTO poEntity)
        {
