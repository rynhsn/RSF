...
{
    public class PMT50630Cls : R_BusinessObject<PMT50630ParameterDTO>
    {
        RSP_PM_SAVE_TRANS_HDResources.Resources_Dummy_Class _loRspSaveTransHd = new RSP_PM_SAVE_TRANS_HDResources.Resources_Dummy_Class();
        private LoggerPMT50630 _logger;
        private readonly ActivitySource _activitySource;
        public PMT50630Cls()
        {
            _logger = LoggerPMT50630.R_GetInstanceLogger();
            _activitySource = PMT50630ActivitySourceBase.R_GetInstanceActivitySource();
        }

        public PMT50630DTO GetSummaryInfo(GetSummaryParameterDTO poParam)
        {
            using Activity activity = _activitySource.StartActivity("GetSummaryInfo");
            R_Exception loException = new R_Exception();
            PMT50630DTO loResult = null;
            R_Db loDb = new R_Db();
            ...
            try
            {
                ...
                _logger.LogDebug("EXEC RSP_PM_GET_TRANS_HD {@Parameters} || GetSummaryInfo(Cls) ", loDbParam);

                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);

                loResult = R_Utility.R_ConvertTo<PMT50630DTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        protected override void R_Deleting(PMT50630ParameterDTO poEntity)
        {
            throw new NotImplementedException();
        }

        protected override PMT50630ParameterDTO R_Display(PMT50630ParameterDTO poEntity)
        {
            ...
            try
            {
                loResult = new PMT50630ParameterDTO()
                {
        ...
        protected override void R_Saving(PMT50630ParameterDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            ...
            try
            {
                ...
                lcQuery = "EXEC RSP_PM_SAVE_TRANS_HD_SUMMARY " +
                    "@CLOGIN_COMPANY_ID, " +
                    "@CPROPERTY_ID, " +
                    "@CLOGIN_USER_ID, " +
                    "@CREC_ID, " +
                ...
                _logger.LogDebug("EXEC RSP_PM_SAVE_TRANS_HD_SUMARRY {@Parameters} || R_Saving(Cls) ", loDbParam);
