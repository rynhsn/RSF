...
namespace APT00100BACK
{
    public class APT00100Cls
    {
        ...
        public APT00100Cls()
        {
            ...
            _activitySource = APT00100ActivitySourceBase.R_GetInstanceActivitySource();
        }
        ...
        public List<APT00100DetailDTO> GetInvoiceList(APT00100ParameterDTO poParameter)
        {
            ...
            try
            {
                ...
                _logger.LogDebug("EXEC RSP_AP_GET_TRANS_HD_LIST {@Parameters} || GetInvoiceList(Cls) ", loDbParam);

                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);

                loResult = R_Utility.R_ConvertTo<APT00100DetailDTO>(loDataTable).ToList();
