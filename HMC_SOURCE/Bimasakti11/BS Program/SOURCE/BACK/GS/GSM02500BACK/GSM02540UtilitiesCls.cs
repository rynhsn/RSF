...
{
    public class GSM02540UtilitiesCls : R_BusinessObject<GSM02531UtilityParameterDTO>
    {
        ...
        public void RSP_GS_ACTIVE_INACTIVE_OTHER_UNIT_UTILITIESMethod(GSM02500ActiveInactiveParameterDTO poEntity)
        {
        ...
        private void RSP_GS_MAINTAIN_BUILDING_OTHER_UNIT_UTILITIESMethod(GSM02531UtilityParameterDTO poEntity)
        {
        ...
        protected override void R_Saving(GSM02531UtilityParameterDTO poNewEntity, eCRUDMode poCRUDMode)
        {
            ...
            try
            {
                RSP_GS_MAINTAIN_BUILDING_OTHER_UNIT_UTILITIESMethod(poNewEntity);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        protected override void R_Deleting(GSM02531UtilityParameterDTO poEntity)
        {
            ...
            try
            {
                RSP_GS_MAINTAIN_BUILDING_OTHER_UNIT_UTILITIESMethod(poEntity);
            }
            catch (Exception ex)
            {
                loException.Add(ex);
