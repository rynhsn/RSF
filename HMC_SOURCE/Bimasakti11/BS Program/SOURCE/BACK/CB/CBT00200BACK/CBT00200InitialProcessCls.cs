...
{
    public class CBT00200InitialProcessCls
    {
        private LoggerCBT00200InitialProcess _Logger;
        private readonly ActivitySource _activitySource;
        public CBT00200InitialProcessCls()
        {
            _Logger = LoggerCBT00200InitialProcess.R_GetInstanceLogger();
            _activitySource = CBT00200InitialProcessActivityInitSourceBase.R_GetInstanceActivitySource();
        }

        public CBT00200CBSystemParamDTO GetSystemParamCB()
        {
            ...
            try
            {
             ...
             .Where(x => x != null && x.ParameterName.StartsWith("@")).Select(x => x.Value);
                ...
                loResult = R_Utility.R_ConvertTo<CBT00200CBSystemParamDTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public CBT00200GSCompanyInfoDTO GetCompanyInfoRecord()
        {
            ...
            try
            {
                ...
                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);
                loResult = R_Utility.R_ConvertTo<CBT00200GSCompanyInfoDTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public CBT00200GLSystemParamDTO GetGLSystemParamRecord()
        {
            ...
            try
            {
                ...
                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);
                loResult = R_Utility.R_ConvertTo<CBT00200GLSystemParamDTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public CBT00200GSTransInfoDTO GetTransCodeInfoRecord()
        {
            ...
            try
            {
                ...
                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);
                loResult = R_Utility.R_ConvertTo<CBT00200GSTransInfoDTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public CBT00200GSPeriodYearRangeDTO GetPeriodYearRangeRecord()
        {
            ...
            try
            {
                ...
                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);
                loResult = R_Utility.R_ConvertTo<CBT00200GSPeriodYearRangeDTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public CBT00200TodayDateDTO GetTodayDateRecord()
        {
            ...
            try
            {
                ...
                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);
                loResult = R_Utility.R_ConvertTo<CBT00200TodayDateDTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public CBT00200GSPeriodDTInfoDTO GetPeriodDTInfoRecord(CBT00200ParamGSPeriodDTInfoDTO poEntity)
        {
            var loEx = new R_Exception();
            ...
            try
            {
                ...
                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);
                loResult = R_Utility.R_ConvertTo<CBT00200GSPeriodDTInfoDTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public CBT00200LastCurrencyRateDTO GetLastCurrency(CBT00200LastCurrencyRateDTO poEntity)
        {
            ...
            try
            {
                ...
                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);
                loResult = R_Utility.R_ConvertTo<CBT00200LastCurrencyRateDTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public List<CBT00200GSGSBCodeDTO> GetGSBCodeList()
        {
            ...
            try
            {
                ...
                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);
                loResult = R_Utility.R_ConvertTo<CBT00200GSGSBCodeDTO>(loDataTable).ToList();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        public List<CBT00200GSCenterDTO> GetCenterList()
        {
            ...
            try
            {
                ...
                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);
                loResult = R_Utility.R_ConvertTo<CBT00200GSCenterDTO>(loDataTable).ToList();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
