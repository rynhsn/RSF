...
namespace PMT01100Service
{
    ...
    [ApiController]
    public class PMT01100LOO_UnitCharges_UnitChargesController : ControllerBase, IPMT01100LOO_UnitCharges_UnitCharges
    {

        private readonly LoggerPMT01100? _loggerPMT01100;
        private readonly ActivitySource _activitySource;

        public PMT01100LOO_UnitCharges_UnitChargesController(ILogger<PMT01100LOO_UnitCharges_UnitChargesController> logger)
        {
            LoggerPMT01100.R_InitializeLogger(logger);
            _loggerPMT01100 = LoggerPMT01100.R_GetInstanceLogger();
            _activitySource = PMT01100Activity.R_InitializeAndGetActivitySource(nameof(PMT01100LOO_UnitCharges_UnitChargesController));
        }
        ...
        {
            string? lcMethod = nameof(GetUnitChargesHeader);
            _loggerPMT01100.LogInfo(string.Format("Start Method {0}", lcMethod));

            R_Exception loException = new R_Exception();
            PMT01100LOO_UnitCharges_UnitCharges_UnitChargesHeaderDTO? loReturn = new PMT01100LOO_UnitCharges_UnitCharges_UnitChargesHeaderDTO();
            PMT01100UtilitiesParameterDTO loDbParameterInternal;
            PMT01100LOO_UnitCharges_UnitCharges_RequestBodyUnitChargesHeaderDTO loDbParameter;
            PMT01100LOO_UnitCharges_UnitChargesCls loCls;
            ...
            try
            {
                ...
                loReturn = loCls.GetUnitChargesHeaderDb(poParameterInternal: loDbParameterInternal, poParameter: loDbParameter);
        ...
        {
            string? lcMethod = nameof(GetChargesList);
            _loggerPMT01100.LogInfo(string.Format("Start Method {0}", lcMethod));

            R_Exception loException = new R_Exception();
            PMT01100UtilitiesParameterDTO? loDbParameterInternal;
            PMT01100UtilitiesParameterChargesListDTO loDbParameter;
            List<PMT01100LOO_UnitCharges_UnitCharges_ChargesListDTO> loRtnTmp;
            PMT01100LOO_UnitCharges_UnitChargesCls loCls;
            IAsyncEnumerable<PMT01100LOO_UnitCharges_UnitCharges_ChargesListDTO>? loReturn = null;
            ...
            try
            {
                ...
                {
                    loDbParameter.CPROPERTY_ID = R_Utility.R_GetStreamingContext<string>(PMT01100ParameterChargesListContextDTO.CPROPERTY_ID);
                    loDbParameter.CDEPT_CODE = R_Utility.R_GetStreamingContext<string>(PMT01100ParameterChargesListContextDTO.CDEPT_CODE);
                    loDbParameter.CTRANS_CODE = R_Utility.R_GetStreamingContext<string>(PMT01100ParameterChargesListContextDTO.CTRANS_CODE);
                    loDbParameter.CREF_NO = R_Utility.R_GetStreamingContext<string>(PMT01100ParameterChargesListContextDTO.CREF_NO);
                    loDbParameter.CBUILDING_ID = R_Utility.R_GetStreamingContext<string>(PMT01100ParameterChargesListContextDTO.CBUILDING_ID);
                    loDbParameterInternal.CUSER_ID = R_BackGlobalVar.USER_ID;
                }
                _loggerPMT01100.LogDebug("{@ObjectParameterInternal}", loDbParameterInternal);
                _loggerPMT01100.LogDebug("{@ObjectParameter}", loDbParameter);
                ...
                _loggerPMT01100.LogInfo(string.Format("Get Data From Back/Cls in Method {0}", lcMethod));
                loRtnTmp = loCls.GetChargesListDb(poParameterInternal: loDbParameterInternal, poParameter: loDbParameter);
        ...
        public IAsyncEnumerable<PMT01100LOO_UnitCharges_UnitCharges_UnitInfoListDTO> GetUnitInfoList()
        {
            ...
            R_Exception loException = new R_Exception();
            PMT01100UtilitiesParameterDTO? loDbParameterInternal;
            PMT01100UtilitiesParameterUnitInfoListDTO loDbParameter;
            List<PMT01100LOO_UnitCharges_UnitCharges_UnitInfoListDTO> loRtnTmp;
            PMT01100LOO_UnitCharges_UnitChargesCls loCls;
            IAsyncEnumerable<PMT01100LOO_UnitCharges_UnitCharges_UnitInfoListDTO>? loReturn = null;
            PMT01100Utilities? loUtilities = null;
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(loDbParameterInternal.CCOMPANY_ID))
                {
                    loDbParameter.CPROPERTY_ID = R_Utility.R_GetStreamingContext<string>(PMT01100ParameterUnitInfoListContextDTO.CPROPERTY_ID);
                    loDbParameter.CDEPT_CODE = R_Utility.R_GetStreamingContext<string>(PMT01100ParameterUnitInfoListContextDTO.CDEPT_CODE);
                    loDbParameter.CTRANS_CODE = R_Utility.R_GetStreamingContext<string>(PMT01100ParameterUnitInfoListContextDTO.CTRANS_CODE);
                    loDbParameter.CREF_NO = R_Utility.R_GetStreamingContext<string>(PMT01100ParameterUnitInfoListContextDTO.CREF_NO);
        ...
        [HttpPost]
        public R_ServiceGetRecordResultDTO<PMT01100LOO_UnitCharges_UnitCharges_UnitInfoListDTO> R_ServiceGetRecord(R_ServiceGetRecordParameterDTO<PMT01100LOO_UnitCharges_UnitCharges_UnitInfoListDTO> poParameter)
        {
            string? lcMethod = nameof(R_ServiceGetRecord);
            _loggerPMT01100.LogInfo(string.Format("Start Method {0}", lcMethod));
            var loEx = new R_Exception();
            var loRtn = new R_ServiceGetRecordResultDTO<PMT01100LOO_UnitCharges_UnitCharges_UnitInfoListDTO>();

            try
            {
                _loggerPMT01100.LogInfo(string.Format("Initialize the loCls in method {0}", lcMethod));
                var loCls = new PMT01100LOO_UnitCharges_UnitChargesCls();
        ...
        [HttpPost]
        public R_ServiceSaveResultDTO<PMT01100LOO_UnitCharges_UnitCharges_UnitInfoListDTO> R_ServiceSave(R_ServiceSaveParameterDTO<PMT01100LOO_UnitCharges_UnitCharges_UnitInfoListDTO> poParameter)
        {
            string? lcMethod = nameof(R_ServiceSave);
            using Activity activity = _activitySource.StartActivity(lcMethod)!;
            _loggerPMT01100.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception? loException = new R_Exception();
            R_ServiceSaveResultDTO<PMT01100LOO_UnitCharges_UnitCharges_UnitInfoListDTO> loReturn = new();
            try
            {
                _loggerPMT01100.LogInfo(string.Format("Initialize the loCls object as a new instance of Cls in method {0}", lcMethod));
                PMT01100LOO_UnitCharges_UnitChargesCls? loCls = new();
        ...
        [HttpPost]
        public R_ServiceDeleteResultDTO R_ServiceDelete(R_ServiceDeleteParameterDTO<PMT01100LOO_UnitCharges_UnitCharges_UnitInfoListDTO> poParameter)
        {
