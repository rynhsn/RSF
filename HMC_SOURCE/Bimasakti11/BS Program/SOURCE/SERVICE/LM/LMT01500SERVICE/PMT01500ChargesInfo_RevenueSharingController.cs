...
namespace PMT01500Service
{
    ...
    [ApiController]
    public class PMT01500ChargesInfo_RevenueSharingController : ControllerBase, IPMT01500ChargesInfo_RevenueSharing
    {
        private readonly LoggerPMT01500? _loggerPMT01500;
        private readonly ActivitySource _activitySource;

        public PMT01500ChargesInfo_RevenueSharingController(ILogger<PMT01500ChargesInfo_RevenueSharingController> logger)
        {
        ...
        public IAsyncEnumerable<PMT01500ChargesInfo_RevenueSharingSchemeOriginalDTO> GetRevenueSharingSchemeList()
        {
            ...
            PMT01500ParameterForChargesInfo_RevenueSharingDTO? loDbParameter;
            List<PMT01500ChargesInfo_RevenueSharingSchemeOriginalDTO> loRtnTmp;
            PMT01500ChargesInfo_RevenueSharingCls loCls;
            IAsyncEnumerable<PMT01500ChargesInfo_RevenueSharingSchemeOriginalDTO>? loReturn = null;
            ...
            try
            {
                ...
                {
                    loDbParameter.CPROPERTY_ID = R_Utility.R_GetStreamingContext<string>(PMT01500GetAgreementChargesInfo_RevenueSharingContextDTO.CPROPERTY_ID);
                    loDbParameter.CDEPT_CODE = R_Utility.R_GetStreamingContext<string>(PMT01500GetAgreementChargesInfo_RevenueSharingContextDTO.CDEPT_CODE);
                    loDbParameter.CREF_NO = R_Utility.R_GetStreamingContext<string>(PMT01500GetAgreementChargesInfo_RevenueSharingContextDTO.CREF_NO);
                    loDbParameter.CTRANS_CODE = R_Utility.R_GetStreamingContext<string>(PMT01500GetAgreementChargesInfo_RevenueSharingContextDTO.CTRANS_CODE);
                    loDbParameter.CCHARGE_SEQ_NO = R_Utility.R_GetStreamingContext<string>(PMT01500GetAgreementChargesInfo_RevenueSharingContextDTO.CCHARGE_SEQ_NO);
                    /*
                ...
                loCls = new();
                _loggerPMT01500.LogDebug("{@PMT01500ChargesInfo_RevenueSharingCls}", loCls);
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public IAsyncEnumerable<PMT01500ChargesInfo_RevenueMinimumRentDTO> GetRevenueMinimumRentList()
        {
            ...
            PMT01500UtilitiesParameterDTO? loDbParameterInternal;
            PMT01500ParameterForChargesInfo_RevenueSharingDTO? loDbParameter;
            List<PMT01500ChargesInfo_RevenueMinimumRentDTO> loRtnTmp;
            PMT01500ChargesInfo_RevenueSharingCls loCls;
            IAsyncEnumerable<PMT01500ChargesInfo_RevenueMinimumRentDTO>? loReturn = null;
            PMT01500Utilities? loUtilities = null;
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        [HttpPost]
        public R_ServiceGetRecordResultDTO<PMT01500ChargesInfo_RevenueSharingSchemeOriginalDTO> R_ServiceGetRecord(R_ServiceGetRecordParameterDTO<PMT01500ChargesInfo_RevenueSharingSchemeOriginalDTO> poParameter)
        {
            string? lcMethod = nameof(R_ServiceGetRecord);
            _loggerPMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            var loEx = new R_Exception();
            var loRtn = new R_ServiceGetRecordResultDTO<PMT01500ChargesInfo_RevenueSharingSchemeOriginalDTO>();

            try
            {
                _loggerPMT01500.LogInfo(string.Format("Initialize the loCls in method {0}", lcMethod));
                var loCls = new PMT01500ChargesInfo_RevenueSharingCls();
                _loggerPMT01500.LogDebug("{@PMT01500ChargesInfo_RevenueSharingCls}", loCls);
        ...
        [HttpPost]
        public R_ServiceSaveResultDTO<PMT01500ChargesInfo_RevenueSharingSchemeOriginalDTO> R_ServiceSave(R_ServiceSaveParameterDTO<PMT01500ChargesInfo_RevenueSharingSchemeOriginalDTO> poParameter)
        {
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
            _loggerPMT01500.LogInfo(string.Format("Start Method {0}", lcMethod));
            R_Exception? loException = new R_Exception();
            R_ServiceSaveResultDTO<PMT01500ChargesInfo_RevenueSharingSchemeOriginalDTO> loReturn = new();
            try
            {
                _loggerPMT01500.LogInfo(string.Format("Initialize the loCls object as a new instance of Cls in method {0}", lcMethod));
                PMT01500ChargesInfo_RevenueSharingCls? loCls = new();
                _loggerPMT01500.LogDebug("{@ObjectPMT01500ChargesInfo_RevenueSharingCls}", loCls);
        ...
        [HttpPost]
        public R_ServiceDeleteResultDTO R_ServiceDelete(R_ServiceDeleteParameterDTO<PMT01500ChargesInfo_RevenueSharingSchemeOriginalDTO> poParameter)
        {
