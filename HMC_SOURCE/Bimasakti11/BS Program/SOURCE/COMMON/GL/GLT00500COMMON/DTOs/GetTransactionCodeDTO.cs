...
{
    public class GetTransactionCodeDTO
    {
        ...
        public string CDEPT_DELIMETER { get; set; }
        public bool LTRANSACTION_MODE { get; set; }
        public string CTRANSACTION_DELIMETER { get; set; }
        public bool LPERIOND_MODE { get; set; }
        public string CPERIOND_DELIMETER { get; set; }
        public string CYEAR_FORMAT { get; set; }
        public int INUMBER_LEBGTH { get; set; }
        public string CNUMBER_DELIMETER { get; set; }
        public string CPREFIX { get; set; }
        public string CPREFIX_DELIMETER { get; set; }
