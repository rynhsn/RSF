...
namespace PMF00200BACK
{
    public class PMF00200Cls 
    {
        ...
        #region Back SP
        public PMF00200GSCompanyInfoDTO GetCompanyInfoRecord()
        {
        ...
        public List<PMF00200ReportTemplateDTO> GetReportTempateList(PMF00200InputParameterDTO poEntity)
        {
        ...
        public PMF00200DTO GetJournalDisplay(PMF00200InputParameterDTO poEntity)
        {
        ...
        public PMF00200LogoDTO GetBaseHeaderLogoCompany(string pcCompanyId)
        {
            using Activity activity = _activitySource.StartActivity("GetBaseHeaderLogoCompany");
            var loEx = new R_Exception();
            PMF00200LogoDTO loResult = null;
            ...
            try
            {
                ...
                var loDataTable = loDb.SqlExecQuery(loConn, loCmd, true);
                loResult = R_Utility.R_ConvertTo<PMF00200LogoDTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        private string SaveEmailProcess(byte[] EmailMessageData, PMF00200HeaderPrintDTO poReceiptData, PMF00200EmailTemplateDTO poBodyData, string pcProgramId)
        {
            ...
            try
            {
                ...
                loConn = loDb.GetConnection(loConnAttr);
